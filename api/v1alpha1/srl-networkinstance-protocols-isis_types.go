...
const (
	// SrlNetworkinstanceProtocolsIsisFinalizer is the name of the finalizer added to
	// SrlNetworkinstanceProtocolsIsis to block delete operations until the physical node can be
	// deprovisioned.
	SrlNetworkinstanceProtocolsIsisFinalizer string = "NetworkinstanceProtocolsIsis.srlinux.henderiw.be"
)
...
// SrlNetworkinstanceProtocolsIsisSpec struct
type SrlNetworkinstanceProtocolsIsisSpec struct {
	SrlNokiaNetworkInstanceName     *string                       `json:"network-instance-name"`
	SrlNetworkinstanceProtocolsIsis *NetworkinstanceProtocolsIsis `json:"isis"`
}

// SrlNetworkinstanceProtocolsIsisStatus struct
type SrlNetworkinstanceProtocolsIsisStatus struct {
	...
	UsedSpec *SrlNetworkinstanceProtocolsIsisSpec `json:"usedSpec,omitempty"`
...
// SrlNetworkinstanceProtocolsIsis is the Schema for the SrlNetworkinstanceProtocolsIsiss API
type SrlNetworkinstanceProtocolsIsis struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SrlNetworkinstanceProtocolsIsisSpec   `json:"spec,omitempty"`
	Status SrlNetworkinstanceProtocolsIsisStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SrlNetworkinstanceProtocolsIsisList contains a list of SrlNetworkinstanceProtocolsIsiss
...
func (o *SrlNetworkinstanceProtocolsIsis) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
...
func (o *SrlNetworkinstanceProtocolsIsis) SetConfigStatus(t *string, c *ConfigStatus) {
	o.Status.Target[*t].ConfigStatus = c
}
func (o *SrlNetworkinstanceProtocolsIsis) SetConfigStatusDetails(t *string, c *string) {
