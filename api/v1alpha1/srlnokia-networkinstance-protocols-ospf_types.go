...
const (
	// SrlnokiaNetworkinstanceProtocolsOspfFinalizer is the name of the finalizer added to
	// SrlnokiaNetworkinstanceProtocolsOspf to block delete operations until the physical node can be
	// deprovisioned.
	SrlnokiaNetworkinstanceProtocolsOspfFinalizer string = "NetworkinstanceProtocolsOspf.srlinux.henderiw.be"
)
...
type NetworkinstanceProtocolsOspfInstanceArea struct {
  ...
  // +kubebuilder:validation:Pattern=`(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])|[0-9\.]*|(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%!+(BADINDEX))?`
...
// SrlnokiaNetworkinstanceProtocolsOspfSpec struct
type SrlnokiaNetworkinstanceProtocolsOspfSpec struct{
  SrlNokiaNetworkInstanceName       *string `json:"network-instance-name"`
  SrlnokiaNetworkinstanceProtocolsOspf       *NetworkinstanceProtocolsOspf `json:"ospf"`
}

// SrlnokiaNetworkinstanceProtocolsOspfStatus struct
type SrlnokiaNetworkinstanceProtocolsOspfStatus struct{
  // Target provides the status of the configuration on the device
  Target map[string]*TargetStatus `json:"targetStatus,omitempty"`

  // UsedSpec provides the spec used for the configuration
  UsedSpec *SrlnokiaNetworkinstanceProtocolsOspfSpec `json:"usedSpec,omitempty"`
...
// SrlnokiaNetworkinstanceProtocolsOspf is the Schema for the SrlnokiaNetworkinstanceProtocolsOspfs API
type SrlnokiaNetworkinstanceProtocolsOspf struct {
  metav1.TypeMeta   `json:",inline"`
  metav1.ObjectMeta `json:"metadata,omitempty"`

  Spec   SrlnokiaNetworkinstanceProtocolsOspfSpec   `json:"spec,omitempty"`
  Status SrlnokiaNetworkinstanceProtocolsOspfStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SrlnokiaNetworkinstanceProtocolsOspfList contains a list of SrlnokiaNetworkinstanceProtocolsOspfs
type SrlnokiaNetworkinstanceProtocolsOspfList struct {
  metav1.TypeMeta   `json:",inline"`
  metav1.ListMeta `json:"metadata,omitempty"`
  Items           []SrlnokiaNetworkinstanceProtocolsOspf `json:"items"`
}

func init() {
  SchemeBuilder.Register(&SrlnokiaNetworkinstanceProtocolsOspf{}, &SrlnokiaNetworkinstanceProtocolsOspfList{})
}

// NewEvent creates a new event associated with the object and ready
// to be published to the kubernetes API.
func (o *SrlnokiaNetworkinstanceProtocolsOspf) NewEvent(reason, message string) corev1.Event {
  t := metav1.Now()
  return corev1.Event{
    ...
    InvolvedObject: corev1.ObjectReference{
      Kind:       "SrlnokiaNetworkinstanceProtocolsOspf",
...
func (o *SrlnokiaNetworkinstanceProtocolsOspf) SetConfigStatus(t *string, c *ConfigStatus) {
