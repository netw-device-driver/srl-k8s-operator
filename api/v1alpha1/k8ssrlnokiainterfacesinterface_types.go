...
type SrlNokiaInterfacesInterfaceStatus struct {
	...
	UsedSpec *SrlNokiaInterfacesInterfaceSpec `json:"usedSpec,omitempty"`
...
func (o *K8sSrlNokiaInterfacesInterface) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
		...
		InvolvedObject: corev1.ObjectReference{
			Kind:       "SrlNokiaInterfacesInterface",
...
func (o *K8sSrlNokiaInterfacesInterface) SetConfigStatus(t *string, c *ConfigStatus) {
