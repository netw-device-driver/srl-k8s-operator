...
const (
	// SrlInterfaceFinalizer is the name of the finalizer added to
	// SrlInterface to block delete operations until the physical node can be
	// deprovisioned.
	SrlInterfaceFinalizer string = "Interface.srlinux.henderiw.be"
)
...
// SrlInterfaceSpec struct
type SrlInterfaceSpec struct {
	SrlInterface *[]Interface `json:"interface"`
}

// SrlInterfaceStatus struct
type SrlInterfaceStatus struct {
	...
	UsedSpec *SrlInterfaceSpec `json:"usedSpec,omitempty"`
...
// SrlInterface is the Schema for the SrlInterfaces API
type SrlInterface struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SrlInterfaceSpec   `json:"spec,omitempty"`
	Status SrlInterfaceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SrlInterfaceList contains a list of SrlInterfaces
...
func (o *SrlInterface) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
...
func (o *SrlInterface) SetConfigStatus(t *string, c *ConfigStatus) {
	o.Status.Target[*t].ConfigStatus = c
}
func (o *SrlInterface) SetConfigStatusDetails(t *string, c *string) {
