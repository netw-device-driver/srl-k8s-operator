...
const (
	// SrlnokiaInterfaceSubinterfaceFinalizer is the name of the finalizer added to
	// SrlnokiaInterfaceSubinterface to block delete operations until the physical node can be
	// deprovisioned.
	SrlnokiaInterfaceSubinterfaceFinalizer string = "InterfaceSubinterface.srlinux.henderiw.be"
)
...
type SrlnokiaInterfaceSubinterfaceSpec struct {
	SrlNokiaInterfaceName         *string                  `json:"interface-name"`
	SrlnokiaInterfaceSubinterface *[]InterfaceSubinterface `json:"subinterface"`
}

// SrlnokiaInterfaceSubinterfaceStatus struct
type SrlnokiaInterfaceSubinterfaceStatus struct {
	...
	UsedSpec *SrlnokiaInterfaceSubinterfaceSpec `json:"usedSpec,omitempty"`
...
// SrlnokiaInterfaceSubinterface is the Schema for the SrlnokiaInterfaceSubinterfaces API
type SrlnokiaInterfaceSubinterface struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SrlnokiaInterfaceSubinterfaceSpec   `json:"spec,omitempty"`
	Status SrlnokiaInterfaceSubinterfaceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SrlnokiaInterfaceSubinterfaceList contains a list of SrlnokiaInterfaceSubinterfaces
type SrlnokiaInterfaceSubinterfaceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SrlnokiaInterfaceSubinterface `json:"items"`
}

func init() {
	SchemeBuilder.Register(&SrlnokiaInterfaceSubinterface{}, &SrlnokiaInterfaceSubinterfaceList{})
}

// NewEvent creates a new event associated with the object and ready
// to be published to the kubernetes API.
func (o *SrlnokiaInterfaceSubinterface) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
		...
		InvolvedObject: corev1.ObjectReference{
			Kind:       "SrlnokiaInterfaceSubinterface",
...
func (o *SrlnokiaInterfaceSubinterface) SetConfigStatus(t *string, c *ConfigStatus) {
	o.Status.Target[*t].ConfigStatus = c
}
func (o *SrlnokiaInterfaceSubinterface) SetConfigStatusDetails(t *string, c *string) {
