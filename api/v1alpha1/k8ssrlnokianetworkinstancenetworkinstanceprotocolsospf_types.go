...
type SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStatus struct {
	...
	UsedSpec *SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfSpec `json:"usedSpec,omitempty"`
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
		...
		InvolvedObject: corev1.ObjectReference{
			Kind:       "SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf",
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf) SetConfigStatus(t *string, c *ConfigStatus) {
