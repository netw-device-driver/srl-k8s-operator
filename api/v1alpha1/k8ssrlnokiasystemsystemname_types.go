...
type SrlNokiaSystemSystemNameStatus struct {
	...
	UsedSpec *SrlNokiaSystemSystemNameSpec `json:"usedSpec,omitempty"`
...
func (o *K8sSrlNokiaSystemSystemName) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
...
func (o *K8sSrlNokiaSystemSystemName) SetConfigStatus(t *string, c *ConfigStatus) {
