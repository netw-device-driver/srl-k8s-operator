...
const (
	// SrlNetworkinstanceFinalizer is the name of the finalizer added to
	// SrlNetworkinstance to block delete operations until the physical node can be
	// deprovisioned.
	SrlNetworkinstanceFinalizer string = "NetworkInstance.srlinux.henderiw.be"
)
...
type SrlNetworkinstanceSpec struct {
	SrlNetworkinstance *[]Networkinstance `json:"network-instance"`
}

// SrlNetworkinstanceStatus struct
type SrlNetworkinstanceStatus struct {
	...
	ConfigurationDependencyInternalLeafrefValidationDetails map[string]*ValidationDetails2 `json:"internalLeafrefValidationDetails,omitempty"`

	// Target provides the status of the configuration on the device
	Target map[string]*TargetStatus `json:"targetStatus,omitempty"`

	// UsedSpec provides the spec used for the configuration
	UsedSpec *SrlNetworkinstanceSpec `json:"usedSpec,omitempty"`
...
// SrlNetworkinstance is the Schema for the SrlNetworkinstances API
type SrlNetworkinstance struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   SrlNetworkinstanceSpec   `json:"spec,omitempty"`
	Status SrlNetworkinstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// SrlNetworkinstanceList contains a list of SrlNetworkinstances
...
func (o *SrlNetworkinstance) NewEvent(reason, message string) corev1.Event {
	t := metav1.Now()
	return corev1.Event{
...
func (o *SrlNetworkinstance) SetConfigStatus(t *string, c *ConfigStatus) {
	o.Status.Target[*t].ConfigStatus = c
}
func (o *SrlNetworkinstance) SetConfigStatusDetails(t *string, c *string) {
