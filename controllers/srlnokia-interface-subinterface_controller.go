...
var InterfaceSubinterfaceIntraResourceleafRef = map[string]*LeafRef{}

var InterfaceSubinterfaceInterResourceleafRef = map[string]*LeafRef{
	"/interface/subinterface/acl/input/ipv4-filter": {
		AbsoluteLeafRefPath: "/acl",
		RelativeLeafRefPath: "",
	...
	"/interface/subinterface/qos/input/classifiers/dscp": {
		AbsoluteLeafRefPath: "/qos/classifiers",
		RelativeLeafRefPath: "",
	...
	"/interface/subinterface/qos/output/rewrite-rules/dscp": {
		AbsoluteLeafRefPath: "/qos/rewrite-rules",
		RelativeLeafRefPath: "",
		ElementName:         "dscp-policy",
		KeyName:             "name",
	},
...
// the SrlnokiaInterfaceSubinterface object against the actual cluster state, and then
