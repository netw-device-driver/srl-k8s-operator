...
// SrlnokiaInterfaceSubinterfaceReconciler reconciles a SrlnokiaInterfaceSubinterface object
type SrlnokiaInterfaceSubinterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaInterfaceSubinterfaceTargetReconcileInfo struct {
	Target map[string]*SrlnokiaInterfaceSubinterfaceReconcileInfo
}

type SrlnokiaInterfaceSubinterfaceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiainterfacesubinterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiainterfacesubinterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiainterfacesubinterfaces/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaInterfaceSubinterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaInterfaceSubinterface{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaInterfaceSubinterface.
func (r *SrlnokiaInterfaceSubinterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaInterfaceSubinterfaceList{}
...
func (r *SrlnokiaInterfaceSubinterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaInterfaceSubinterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaInterfaceSubinterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaInterfaceSubinterface config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaInterfaceSubinterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaInterfaceSubinterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaInterfaceSubinterfaceFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaInterfaceSubinterface" + "." + strcase.UpperCamelCase(o.Name)
	hkey0 := *o.Spec.SrlNokiaInterfaceName
	hkeys1 := make([]string, 0)
	for _, n := range *o.Spec.SrlnokiaInterfaceSubinterface {
	...
	info := make(map[string]*SrlnokiaInterfaceSubinterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaInterfaceSubinterfaceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaInterfaceSubinterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaInterfaceSubinterfacehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaInterfaceSubinterfaceFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaInterfaceSubinterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaInterfaceSubinterfacelogResult(info *SrlnokiaInterfaceSubinterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaInterfaceSubinterface",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaInterfaceSubinterfaceReconciler) saveSrlnokiaInterfaceSubinterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaInterfaceSubinterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaInterfaceSubinterface ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaInterfaceSubinterfaceReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaInterfaceSubinterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface) ([]*Target, bool, error) {
...
// SrlnokiaInterfaceSubinterfacehasFinalizer checks if object has finalizer
func SrlnokiaInterfaceSubinterfacehasFinalizer(o *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaInterfaceSubinterfaceFinalizer)
}

func (info *SrlnokiaInterfaceSubinterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaInterfaceSubinterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaInterfaceSubinterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlnokiaInterfaceSubinterface {
...
type SrlnokiaInterfaceSubinterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface
	Reconciler *SrlnokiaInterfaceSubinterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaInterfaceSubinterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaInterfaceSubinterfaceStateMachine(o *srlinuxv1alpha1.SrlnokiaInterfaceSubinterface,
	reconciler *SrlnokiaInterfaceSubinterfaceReconciler, n *string,
	info *SrlnokiaInterfaceSubinterfaceReconcileInfo) *SrlnokiaInterfaceSubinterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaInterfaceSubinterfaceStateMachine{
		Object:     o,
...
type SrlnokiaInterfaceSubinterfacestateHandler func(*SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult

func (o *SrlnokiaInterfaceSubinterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaInterfaceSubinterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaInterfaceSubinterfacestateHandler{
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) updateSrlnokiaInterfaceSubinterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaInterfaceSubinterfaceReconcileInfo) {
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) ReconcileState(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaInterfaceSubinterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaInterfaceSubinterfaceStateMachine deletion")
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaInterfaceSubinterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) handleNone(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) handleConfiguring(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) handleDeleting(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) DeleteFailed(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaInterfaceSubinterfaceStateMachine) DeleteSuccess(info *SrlnokiaInterfaceSubinterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
