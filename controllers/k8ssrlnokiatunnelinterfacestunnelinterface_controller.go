...
// K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler reconciles a SrlNokiaTunnelInterfacesTunnelInterface object
type K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaTunnelInterfacesTunnelInterfaceTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo
}

type K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiatunnelinterfacestunnelinterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiatunnelinterfacestunnelinterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiatunnelinterfacestunnelinterfaces/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaTunnelInterfacesTunnelInterface.
func (r *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterfaceList{}
...
// the SrlNokiaTunnelInterfacesTunnelInterface object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaTunnelInterfacesTunnelInterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaTunnelInterfacesTunnelInterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaTunnelInterfacesTunnelInterface config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaTunnelInterfacesTunnelInterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaTunnelInterfacesTunnelInterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaTunnelInterfacesTunnelInterfaceFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaTunnelInterfacesTunnelInterfaceStatus(ctx, o); err != nil {
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaTunnelInterfacesTunnelInterface" + "." + strcase.UpperCamelCase(o.Name)

	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlNokiaTunnelInterfacesTunnelInterface {
	...
	info := make(map[string]*K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaTunnelInterfacesTunnelInterfacehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaTunnelInterfacesTunnelInterfaceFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaTunnelInterfacesTunnelInterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaTunnelInterfacesTunnelInterfacelogResult(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaTunnelInterfacesTunnelInterface",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler) saveK8sSrlNokiaTunnelInterfacesTunnelInterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaTunnelInterfacesTunnelInterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaTunnelInterfacesTunnelInterface ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface) ([]*Target, bool, error) {
...
// SrlNokiaTunnelInterfacesTunnelInterfacehasFinalizer checks if object has finalizer
func SrlNokiaTunnelInterfacesTunnelInterfacehasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaTunnelInterfacesTunnelInterfaceFinalizer)
}

func (info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaTunnelInterfacesTunnelInterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlNokiaTunnelInterfacesTunnelInterface {
		o := make([]srlinuxv1alpha1.SrlNokiaTunnelInterfacesTunnelInterface, 0)
		o = append(o, obj)
		dd := struct {
			TunnelInterface *[]srlinuxv1alpha1.SrlNokiaTunnelInterfacesTunnelInterface `json:"tunnel-interface"`
		}{
			TunnelInterface: &o,
		}
...
type K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface
	Reconciler *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaTunnelInterfacesTunnelInterface,
	reconciler *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconciler, n *string,
	info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine{
		Object:     o,
...
type SrlNokiaTunnelInterfacesTunnelInterfacestateHandler func(*K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult

func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaTunnelInterfacesTunnelInterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaTunnelInterfacesTunnelInterfacestateHandler{
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) updateK8sSrlNokiaTunnelInterfacesTunnelInterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) {
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) ReconcileState(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaTunnelInterfacesTunnelInterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine deletion")
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaTunnelInterfacesTunnelInterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) handleNone(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) handleConfiguring(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) handleDeleting(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) DeleteFailed(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaTunnelInterfacesTunnelInterfaceStateMachine) DeleteSuccess(info *K8sSrlNokiaTunnelInterfacesTunnelInterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
