	...
	*/
	...
	var NetworkinstanceProtocolsBgpevpnIntraResourceleafRef= map[string]*LeafRef{
	}

	var NetworkinstanceProtocolsBgpevpnInterResourceleafRef = map[string]*LeafRef{
		"/network-instance/protocols/bgp-evpn/bgp-instance/id" : {
			AbsoluteLeafRefPath: "/network-instance/protocols/bgp-vpn",
			RelativeLeafRefPath: "",
	...
	// the SrlnokiaNetworkinstanceProtocolsBgpevpn object against the actual cluster state, and then
