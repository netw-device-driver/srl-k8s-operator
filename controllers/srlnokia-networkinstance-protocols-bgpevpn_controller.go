...
var NetworkinstanceProtocolsBgpevpnInterResourceleafRef = map[string]*ElementWithLeafRef{
	...
	"/network-instance/protocols/bgp-evpn/bgp-instance/vxlan-interface": {
...
// SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler reconciles a SrlnokiaNetworkinstanceProtocolsBgpevpn object
type SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceProtocolsBgpevpnTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo
}

type SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsbgpevpns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsbgpevpns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsbgpevpns/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceProtocolsBgpevpn.
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpnList{}
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsBgpevpn) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsBgpevpnIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaNetworkinstanceProtocolsBgpevpn", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceProtocolsBgpevpn")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceProtocolsBgpevpn config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaNetworkinstanceProtocolsBgpevpn)
	if err != nil {
	...
	if err := r.saveSrlnokiaNetworkinstanceProtocolsBgpevpnStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpnFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpnFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceProtocolsBgpevpn" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpnFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceProtocolsBgpevpnlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceProtocolsBgpevpnlogResult(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceProtocolsBgpevpn",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) saveSrlnokiaNetworkinstanceProtocolsBgpevpnStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceProtocolsBgpevpn",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceProtocolsBgpevpn ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceProtocolsBgpevpnhasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceProtocolsBgpevpnhasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpnFinalizer)
}

func (info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsBgpevpnhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		BgpEvpn: info.o.Spec.SrlnokiaNetworkinstanceProtocolsBgpevpn,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn
	Reconciler *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpevpn,
	reconciler *SrlnokiaNetworkinstanceProtocolsBgpevpnReconciler, n *string,
	info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceProtocolsBgpevpnstateHandler func(*SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsBgpevpnstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsBgpevpnstateHandler{
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) updateSrlnokiaNetworkinstanceProtocolsBgpevpnStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceProtocolsBgpevpnStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsBgpevpnhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) handleNone(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpevpnStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	return actionComplete{}
}
