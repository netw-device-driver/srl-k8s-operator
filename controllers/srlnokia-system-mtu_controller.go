	...
	*/
	...
	var SystemMtuIntraResourceleafRef= map[string]*LeafRef{
	}

	var SystemMtuInterResourceleafRef = map[string]*LeafRef{
	}
	...
	// the SrlnokiaSystemMtu object against the actual cluster state, and then
