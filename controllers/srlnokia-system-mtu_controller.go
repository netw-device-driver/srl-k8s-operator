...
// SrlnokiaSystemMtuReconciler reconciles a SrlnokiaSystemMtu object
type SrlnokiaSystemMtuReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaSystemMtuTargetReconcileInfo struct {
	Target map[string]*SrlnokiaSystemMtuReconcileInfo
}

type SrlnokiaSystemMtuReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaSystemMtu
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemmtus,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemmtus/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemmtus/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaSystemMtuReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaSystemMtu{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaSystemMtu.
func (r *SrlnokiaSystemMtuReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaSystemMtuList{}
...
func (r *SrlnokiaSystemMtuReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaSystemMtuReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaSystemMtuReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.SystemMtu) (err error) {
	...
	for _, elementWithleafref := range SystemMtuIntraResourceleafRef {
...
func (r *SrlnokiaSystemMtuReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaSystemMtu", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaSystemMtu")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaSystemMtu config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaSystemMtu)
	if err != nil {
	...
	if err := r.saveSrlnokiaSystemMtuStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaSystemMtuhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaSystemMtuFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaSystemMtuFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaSystemMtu" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaSystemMtuReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaSystemMtuReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaSystemMtuStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaSystemMtuhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemMtuFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaSystemMtulogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaSystemMtulogResult(info *SrlnokiaSystemMtuReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaSystemMtu",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaSystemMtuReconciler) saveSrlnokiaSystemMtuStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemMtu) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaSystemMtu",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaSystemMtu ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaSystemMtuReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemMtu) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaSystemMtuReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemMtu) ([]*Target, bool, error) {
...
// SrlnokiaSystemMtuhasFinalizer checks if object has finalizer
func SrlnokiaSystemMtuhasFinalizer(o *srlinuxv1alpha1.SrlnokiaSystemMtu) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemMtuFinalizer)
}

func (info *SrlnokiaSystemMtuReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaSystemMtuhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaSystemMtuReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Mtu: info.o.Spec.SrlnokiaSystemMtu,
	}
	d := make([][]byte, 0)
...
type SrlnokiaSystemMtuStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaSystemMtu
	Reconciler *SrlnokiaSystemMtuReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaSystemMtuReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaSystemMtuStateMachine(o *srlinuxv1alpha1.SrlnokiaSystemMtu,
	reconciler *SrlnokiaSystemMtuReconciler, n *string,
	info *SrlnokiaSystemMtuReconcileInfo) *SrlnokiaSystemMtuStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaSystemMtuStateMachine{
		Object:     o,
...
type SrlnokiaSystemMtustateHandler func(*SrlnokiaSystemMtuReconcileInfo) actionResult

func (o *SrlnokiaSystemMtuStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemMtustateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemMtustateHandler{
...
func (o *SrlnokiaSystemMtuStateMachine) updateSrlnokiaSystemMtuStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaSystemMtuReconcileInfo) {
...
func (o *SrlnokiaSystemMtuStateMachine) ReconcileState(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaSystemMtuStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaSystemMtuStateMachine deletion")
...
func (o *SrlnokiaSystemMtuStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaSystemMtuhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaSystemMtuStateMachine) handleNone(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
...
func (o *SrlnokiaSystemMtuStateMachine) handleConfiguring(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemMtuStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemMtuStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemMtuStateMachine) handleDeleting(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemMtuStateMachine) DeleteFailed(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemMtuStateMachine) DeleteSuccess(info *SrlnokiaSystemMtuReconcileInfo) actionResult {
	return actionComplete{}
}
