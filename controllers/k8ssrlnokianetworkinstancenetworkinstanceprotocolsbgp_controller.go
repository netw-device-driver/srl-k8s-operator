...
// K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler reconciles a SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp object
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo
}

type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceprotocolsbgps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceprotocolsbgps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceprotocolsbgps/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpList{}
...
// the SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgphasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStatus(ctx, o); err != nil {
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgphasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgplogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgplogResult(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler) saveK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp) ([]*Target, bool, error) {
...
// SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgphasFinalizer checks if object has finalizer
func SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgphasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpFinalizer)
}

func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgphasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Bgp *srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp `json:"bgp"`
	}{
		Bgp: info.o.Spec.SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp
	Reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgp,
	reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconciler, n *string,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine{
		Object:     o,
...
type SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpstateHandler func(*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult

func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpstateHandler{
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) updateK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) ReconcileState(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine deletion")
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsBgphasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) handleNone(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) handleConfiguring(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) handleDeleting(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) DeleteFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpStateMachine) DeleteSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsBgpReconcileInfo) actionResult {
	return actionComplete{}
}
