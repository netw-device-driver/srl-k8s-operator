...
var NetworkinstanceNexthopgroupsIntraResourceleafRef = map[string]*LeafRef{}

var NetworkinstanceNexthopgroupsInterResourceleafRef = map[string]*LeafRef{}
...
// the SrlnokiaNetworkinstanceNexthopgroups object against the actual cluster state, and then
