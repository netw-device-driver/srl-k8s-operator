...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux) ([]string, error) {
