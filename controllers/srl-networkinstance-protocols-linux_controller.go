...
var NetworkinstanceProtocolsLinuxInterResourceleafRef = map[string][]ElementKeyValue{}
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsLinuxIntraResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsLinuxIntraResourceleafRef", NetworkinstanceProtocolsLinuxIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
