...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsLinuxhasFinalizer(o) {
		...
		/*
			...
			for s, elementWithLeafRef := range NetworkinstanceProtocolsLinuxIntraResourceleafRef {
...
/*
	func (r *SrlNetworkinstanceProtocolsLinuxReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux) ([]string, []string, error) {
		...
		leafRefDependencies := make([]string, 0)
		localLeafRefPaths := make([]string, 0)
		for localLeafRef, rekvl := range NetworkinstanceProtocolsLinuxInterResourceleafRef {
			// get the ekvl for the local leafref
			ekvl := getHierarchicalElements(localLeafRef)
