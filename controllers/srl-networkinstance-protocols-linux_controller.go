...
var NetworkinstanceProtocolsLinuxInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceProtocolsLinuxExternalResourceleafRef = map[string]*ElementWithLeafRef{}
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux, cm *string) (err error) {
	...
	dd := struct {
		...
		Linux: o.Spec.SrlNetworkinstanceProtocolsLinux,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsLinuxExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsLinuxExternalResourceleafRef", NetworkinstanceProtocolsLinuxExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlNetworkinstanceProtocolsLinuxReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsLinuxInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceProtocolsLinuxInternalResourceleafRef", NetworkinstanceProtocolsLinuxInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsLinuxhasFinalizer(o) {
		if SrlNetworkinstanceProtocolsLinuxhasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsLinuxhasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceProtocolsLinux"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
...
func SrlNetworkinstanceProtocolsLinuxlogResult(info *SrlNetworkinstanceProtocolsLinuxReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsLinux")
		//info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsLinux",
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceProtocolsLinuxReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceProtocolsLinux"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsLinux.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceProtocolsLinuxReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsLinux.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceProtocolsLinux.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceProtocolsLinuxReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsLinuxReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux) (bool, *[]string, error) {
...
// SSrlNetworkinstanceProtocolsLinuxhasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceProtocolsLinuxhasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinux) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceProtocolsLinuxFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceProtocolsLinuxReconcileInfo) DeleteCache() error {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsLinuxReconcileInfo) UpdateCache(path string) error {
...
func (o *SrlNetworkinstanceProtocolsLinuxStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsLinuxStateMachine) handleConfigureFailed(info *SrlNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsLinuxStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceProtocolsLinuxStateMachine) handleDeleteFailed(info *SrlNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
