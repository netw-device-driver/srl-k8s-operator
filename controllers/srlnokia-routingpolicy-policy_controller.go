...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) validateIfElementWithLeafRefExists(last bool, e string, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) validateLeafRefExists(last bool, e string, o interface{}, leafrefValue string) (interface{}, bool) {
	xType := reflect.TypeOf(o)
	xValue := reflect.ValueOf(o)
	r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.RoutingpolicyPolicy) (err error) {
	...
	for _, elementWithleafref := range RoutingpolicyPolicyInterResourceleafRef {
