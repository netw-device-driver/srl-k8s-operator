...
var RoutingpolicyPolicyIntraResourceleafRef = map[string]*LeafRef{}

var RoutingpolicyPolicyInterResourceleafRef = map[string]*LeafRef{
...
// the SrlnokiaRoutingpolicyPolicy object against the actual cluster state, and then
