...
var RoutingpolicyPolicyInterResourceleafRef = map[string]*ElementWithLeafRef{
	"/routing-policy/policy/default-action/accept/bgp/communities/add": {
	...
	"/routing-policy/policy/default-action/accept/bgp/communities/remove": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
		ElementName:                    "community-set",
	...
	"/routing-policy/policy/default-action/accept/bgp/communities/replace": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
		ElementName:                    "community-set",
	...
	"/routing-policy/policy/statement/action/accept/bgp/communities/add": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
		ElementName:                    "community-set",
	...
	"/routing-policy/policy/statement/action/accept/bgp/communities/remove": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
		ElementName:                    "community-set",
	...
	"/routing-policy/policy/statement/action/accept/bgp/communities/replace": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
		ElementName:                    "community-set",
	...
	"/routing-policy/policy/statement/match/bgp/as-path-set": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
	...
	"/routing-policy/policy/statement/match/bgp/community-set": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
		ElementName:                    "community-set",
	...
	"/routing-policy/policy/statement/match/prefix-set": {
		AbsolutePath2LeafRef:           "/routing-policy",
		RelativePath2LeafRef:           "",
		RelativePath2ObjectWithLeafRef: "",
...
// SrlnokiaRoutingpolicyPolicyReconciler reconciles a SrlnokiaRoutingpolicyPolicy object
type SrlnokiaRoutingpolicyPolicyReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaRoutingpolicyPolicyTargetReconcileInfo struct {
	Target map[string]*SrlnokiaRoutingpolicyPolicyReconcileInfo
}

type SrlnokiaRoutingpolicyPolicyReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiaroutingpolicypolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiaroutingpolicypolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiaroutingpolicypolicies/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaRoutingpolicyPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaRoutingpolicyPolicy.
func (r *SrlnokiaRoutingpolicyPolicyReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicyList{}
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.RoutingpolicyPolicy) (err error) {
	...
	for _, elementWithleafref := range RoutingpolicyPolicyIntraResourceleafRef {
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaRoutingpolicyPolicy", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaRoutingpolicyPolicy")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaRoutingpolicyPolicy config")
	...
	for _, vo := range *o.Spec.SrlnokiaRoutingpolicyPolicy {
	...
	if err := r.saveSrlnokiaRoutingpolicyPolicyStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaRoutingpolicyPolicyhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicyFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicyFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaRoutingpolicyPolicy" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlnokiaRoutingpolicyPolicy {
	...
	for _, hkey0 := range hkeys0 {
		deletepaths = append(deletepaths, fmt.Sprintf("/routing-policy/policy[name=%s]", hkey0))
	}

	// path to be used for this object
	path := "/routing-policy"

	info := make(map[string]*SrlnokiaRoutingpolicyPolicyReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaRoutingpolicyPolicyReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaRoutingpolicyPolicyStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaRoutingpolicyPolicyhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicyFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaRoutingpolicyPolicylogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaRoutingpolicyPolicylogResult(info *SrlnokiaRoutingpolicyPolicyReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaRoutingpolicyPolicy",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaRoutingpolicyPolicyReconciler) saveSrlnokiaRoutingpolicyPolicyStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaRoutingpolicyPolicy",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaRoutingpolicyPolicy ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaRoutingpolicyPolicyReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaRoutingpolicyPolicyReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy) ([]*Target, bool, error) {
...
// SrlnokiaRoutingpolicyPolicyhasFinalizer checks if object has finalizer
func SrlnokiaRoutingpolicyPolicyhasFinalizer(o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicyFinalizer)
}

func (info *SrlnokiaRoutingpolicyPolicyReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaRoutingpolicyPolicyhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaRoutingpolicyPolicyReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlnokiaRoutingpolicyPolicy {
...
type SrlnokiaRoutingpolicyPolicyStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy
	Reconciler *SrlnokiaRoutingpolicyPolicyReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaRoutingpolicyPolicyReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaRoutingpolicyPolicyStateMachine(o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPolicy,
	reconciler *SrlnokiaRoutingpolicyPolicyReconciler, n *string,
	info *SrlnokiaRoutingpolicyPolicyReconcileInfo) *SrlnokiaRoutingpolicyPolicyStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaRoutingpolicyPolicyStateMachine{
		Object:     o,
...
type SrlnokiaRoutingpolicyPolicystateHandler func(*SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult

func (o *SrlnokiaRoutingpolicyPolicyStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaRoutingpolicyPolicystateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaRoutingpolicyPolicystateHandler{
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) updateSrlnokiaRoutingpolicyPolicyStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaRoutingpolicyPolicyReconcileInfo) {
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) ReconcileState(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaRoutingpolicyPolicyStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaRoutingpolicyPolicyStateMachine deletion")
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaRoutingpolicyPolicyhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) handleNone(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) handleConfiguring(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) handleDeleting(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) DeleteFailed(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPolicyStateMachine) DeleteSuccess(info *SrlnokiaRoutingpolicyPolicyReconcileInfo) actionResult {
	return actionComplete{}
}
