...
var TunnelinterfaceIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var TunnelinterfaceInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var TunnelinterfaceInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlTunnelinterfaceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlTunnelinterfaceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlTunnelinterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterface) (err error) {
	...
	for localLeafRef, leafRefInfo := range TunnelinterfaceIntraResourceleafRef {
	...
	r.Log.WithValues("TunnelinterfaceIntraResourceleafRef", TunnelinterfaceIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
