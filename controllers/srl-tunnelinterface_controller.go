...
/*
	func (r *SrlTunnelinterfaceReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.Tunnelinterface) (err error) {
		// marshal data to json
		dd := struct {
			TunnelInterface *srlinuxv1alpha1.Tunnelinterface `json:"tunnel-interface"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range TunnelinterfaceIntraResourceleafRef {
...
func (r *SrlTunnelinterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlTunnelinterfacehasFinalizer(o) {
		...
		/*
			validationSuccess := true
			for _, vo := range *o.Spec.SrlTunnelinterface {
...
/*
	func (r *SrlTunnelinterfaceReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterface) ([]string, []string, error) {
