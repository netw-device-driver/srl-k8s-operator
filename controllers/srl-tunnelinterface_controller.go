...
func (r *SrlTunnelinterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (info *SrlTunnelinterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlTunnelinterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
