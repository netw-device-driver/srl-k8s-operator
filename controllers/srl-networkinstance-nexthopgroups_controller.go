...
var NetworkinstanceNexthopgroupsInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceNexthopgroupsExternalResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlNetworkinstanceNexthopgroupsReconciler reconciles a SrlNetworkinstanceNexthopgroups object
type SrlNetworkinstanceNexthopgroupsReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlNetworkinstanceNexthopgroupsTargetReconcileInfo struct {
	Target map[string]*SrlNetworkinstanceNexthopgroupsReconcileInfo
}

type SrlNetworkinstanceNexthopgroupsReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstancenexthopgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstancenexthopgroups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstancenexthopgroups/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlNetworkinstanceNexthopgroupsReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlNetworkinstanceNexthopgroups", request.NamespacedName)
...
/*
	func (r *SrlNetworkinstanceNexthopgroupsReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups)
		if !(oldOK && newOK) {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups{}).
...
// request for reconciliation of SrlNetworkinstanceNexthopgroups.
func (r *SrlNetworkinstanceNexthopgroupsReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlNetworkinstanceNexthopgroupsList{}
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups, cm *string) (err error) {
	...
	dd := struct {
		...
		NextHopGroups: o.Spec.SrlNetworkinstanceNexthopgroups,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceNexthopgroupsExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceNexthopgroupsExternalResourceleafRef", NetworkinstanceNexthopgroupsExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlNetworkinstanceNexthopgroupsReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceNexthopgroupsInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceNexthopgroupsInternalResourceleafRef", NetworkinstanceNexthopgroupsInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlNetworkinstanceNexthopgroupsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlNetworkinstanceNexthopgroups", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlNetworkinstanceNexthopgroups")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlNetworkinstanceNexthopgroups config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNetworkinstanceNexthopgroupshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNetworkinstanceNexthopgroupsFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNetworkinstanceNexthopgroupsFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(o) {
		if SrlNetworkinstanceNexthopgroupshasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(o) {
		...
		if err := r.saveSrlNetworkinstanceNexthopgroupsStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceNexthopgroupsFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlNetworkinstanceNexthopgroups" + "." + strcase.UpperCamelCase(o.Name)
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceNexthopgroups"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlNetworkinstanceNexthopgroupsReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlNetworkinstanceNexthopgroupsReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlNetworkinstanceNexthopgroupsStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlNetworkinstanceNexthopgroupslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNetworkinstanceNexthopgroupslogResult(info *SrlNetworkinstanceNexthopgroupsReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceNexthopgroups")
		//info.log.Info("stopping reconcile SrlNetworkinstanceNexthopgroups",
		//	"message", info.o.Status)
	}
}

func (r *SrlNetworkinstanceNexthopgroupsReconciler) saveSrlNetworkinstanceNexthopgroupsStatus(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlNetworkinstanceNexthopgroups",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlNetworkinstanceNexthopgroups ")
		return err
	}
	return nil
}

func (r *SrlNetworkinstanceNexthopgroupsReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceNexthopgroupsReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceNexthopgroups"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceNexthopgroups.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceNexthopgroupsReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceNexthopgroups.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceNexthopgroups.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceNexthopgroupsReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) (bool, *[]string, error) {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) ([]*Target, bool, error) {
...
// SrlNetworkinstanceNexthopgroupshasFinalizer checks if object has finalizer
func SrlNetworkinstanceNexthopgroupshasFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceNexthopgroupsFinalizer)
}

// SSrlNetworkinstanceNexthopgroupshasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceNexthopgroupshasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceNexthopgroupsFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceNexthopgroupsReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(info.o) {
...
// Update Cache
func (info *SrlNetworkinstanceNexthopgroupsReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	dd := struct {
		NextHopGroups *srlinuxv1alpha1.NetworkinstanceNexthopgroups `json:"next-hop-groups"`
	}{
		NextHopGroups: info.o.Spec.SrlNetworkinstanceNexthopgroups,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlNetworkinstanceNexthopgroupsStateMachine struct {
	Object     *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups
	Reconciler *SrlNetworkinstanceNexthopgroupsReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlNetworkinstanceNexthopgroupsReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlNetworkinstanceNexthopgroupsStateMachine(o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups,
	reconciler *SrlNetworkinstanceNexthopgroupsReconciler, n *string,
	info *SrlNetworkinstanceNexthopgroupsReconcileInfo) *SrlNetworkinstanceNexthopgroupsStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlNetworkinstanceNexthopgroupsStateMachine{
		Object:     o,
...
type SrlNetworkinstanceNexthopgroupsstateHandler func(*SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult

func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceNexthopgroupsstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceNexthopgroupsstateHandler{
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) updateSrlNetworkinstanceNexthopgroupsStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlNetworkinstanceNexthopgroupsReconcileInfo) {
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) ReconcileState(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlNetworkinstanceNexthopgroupsStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlNetworkinstanceNexthopgroupsStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleNone(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleConfiguring(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleConfigureFailed(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleDeleting(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleDeleteFailed(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
