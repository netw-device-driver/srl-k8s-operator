...
var NetworkinstanceNexthopgroupsInterResourceleafRef = map[string][]ElementKeyValue{}
...
/*
	...
	func (r *SrlNetworkinstanceNexthopgroupsReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlNetworkinstanceNexthopgroupsReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceNexthopgroups) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceNexthopgroupsIntraResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceNexthopgroupsIntraResourceleafRef", NetworkinstanceNexthopgroupsIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
