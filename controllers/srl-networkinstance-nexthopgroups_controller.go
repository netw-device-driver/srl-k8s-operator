...
func SrlNetworkinstanceNexthopgroupslogResult(info *SrlNetworkinstanceNexthopgroupsReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlNetworkinstanceNexthopgroups",
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleConfigStatusConfigureSuccess(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) handleConfigStatusConfigureFailed(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) DeleteFailed(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceNexthopgroupsStateMachine) DeleteSuccess(info *SrlNetworkinstanceNexthopgroupsReconcileInfo) actionResult {
	return actionComplete{}
}
