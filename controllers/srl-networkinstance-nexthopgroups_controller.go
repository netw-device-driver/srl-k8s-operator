...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlNetworkinstanceNexthopgroupsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceNexthopgroupshasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlNetworkinstanceNexthopgroups)
		if err != nil {
...
func (info *SrlNetworkinstanceNexthopgroupsReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlNetworkinstanceNexthopgroupsReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
