...
// SrlnokiaSystemNameReconciler reconciles a SrlnokiaSystemName object
type SrlnokiaSystemNameReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaSystemNameTargetReconcileInfo struct {
	Target map[string]*SrlnokiaSystemNameReconcileInfo
}

type SrlnokiaSystemNameReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaSystemName
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemnames,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemnames/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemnames/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaSystemNameReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaSystemName{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaSystemName.
func (r *SrlnokiaSystemNameReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaSystemNameList{}
...
func (r *SrlnokiaSystemNameReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaSystemNameReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaSystemNameReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.SystemName) (err error) {
	...
	for _, elementWithleafref := range SystemNameIntraResourceleafRef {
...
func (r *SrlnokiaSystemNameReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaSystemName", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaSystemName")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaSystemName config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaSystemName)
	if err != nil {
	...
	if err := r.saveSrlnokiaSystemNameStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaSystemNamehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaSystemNameFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaSystemNameFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaSystemName" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaSystemNameReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaSystemNameReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaSystemNameStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaSystemNamehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemNameFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaSystemNamelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaSystemNamelogResult(info *SrlnokiaSystemNameReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaSystemName",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaSystemNameReconciler) saveSrlnokiaSystemNameStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemName) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaSystemName",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaSystemName ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaSystemNameReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemName) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaSystemNameReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemName) ([]*Target, bool, error) {
...
// SrlnokiaSystemNamehasFinalizer checks if object has finalizer
func SrlnokiaSystemNamehasFinalizer(o *srlinuxv1alpha1.SrlnokiaSystemName) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemNameFinalizer)
}

func (info *SrlnokiaSystemNameReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaSystemNamehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaSystemNameReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Name: info.o.Spec.SrlnokiaSystemName,
	}
	d := make([][]byte, 0)
...
type SrlnokiaSystemNameStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaSystemName
	Reconciler *SrlnokiaSystemNameReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaSystemNameReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaSystemNameStateMachine(o *srlinuxv1alpha1.SrlnokiaSystemName,
	reconciler *SrlnokiaSystemNameReconciler, n *string,
	info *SrlnokiaSystemNameReconcileInfo) *SrlnokiaSystemNameStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaSystemNameStateMachine{
		Object:     o,
...
type SrlnokiaSystemNamestateHandler func(*SrlnokiaSystemNameReconcileInfo) actionResult

func (o *SrlnokiaSystemNameStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemNamestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemNamestateHandler{
...
func (o *SrlnokiaSystemNameStateMachine) updateSrlnokiaSystemNameStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaSystemNameReconcileInfo) {
...
func (o *SrlnokiaSystemNameStateMachine) ReconcileState(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaSystemNameStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaSystemNameStateMachine deletion")
...
func (o *SrlnokiaSystemNameStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaSystemNamehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaSystemNameStateMachine) handleNone(info *SrlnokiaSystemNameReconcileInfo) actionResult {
...
func (o *SrlnokiaSystemNameStateMachine) handleConfiguring(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNameStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNameStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNameStateMachine) handleDeleting(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNameStateMachine) DeleteFailed(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNameStateMachine) DeleteSuccess(info *SrlnokiaSystemNameReconcileInfo) actionResult {
	return actionComplete{}
}
