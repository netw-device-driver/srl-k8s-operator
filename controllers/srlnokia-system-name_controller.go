...
var SystemNameIntraResourceleafRef = map[string]*LeafRef{}

var SystemNameInterResourceleafRef = map[string]*LeafRef{}
...
// the SrlnokiaSystemName object against the actual cluster state, and then
