...
// K8sSrlNokiaBfdBfdReconciler reconciles a SrlNokiaBfdBfd object
type K8sSrlNokiaBfdBfdReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaBfdBfdTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaBfdBfdReconcileInfo
}

type K8sSrlNokiaBfdBfdReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaBfdBfd
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiabfdbfds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiabfdbfds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiabfdbfds/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaBfdBfdReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaBfdBfd{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaBfdBfd.
func (r *K8sSrlNokiaBfdBfdReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaBfdBfdList{}
...
// the SrlNokiaBfdBfd object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaBfdBfdReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaBfdBfd", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaBfdBfd")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaBfdBfd config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaBfdBfdhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaBfdBfdFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaBfdBfdFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaBfdBfdStatus(ctx, o); err != nil {
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaBfdBfd" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaBfdBfdReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaBfdBfdReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaBfdBfdStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaBfdBfdhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaBfdBfdFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaBfdBfdlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaBfdBfdlogResult(info *K8sSrlNokiaBfdBfdReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaBfdBfd",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaBfdBfdReconciler) saveK8sSrlNokiaBfdBfdStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaBfdBfd) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaBfdBfd",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaBfdBfd ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaBfdBfdReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaBfdBfd) ([]*Target, bool, error) {
...
// SrlNokiaBfdBfdhasFinalizer checks if object has finalizer
func SrlNokiaBfdBfdhasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaBfdBfd) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaBfdBfdFinalizer)
}

func (info *K8sSrlNokiaBfdBfdReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaBfdBfdhasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaBfdBfdReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Bfd *srlinuxv1alpha1.SrlNokiaBfdBfd `json:"bfd"`
	}{
		Bfd: info.o.Spec.SrlNokiaBfdBfd,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaBfdBfdStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaBfdBfd
	Reconciler *K8sSrlNokiaBfdBfdReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaBfdBfdReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaBfdBfdStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaBfdBfd,
	reconciler *K8sSrlNokiaBfdBfdReconciler, n *string,
	info *K8sSrlNokiaBfdBfdReconcileInfo) *K8sSrlNokiaBfdBfdStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaBfdBfdStateMachine{
		Object:     o,
...
type SrlNokiaBfdBfdstateHandler func(*K8sSrlNokiaBfdBfdReconcileInfo) actionResult

func (o *K8sSrlNokiaBfdBfdStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaBfdBfdstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaBfdBfdstateHandler{
...
func (o *K8sSrlNokiaBfdBfdStateMachine) updateK8sSrlNokiaBfdBfdStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaBfdBfdReconcileInfo) {
...
func (o *K8sSrlNokiaBfdBfdStateMachine) ReconcileState(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaBfdBfdStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaBfdBfdStateMachine deletion")
...
func (o *K8sSrlNokiaBfdBfdStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaBfdBfdhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaBfdBfdStateMachine) handleNone(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaBfdBfdStateMachine) handleConfiguring(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaBfdBfdStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaBfdBfdStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaBfdBfdStateMachine) handleDeleting(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaBfdBfdStateMachine) DeleteFailed(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaBfdBfdStateMachine) DeleteSuccess(info *K8sSrlNokiaBfdBfdReconcileInfo) actionResult {
	return actionComplete{}
}
