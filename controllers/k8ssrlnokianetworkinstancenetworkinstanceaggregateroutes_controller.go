...
// K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler reconciles a SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes object
type K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo
}

type K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceaggregateroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceaggregateroutes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceaggregateroutes/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesList{}
...
// the SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteshasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteslogResult(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler) saveK8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes) ([]*Target, bool, error) {
...
// SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteshasFinalizer checks if object has finalizer
func SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteshasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesFinalizer)
}

func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteshasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		AggregateRoutes *srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes `json:"aggregate-routes"`
	}{
		AggregateRoutes: info.o.Spec.SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes
	Reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutes,
	reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconciler, n *string,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine{
		Object:     o,
...
type SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesstateHandler func(*K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult

func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesstateHandler{
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) updateK8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) ReconcileState(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine deletion")
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceAggregateRouteshasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) handleNone(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) handleConfiguring(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) handleDeleting(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) DeleteFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesStateMachine) DeleteSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceAggregateRoutesReconcileInfo) actionResult {
	return actionComplete{}
}
