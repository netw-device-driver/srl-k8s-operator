...
func SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancelogResult(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance",
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleConfigStatusConfigureSuccess(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleConfigStatusConfigureFailed(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) DeleteFailed(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) DeleteSuccess(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	return actionComplete{}
}
