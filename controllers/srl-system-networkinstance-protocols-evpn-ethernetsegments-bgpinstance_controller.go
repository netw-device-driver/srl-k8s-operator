...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) ([]string, []string, error) {
