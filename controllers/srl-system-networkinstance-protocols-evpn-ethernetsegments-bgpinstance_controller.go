...
var SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceExternalResourceleafRef = map[string]*ElementWithLeafRef{
	"/bgp-instance[id=]": {
...
type SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceTargetReconcileInfo struct {
	Target map[string]*SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo
}
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlsystemnetworkinstanceprotocolsevpnesisbgpinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlsystemnetworkinstanceprotocolsevpnesisbgpinstances/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlsystemnetworkinstanceprotocolsevpnesisbgpinstances/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance", request.NamespacedName)
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
		if !(oldOK && newOK) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{}).
...
// request for reconciliation of SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance.
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceList{}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance, cm *string) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceExternalResourceleafRef {
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceExternalResourceleafRef", SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceExternalResourceleafRef).Info("External leafref STATUS All")
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceInternalResourceleafRef", SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o) {
		if SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o) {
		...
		if err := r.saveSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceFinalizer)
	...
	level := int32(6)
	resource := "srlinux.henderiw.be" + "." + "SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance" + "." + strcase.UpperCamelCase(o.Name)
	hkeys1 := make([]string, 0)
	for _, n := range *o.Spec.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance {
		hkeys1 = append(hkeys1, *n.Id)
	}

	dependencies := make([]string, 0)
	dependencies = append(dependencies, fmt.Sprintf("/system/network-instance/protocols/evpn"))
	//dependencies = append(dependencies, fmt.Sprintf("/evpn[=%s]", hkey0))

	deletepaths := make([]string, 0)
	for _, hkey1 := range hkeys1 {
		deletepaths = append(deletepaths, fmt.Sprintf("/system/network-instance/protocols/evpn/ethernet-segments/bgp-instance[id=%s]", hkey1))
	}

	// path to be used for this object
	path := fmt.Sprintf("/system/network-instance/protocols/evpn/ethernet-segments")
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo)
	...
	for _, target := range t {
		...
		stateMachine := newSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancelogResult(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance")
		//info.log.Info("stopping reconcile SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance",
		//	"message", info.o.Status)
	}
}

func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) saveSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance ")
		return err
	}
	return nil
}

func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance"] = string(d)
		cm.Data[fmt.Sprintf("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance.%s",*oName)] = string(d)
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) (bool, *[]string, error) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) ([]*Target, bool, error) {
...
// SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer checks if object has finalizer
func SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceFinalizer)
}

// SSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasOtherFinalizer checks if object has other finalizers
func SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasOtherFinalizer(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceFinalizer {
			return true
		}
	}
	return false
...
type SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance
	Reconciler *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance,
	reconciler *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconciler, n *string,
	info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine{
		Object:     o,
...
type SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancestateHandler func(*SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult

func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancestateHandler{
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) updateSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) {
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) ReconcileState(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateFrom(initialState, info)
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstancehasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleNone(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleConfiguring(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleConfigureSuccess(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleConfigureFailed(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleDeleting(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleDeleteSuccess(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceStateMachine) handleDeleteFailed(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
