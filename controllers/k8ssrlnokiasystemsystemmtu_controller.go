...
// K8sSrlNokiaSystemSystemMtuReconciler reconciles a SrlNokiaSystemSystemMtu object
type K8sSrlNokiaSystemSystemMtuReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaSystemSystemMtuTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaSystemSystemMtuReconcileInfo
}

type K8sSrlNokiaSystemSystemMtuReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemmtus,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemmtus/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemmtus/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaSystemSystemMtuReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaSystemSystemMtu.
func (r *K8sSrlNokiaSystemSystemMtuReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtuList{}
...
// the SrlNokiaSystemSystemMtu object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaSystemSystemMtuReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaSystemSystemMtu", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaSystemSystemMtu")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaSystemSystemMtu config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaSystemSystemMtuhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaSystemSystemMtuFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaSystemSystemMtuFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaSystemSystemMtuStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaSystemSystemMtu" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaSystemSystemMtuReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaSystemSystemMtuReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaSystemSystemMtuStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemMtuhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemMtuFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaSystemSystemMtulogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaSystemSystemMtulogResult(info *K8sSrlNokiaSystemSystemMtuReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaSystemSystemMtu",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaSystemSystemMtuReconciler) saveK8sSrlNokiaSystemSystemMtuStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaSystemSystemMtu",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaSystemSystemMtu ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaSystemSystemMtuReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu) ([]*Target, bool, error) {
...
// SrlNokiaSystemSystemMtuhasFinalizer checks if object has finalizer
func SrlNokiaSystemSystemMtuhasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemMtuFinalizer)
}

func (info *K8sSrlNokiaSystemSystemMtuReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemMtuhasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaSystemSystemMtuReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Mtu *srlinuxv1alpha1.SrlNokiaSystemSystemMtu `json:"mtu"`
	}{
		Mtu: info.o.Spec.SrlNokiaSystemSystemMtu,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaSystemSystemMtuStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu
	Reconciler *K8sSrlNokiaSystemSystemMtuReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaSystemSystemMtuReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaSystemSystemMtuStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemMtu,
	reconciler *K8sSrlNokiaSystemSystemMtuReconciler, n *string,
	info *K8sSrlNokiaSystemSystemMtuReconcileInfo) *K8sSrlNokiaSystemSystemMtuStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaSystemSystemMtuStateMachine{
		Object:     o,
...
type SrlNokiaSystemSystemMtustateHandler func(*K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult

func (o *K8sSrlNokiaSystemSystemMtuStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemMtustateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemMtustateHandler{
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) updateK8sSrlNokiaSystemSystemMtuStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaSystemSystemMtuReconcileInfo) {
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) ReconcileState(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaSystemSystemMtuStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaSystemSystemMtuStateMachine deletion")
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemMtuhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) handleNone(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) handleConfiguring(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) handleDeleting(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) DeleteFailed(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemMtuStateMachine) DeleteSuccess(info *K8sSrlNokiaSystemSystemMtuReconcileInfo) actionResult {
	return actionComplete{}
}
