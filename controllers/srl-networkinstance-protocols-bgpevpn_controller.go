...
var NetworkinstanceProtocolsBgpevpnIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var NetworkinstanceProtocolsBgpevpnInterResourceleafRef = map[string][]ElementKeyValue{
	"/bgp-evpn/bgp-instance[id=]": []ElementKeyValue{
		{"network-instance", "", ""},
		{"protocols", "", ""},
		{"bgp-vpn", "", ""},
		{"bgp-instance", "id", "string"},
	},
	"/bgp-evpn/bgp-instance[id=]/vxlan-interface": []ElementKeyValue{
		{"network-instance", "", ""},
...
/*
	var NetworkinstanceProtocolsBgpevpnInterResourceleafRef = map[string]*ElementWithLeafRef{
		"/bgp-evpn/bgp-instance[id=]" : {
			AbsolutePath2LeafRef: "/network-instance/protocols/bgp-vpn",
...
/*
	...
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpevpnIntraResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpevpnIntraResourceleafRef", NetworkinstanceProtocolsBgpevpnIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
