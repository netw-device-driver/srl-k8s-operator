...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsBgpevpn) (err error) {
		// marshal data to json
		dd := struct {
			BgpEvpn *srlinuxv1alpha1.NetworkinstanceProtocolsBgpevpn `json:"bgp-evpn"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range NetworkinstanceProtocolsBgpevpnIntraResourceleafRef {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		...
		/*
			...
			for s, elementWithLeafRef := range NetworkinstanceProtocolsBgpevpnIntraResourceleafRef {
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) ([]string, []string, error) {
		...
		leafRefDependencies := make([]string, 0)
		localLeafRefPaths := make([]string, 0)
		for localLeafRef, rekvl := range NetworkinstanceProtocolsBgpevpnInterResourceleafRef {
			// get the ekvl for the local leafref
			ekvl := getHierarchicalElements(localLeafRef)
