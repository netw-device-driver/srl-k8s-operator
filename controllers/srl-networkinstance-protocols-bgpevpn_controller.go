...
func SrlNetworkinstanceProtocolsBgpevpnlogResult(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlNetworkinstanceProtocolsBgpevpn",
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleConfigStatusConfigureSuccess(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleConfigStatusConfigureFailed(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) DeleteFailed(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) DeleteSuccess(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	return actionComplete{}
}
