...
var NetworkinstanceProtocolsBgpevpnInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceProtocolsBgpevpnExternalResourceleafRef = map[string]*ElementWithLeafRef{
	"/bgp-evpn/bgp-instance[id=]": {
	...
	"/bgp-evpn/bgp-instance[id=]/vxlan-interface": {
		REkvl: []ElementKeyValue{
			{"network-instance", "", ""},
...
// SrlNetworkinstanceProtocolsBgpevpnReconciler reconciles a SrlNetworkinstanceProtocolsBgpevpn object
type SrlNetworkinstanceProtocolsBgpevpnReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlNetworkinstanceProtocolsBgpevpnTargetReconcileInfo struct {
	Target map[string]*SrlNetworkinstanceProtocolsBgpevpnReconcileInfo
}

type SrlNetworkinstanceProtocolsBgpevpnReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgpevpns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgpevpns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgpevpns/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlNetworkinstanceProtocolsBgpevpn", request.NamespacedName)
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn)
		if !(oldOK && newOK) {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn{}).
...
// request for reconciliation of SrlNetworkinstanceProtocolsBgpevpn.
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpnList{}
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	dd := struct {
		BgpEvpn *srlinuxv1alpha1.NetworkinstanceProtocolsBgpevpn `json:"bgp-evpn"`
	}{
		BgpEvpn: o.Spec.SrlNetworkinstanceProtocolsBgpevpn,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpevpnExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpevpnExternalResourceleafRef", NetworkinstanceProtocolsBgpevpnExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpevpnInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpevpnInternalResourceleafRef", NetworkinstanceProtocolsBgpevpnInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlNetworkinstanceProtocolsBgpevpn", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlNetworkinstanceProtocolsBgpevpn")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlNetworkinstanceProtocolsBgpevpn config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpnFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpnFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		if SrlNetworkinstanceProtocolsBgpevpnhasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		...
		if err := r.saveSrlNetworkinstanceProtocolsBgpevpnStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpnFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlNetworkinstanceProtocolsBgpevpn" + "." + strcase.UpperCamelCase(o.Name)
	...
	deletepaths = append(deletepaths, fmt.Sprintf("/network-instance[name=%s]/protocols/bgp-evpn", hkey0))
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceProtocolsBgpevpn"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlNetworkinstanceProtocolsBgpevpnReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlNetworkinstanceProtocolsBgpevpnReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlNetworkinstanceProtocolsBgpevpnStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlNetworkinstanceProtocolsBgpevpnlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNetworkinstanceProtocolsBgpevpnlogResult(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsBgpevpn")
		//info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsBgpevpn",
		//	"message", info.o.Status)
	}
}

func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) saveSrlNetworkinstanceProtocolsBgpevpnStatus(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlNetworkinstanceProtocolsBgpevpn",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlNetworkinstanceProtocolsBgpevpn ")
		return err
	}
	return nil
}

func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceProtocolsBgpevpn"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsBgpevpn.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsBgpevpn.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceProtocolsBgpevpn.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) (bool, *[]string, error) {
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) ([]*Target, bool, error) {
...
// SrlNetworkinstanceProtocolsBgpevpnhasFinalizer checks if object has finalizer
func SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpnFinalizer)
}

// SSrlNetworkinstanceProtocolsBgpevpnhasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceProtocolsBgpevpnhasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpnFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	dd := struct {
		BgpEvpn *srlinuxv1alpha1.NetworkinstanceProtocolsBgpevpn `json:"bgp-evpn"`
	}{
		BgpEvpn: info.o.Spec.SrlNetworkinstanceProtocolsBgpevpn,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlNetworkinstanceProtocolsBgpevpnStateMachine struct {
	Object     *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn
	Reconciler *SrlNetworkinstanceProtocolsBgpevpnReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlNetworkinstanceProtocolsBgpevpnStateMachine(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn,
	reconciler *SrlNetworkinstanceProtocolsBgpevpnReconciler, n *string,
	info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) *SrlNetworkinstanceProtocolsBgpevpnStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlNetworkinstanceProtocolsBgpevpnStateMachine{
		Object:     o,
...
type SrlNetworkinstanceProtocolsBgpevpnstateHandler func(*SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult

func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsBgpevpnstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsBgpevpnstateHandler{
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) updateSrlNetworkinstanceProtocolsBgpevpnStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) {
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) ReconcileState(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlNetworkinstanceProtocolsBgpevpnStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlNetworkinstanceProtocolsBgpevpnStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleNone(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleConfiguring(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleConfigureFailed(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleDeleting(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceProtocolsBgpevpnStateMachine) handleDeleteFailed(info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
