...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpevpnhasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlNetworkinstanceProtocolsBgpevpn)
		if err != nil {
...
func (info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsBgpevpnReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
