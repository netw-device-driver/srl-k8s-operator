...
func (r *SrlNetworkinstanceProtocolsBgpevpnReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpevpn) (*[]string, error) {
