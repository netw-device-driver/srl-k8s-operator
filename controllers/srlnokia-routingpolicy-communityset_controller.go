...
func (r *SrlnokiaRoutingpolicyCommunitysetReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaRoutingpolicyCommunitysetReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaRoutingpolicyCommunitysetReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.RoutingpolicyCommunityset) (err error) {
	...
	for _, elementWithleafref := range RoutingpolicyCommunitysetIntraResourceleafRef {
...
func (r *SrlnokiaRoutingpolicyCommunitysetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	for _, vo := range *o.Spec.SrlnokiaRoutingpolicyCommunityset {
...
func (r *SrlnokiaRoutingpolicyCommunitysetReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyCommunityset) (*[]string, error) {
