...
func (r *SrlRoutingpolicyPrefixsetReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) ([]string, error) {
