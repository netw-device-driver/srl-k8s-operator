...
func (r *SrlRoutingpolicyPrefixsetReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (info *SrlRoutingpolicyPrefixsetReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlRoutingpolicyPrefixsetReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
