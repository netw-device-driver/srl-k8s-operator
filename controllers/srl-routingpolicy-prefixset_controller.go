...
var RoutingpolicyPrefixsetIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var RoutingpolicyPrefixsetInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var RoutingpolicyPrefixsetInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlRoutingpolicyPrefixsetReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlRoutingpolicyPrefixsetReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) (err error) {
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyPrefixsetIntraResourceleafRef {
	...
	r.Log.WithValues("RoutingpolicyPrefixsetIntraResourceleafRef", RoutingpolicyPrefixsetIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
