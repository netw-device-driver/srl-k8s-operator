...
func SrlRoutingpolicyPrefixsetlogResult(info *SrlRoutingpolicyPrefixsetReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlRoutingpolicyPrefixset",
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleConfigStatusConfigureSuccess(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleConfigStatusConfigureFailed(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) DeleteFailed(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) DeleteSuccess(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	return actionComplete{}
}
