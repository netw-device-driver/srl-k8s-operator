...
var RoutingpolicyPrefixsetInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var RoutingpolicyPrefixsetExternalResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlRoutingpolicyPrefixsetReconciler reconciles a SrlRoutingpolicyPrefixset object
type SrlRoutingpolicyPrefixsetReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlRoutingpolicyPrefixsetTargetReconcileInfo struct {
	Target map[string]*SrlRoutingpolicyPrefixsetReconcileInfo
}

type SrlRoutingpolicyPrefixsetReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicyprefixsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicyprefixsets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicyprefixsets/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlRoutingpolicyPrefixsetReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlRoutingpolicyPrefixset", request.NamespacedName)
...
/*
	func (r *SrlRoutingpolicyPrefixsetReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlRoutingpolicyPrefixset)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlRoutingpolicyPrefixset)
		if !(oldOK && newOK) {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlRoutingpolicyPrefixset{}).
...
// request for reconciliation of SrlRoutingpolicyPrefixset.
func (r *SrlRoutingpolicyPrefixsetReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlRoutingpolicyPrefixsetList{}
...
func (r *SrlRoutingpolicyPrefixsetReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlRoutingpolicyPrefixsetReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *o.Spec.SrlRoutingpolicyPrefixset {
		o := make([]srlinuxv1alpha1.RoutingpolicyPrefixset, 0)
		o = append(o, obj)
		dd := struct {
			PrefixSet *[]srlinuxv1alpha1.RoutingpolicyPrefixset `json:"prefix-set"`
		}{
			PrefixSet: &o,
		}
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyPrefixsetExternalResourceleafRef {
	...
	r.Log.WithValues("RoutingpolicyPrefixsetExternalResourceleafRef", RoutingpolicyPrefixsetExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlRoutingpolicyPrefixsetReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) (err error) {
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyPrefixsetInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("RoutingpolicyPrefixsetInternalResourceleafRef", RoutingpolicyPrefixsetInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlRoutingpolicyPrefixsetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlRoutingpolicyPrefixset", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlRoutingpolicyPrefixset")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlRoutingpolicyPrefixset config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlRoutingpolicyPrefixsethasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlRoutingpolicyPrefixsetFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlRoutingpolicyPrefixsetFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPrefixsethasFinalizer(o) {
		if SrlRoutingpolicyPrefixsethasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPrefixsethasFinalizer(o) {
		...
		if err := r.saveSrlRoutingpolicyPrefixsetStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPrefixsethasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlRoutingpolicyPrefixsetFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlRoutingpolicyPrefixset" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlRoutingpolicyPrefixset {
	...
	for _, hkey0 := range hkeys0 {
		deletepaths = append(deletepaths, fmt.Sprintf("/routing-policy/prefix-set[name=%s]", hkey0))
	}
	...
	if o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPrefixsethasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlRoutingpolicyPrefixset"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlRoutingpolicyPrefixsetReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlRoutingpolicyPrefixsetReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlRoutingpolicyPrefixsetStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlRoutingpolicyPrefixsetlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlRoutingpolicyPrefixsetlogResult(info *SrlRoutingpolicyPrefixsetReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlRoutingpolicyPrefixset")
		//info.log.Info("stopping reconcile SrlRoutingpolicyPrefixset",
		//	"message", info.o.Status)
	}
}

func (r *SrlRoutingpolicyPrefixsetReconciler) saveSrlRoutingpolicyPrefixsetStatus(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlRoutingpolicyPrefixset",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlRoutingpolicyPrefixset ")
		return err
	}
	return nil
}

func (r *SrlRoutingpolicyPrefixsetReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlRoutingpolicyPrefixsetReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlRoutingpolicyPrefixset"] = string(d)
		cm.Data[fmt.Sprintf("SrlRoutingpolicyPrefixset.%s",*oName)] = string(d)
...
/*
	func (r *SrlRoutingpolicyPrefixsetReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlRoutingpolicyPrefixset.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlRoutingpolicyPrefixset.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlRoutingpolicyPrefixsetReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlRoutingpolicyPrefixsetReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) (bool, *[]string, error) {
...
func (r *SrlRoutingpolicyPrefixsetReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) ([]*Target, bool, error) {
...
// SrlRoutingpolicyPrefixsethasFinalizer checks if object has finalizer
func SrlRoutingpolicyPrefixsethasFinalizer(o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlRoutingpolicyPrefixsetFinalizer)
}

// SSrlRoutingpolicyPrefixsethasOtherFinalizer checks if object has other finalizers
func SrlRoutingpolicyPrefixsethasOtherFinalizer(o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlRoutingpolicyPrefixsetFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlRoutingpolicyPrefixsetReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPrefixsethasFinalizer(info.o) {
...
// Update Cache
func (info *SrlRoutingpolicyPrefixsetReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlRoutingpolicyPrefixset {
		o := make([]srlinuxv1alpha1.RoutingpolicyPrefixset, 0)
		o = append(o, obj)
		dd := struct {
			PrefixSet *[]srlinuxv1alpha1.RoutingpolicyPrefixset `json:"prefix-set"`
...
type SrlRoutingpolicyPrefixsetStateMachine struct {
	Object     *srlinuxv1alpha1.SrlRoutingpolicyPrefixset
	Reconciler *SrlRoutingpolicyPrefixsetReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlRoutingpolicyPrefixsetReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlRoutingpolicyPrefixsetStateMachine(o *srlinuxv1alpha1.SrlRoutingpolicyPrefixset,
	reconciler *SrlRoutingpolicyPrefixsetReconciler, n *string,
	info *SrlRoutingpolicyPrefixsetReconcileInfo) *SrlRoutingpolicyPrefixsetStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlRoutingpolicyPrefixsetStateMachine{
		Object:     o,
...
type SrlRoutingpolicyPrefixsetstateHandler func(*SrlRoutingpolicyPrefixsetReconcileInfo) actionResult

func (o *SrlRoutingpolicyPrefixsetStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlRoutingpolicyPrefixsetstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlRoutingpolicyPrefixsetstateHandler{
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) updateSrlRoutingpolicyPrefixsetStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlRoutingpolicyPrefixsetReconcileInfo) {
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) ReconcileState(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlRoutingpolicyPrefixsetStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlRoutingpolicyPrefixsetStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlRoutingpolicyPrefixsethasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleNone(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleConfiguring(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleConfigureSuccess(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleConfigureFailed(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleDeleting(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPrefixsetStateMachine) handleDeleteSuccess(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlRoutingpolicyPrefixsetStateMachine) handleDeleteFailed(info *SrlRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
