...
// SrlnokiaRoutingpolicyPrefixsetReconciler reconciles a SrlnokiaRoutingpolicyPrefixset object
type SrlnokiaRoutingpolicyPrefixsetReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaRoutingpolicyPrefixsetTargetReconcileInfo struct {
	Target map[string]*SrlnokiaRoutingpolicyPrefixsetReconcileInfo
}

type SrlnokiaRoutingpolicyPrefixsetReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiaroutingpolicyprefixsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiaroutingpolicyprefixsets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiaroutingpolicyprefixsets/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaRoutingpolicyPrefixset.
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixsetList{}
...
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.RoutingpolicyPrefixset) (err error) {
	...
	for _, elementWithleafref := range RoutingpolicyPrefixsetIntraResourceleafRef {
...
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaRoutingpolicyPrefixset", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaRoutingpolicyPrefixset")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaRoutingpolicyPrefixset config")
	...
	for _, vo := range *o.Spec.SrlnokiaRoutingpolicyPrefixset {
	...
	if err := r.saveSrlnokiaRoutingpolicyPrefixsetStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaRoutingpolicyPrefixsethasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixsetFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixsetFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaRoutingpolicyPrefixset" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlnokiaRoutingpolicyPrefixset {
	...
	info := make(map[string]*SrlnokiaRoutingpolicyPrefixsetReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaRoutingpolicyPrefixsetReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaRoutingpolicyPrefixsetStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaRoutingpolicyPrefixsethasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixsetFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaRoutingpolicyPrefixsetlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaRoutingpolicyPrefixsetlogResult(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaRoutingpolicyPrefixset",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) saveSrlnokiaRoutingpolicyPrefixsetStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaRoutingpolicyPrefixset",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaRoutingpolicyPrefixset ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaRoutingpolicyPrefixsetReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset) ([]*Target, bool, error) {
...
// SrlnokiaRoutingpolicyPrefixsethasFinalizer checks if object has finalizer
func SrlnokiaRoutingpolicyPrefixsethasFinalizer(o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixsetFinalizer)
}

func (info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaRoutingpolicyPrefixsethasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlnokiaRoutingpolicyPrefixset {
...
type SrlnokiaRoutingpolicyPrefixsetStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset
	Reconciler *SrlnokiaRoutingpolicyPrefixsetReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaRoutingpolicyPrefixsetStateMachine(o *srlinuxv1alpha1.SrlnokiaRoutingpolicyPrefixset,
	reconciler *SrlnokiaRoutingpolicyPrefixsetReconciler, n *string,
	info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) *SrlnokiaRoutingpolicyPrefixsetStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaRoutingpolicyPrefixsetStateMachine{
		Object:     o,
...
type SrlnokiaRoutingpolicyPrefixsetstateHandler func(*SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult

func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaRoutingpolicyPrefixsetstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaRoutingpolicyPrefixsetstateHandler{
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) updateSrlnokiaRoutingpolicyPrefixsetStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) {
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) ReconcileState(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaRoutingpolicyPrefixsetStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaRoutingpolicyPrefixsetStateMachine deletion")
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaRoutingpolicyPrefixsethasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) handleNone(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) handleConfiguring(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) handleDeleting(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) DeleteFailed(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaRoutingpolicyPrefixsetStateMachine) DeleteSuccess(info *SrlnokiaRoutingpolicyPrefixsetReconcileInfo) actionResult {
	return actionComplete{}
}
