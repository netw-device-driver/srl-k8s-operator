...
var RoutingpolicyPrefixsetIntraResourceleafRef = map[string]*LeafRef{}

var RoutingpolicyPrefixsetInterResourceleafRef = map[string]*LeafRef{}
...
// the SrlnokiaRoutingpolicyPrefixset object against the actual cluster state, and then
