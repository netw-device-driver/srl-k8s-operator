	...
	*/
	...
	var BfdIntraResourceleafRef= map[string]*LeafRef{
	}

	var BfdInterResourceleafRef = map[string]*LeafRef{
	...
	// the SrlnokiaBfd object against the actual cluster state, and then
