...
// SrlnokiaBfdReconciler reconciles a SrlnokiaBfd object
type SrlnokiaBfdReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaBfdTargetReconcileInfo struct {
	Target map[string]*SrlnokiaBfdReconcileInfo
}

type SrlnokiaBfdReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaBfd
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiabfds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiabfds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiabfds/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaBfdReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaBfd{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaBfd.
func (r *SrlnokiaBfdReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaBfdList{}
...
func (r *SrlnokiaBfdReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaBfdReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaBfdReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.Bfd) (err error) {
	...
	for _, elementWithleafref := range BfdIntraResourceleafRef {
...
func (r *SrlnokiaBfdReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaBfd", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaBfd")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaBfd config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaBfd)
	if err != nil {
	...
	if err := r.saveSrlnokiaBfdStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaBfdhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaBfdFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaBfdFinalizer)
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaBfd" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaBfdReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaBfdReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaBfdStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaBfdhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaBfdFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaBfdlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaBfdlogResult(info *SrlnokiaBfdReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaBfd",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaBfdReconciler) saveSrlnokiaBfdStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaBfd) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaBfd",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaBfd ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaBfdReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaBfd) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaBfdReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaBfd) ([]*Target, bool, error) {
...
// SrlnokiaBfdhasFinalizer checks if object has finalizer
func SrlnokiaBfdhasFinalizer(o *srlinuxv1alpha1.SrlnokiaBfd) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaBfdFinalizer)
}

func (info *SrlnokiaBfdReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaBfdhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaBfdReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
...
type SrlnokiaBfdStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaBfd
	Reconciler *SrlnokiaBfdReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaBfdReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaBfdStateMachine(o *srlinuxv1alpha1.SrlnokiaBfd,
	reconciler *SrlnokiaBfdReconciler, n *string,
	info *SrlnokiaBfdReconcileInfo) *SrlnokiaBfdStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaBfdStateMachine{
		Object:     o,
...
type SrlnokiaBfdstateHandler func(*SrlnokiaBfdReconcileInfo) actionResult

func (o *SrlnokiaBfdStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaBfdstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaBfdstateHandler{
...
func (o *SrlnokiaBfdStateMachine) updateSrlnokiaBfdStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaBfdReconcileInfo) {
...
func (o *SrlnokiaBfdStateMachine) ReconcileState(info *SrlnokiaBfdReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaBfdStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaBfdStateMachine deletion")
...
func (o *SrlnokiaBfdStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaBfdhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaBfdStateMachine) handleNone(info *SrlnokiaBfdReconcileInfo) actionResult {
...
func (o *SrlnokiaBfdStateMachine) handleConfiguring(info *SrlnokiaBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaBfdStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaBfdStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaBfdStateMachine) handleDeleting(info *SrlnokiaBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaBfdStateMachine) DeleteFailed(info *SrlnokiaBfdReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaBfdStateMachine) DeleteSuccess(info *SrlnokiaBfdReconcileInfo) actionResult {
	return actionComplete{}
}
