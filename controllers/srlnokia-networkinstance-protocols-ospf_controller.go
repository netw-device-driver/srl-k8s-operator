...
// SrlnokiaNetworkinstanceProtocolsOspfReconciler reconciles a SrlnokiaNetworkinstanceProtocolsOspf object
type SrlnokiaNetworkinstanceProtocolsOspfReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceProtocolsOspfTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo
}

type SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsospfs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsospfs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsospfs/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceProtocolsOspf.
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspfList{}
...
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsOspf) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsOspfIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceProtocolsOspf")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceProtocolsOspf config")
	...
	if err := r.saveSrlnokiaNetworkinstanceProtocolsOspfStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceProtocolsOspfhasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspfFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspfFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceProtocolsOspf" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceProtocolsOspfStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsOspfhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspfFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceProtocolsOspflogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceProtocolsOspflogResult(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceProtocolsOspf",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) saveSrlnokiaNetworkinstanceProtocolsOspfStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceProtocolsOspf",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceProtocolsOspf ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceProtocolsOspfReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceProtocolsOspfhasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceProtocolsOspfhasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspfFinalizer)
}

func (info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsOspfhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Ospf: info.o.Spec.SrlnokiaNetworkinstanceProtocolsOspf,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceProtocolsOspfStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf
	Reconciler *SrlnokiaNetworkinstanceProtocolsOspfReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceProtocolsOspfStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsOspf,
	reconciler *SrlnokiaNetworkinstanceProtocolsOspfReconciler, n *string,
	info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) *SrlnokiaNetworkinstanceProtocolsOspfStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceProtocolsOspfStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceProtocolsOspfstateHandler func(*SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsOspfstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsOspfstateHandler{
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) updateSrlnokiaNetworkinstanceProtocolsOspfStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceProtocolsOspfStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceProtocolsOspfStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsOspfhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) handleNone(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsOspfStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	return actionComplete{}
}
