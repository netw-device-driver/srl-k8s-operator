...
// K8sSrlNokiaSystemSystemNtpReconciler reconciles a SrlNokiaSystemSystemNtp object
type K8sSrlNokiaSystemSystemNtpReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaSystemSystemNtpTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaSystemSystemNtpReconcileInfo
}

type K8sSrlNokiaSystemSystemNtpReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemntps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemntps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemntps/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaSystemSystemNtpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaSystemSystemNtp.
func (r *K8sSrlNokiaSystemSystemNtpReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtpList{}
...
// the SrlNokiaSystemSystemNtp object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaSystemSystemNtpReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaSystemSystemNtp", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaSystemSystemNtp")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaSystemSystemNtp config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaSystemSystemNtphasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaSystemSystemNtpFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaSystemSystemNtpFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaSystemSystemNtpStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaSystemSystemNtp" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaSystemSystemNtpReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaSystemSystemNtpReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaSystemSystemNtpStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNtphasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemNtpFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaSystemSystemNtplogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaSystemSystemNtplogResult(info *K8sSrlNokiaSystemSystemNtpReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaSystemSystemNtp",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaSystemSystemNtpReconciler) saveK8sSrlNokiaSystemSystemNtpStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaSystemSystemNtp",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaSystemSystemNtp ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaSystemSystemNtpReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp) ([]*Target, bool, error) {
...
// SrlNokiaSystemSystemNtphasFinalizer checks if object has finalizer
func SrlNokiaSystemSystemNtphasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemNtpFinalizer)
}

func (info *K8sSrlNokiaSystemSystemNtpReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNtphasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaSystemSystemNtpReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Ntp *srlinuxv1alpha1.SrlNokiaSystemSystemNtp `json:"ntp"`
	}{
		Ntp: info.o.Spec.SrlNokiaSystemSystemNtp,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaSystemSystemNtpStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp
	Reconciler *K8sSrlNokiaSystemSystemNtpReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaSystemSystemNtpReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaSystemSystemNtpStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNtp,
	reconciler *K8sSrlNokiaSystemSystemNtpReconciler, n *string,
	info *K8sSrlNokiaSystemSystemNtpReconcileInfo) *K8sSrlNokiaSystemSystemNtpStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaSystemSystemNtpStateMachine{
		Object:     o,
...
type SrlNokiaSystemSystemNtpstateHandler func(*K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult

func (o *K8sSrlNokiaSystemSystemNtpStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemNtpstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemNtpstateHandler{
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) updateK8sSrlNokiaSystemSystemNtpStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaSystemSystemNtpReconcileInfo) {
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) ReconcileState(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaSystemSystemNtpStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaSystemSystemNtpStateMachine deletion")
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNtphasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) handleNone(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) handleConfiguring(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) handleDeleting(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) DeleteFailed(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNtpStateMachine) DeleteSuccess(info *K8sSrlNokiaSystemSystemNtpReconcileInfo) actionResult {
	return actionComplete{}
}
