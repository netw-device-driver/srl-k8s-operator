...
// K8sSrlNokiaSystemSystemNetworkInstanceReconciler reconciles a SrlNokiaSystemSystemNetworkInstance object
type K8sSrlNokiaSystemSystemNetworkInstanceReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaSystemSystemNetworkInstanceTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo
}

type K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemnetworkinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemnetworkinstances/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemnetworkinstances/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaSystemSystemNetworkInstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaSystemSystemNetworkInstance.
func (r *K8sSrlNokiaSystemSystemNetworkInstanceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstanceList{}
...
// the SrlNokiaSystemSystemNetworkInstance object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaSystemSystemNetworkInstanceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaSystemSystemNetworkInstance", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaSystemSystemNetworkInstance")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaSystemSystemNetworkInstance config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaSystemSystemNetworkInstancehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaSystemSystemNetworkInstanceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaSystemSystemNetworkInstanceFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaSystemSystemNetworkInstanceStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaSystemSystemNetworkInstance" + "." + strcase.UpperCamelCase(o.Name)

	dependencies := make([]string, 0)

	deletepaths := make([]string, 0)

	deletepaths = append(deletepaths, "/system/network-instance")

	// path to be used for this object
	path := "/system"

	info := make(map[string]*K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaSystemSystemNetworkInstanceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNetworkInstancehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemNetworkInstanceFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaSystemSystemNetworkInstancelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaSystemSystemNetworkInstancelogResult(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaSystemSystemNetworkInstance",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaSystemSystemNetworkInstanceReconciler) saveK8sSrlNokiaSystemSystemNetworkInstanceStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaSystemSystemNetworkInstance",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaSystemSystemNetworkInstance ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaSystemSystemNetworkInstanceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance) ([]*Target, bool, error) {
...
// SrlNokiaSystemSystemNetworkInstancehasFinalizer checks if object has finalizer
func SrlNokiaSystemSystemNetworkInstancehasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemNetworkInstanceFinalizer)
}

func (info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNetworkInstancehasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		NetworkInstance *srlinuxv1alpha1.SrlNokiaSystemSystemNetworkInstance `json:"network-instance"`
	}{
		NetworkInstance: info.o.Spec.SrlNokiaSystemSystemNetworkInstance,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaSystemSystemNetworkInstanceStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance
	Reconciler *K8sSrlNokiaSystemSystemNetworkInstanceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaSystemSystemNetworkInstanceStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemNetworkInstance,
	reconciler *K8sSrlNokiaSystemSystemNetworkInstanceReconciler, n *string,
	info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaSystemSystemNetworkInstanceStateMachine{
		Object:     o,
...
type SrlNokiaSystemSystemNetworkInstancestateHandler func(*K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult

func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemNetworkInstancestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemNetworkInstancestateHandler{
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) updateK8sSrlNokiaSystemSystemNetworkInstanceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) {
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) ReconcileState(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaSystemSystemNetworkInstanceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaSystemSystemNetworkInstanceStateMachine deletion")
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNetworkInstancehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) handleNone(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) handleConfiguring(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) handleDeleting(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) DeleteFailed(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNetworkInstanceStateMachine) DeleteSuccess(info *K8sSrlNokiaSystemSystemNetworkInstanceReconcileInfo) actionResult {
	return actionComplete{}
}
