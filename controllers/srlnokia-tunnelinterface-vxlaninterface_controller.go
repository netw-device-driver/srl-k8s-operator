...
var TunnelinterfaceVxlaninterfaceIntraResourceleafRef = map[string]*LeafRef{}

var TunnelinterfaceVxlaninterfaceInterResourceleafRef = map[string]*LeafRef{}
...
// the SrlnokiaTunnelinterfaceVxlaninterface object against the actual cluster state, and then
