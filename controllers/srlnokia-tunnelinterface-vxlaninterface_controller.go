...
// SrlnokiaTunnelinterfaceVxlaninterfaceReconciler reconciles a SrlnokiaTunnelinterfaceVxlaninterface object
type SrlnokiaTunnelinterfaceVxlaninterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaTunnelinterfaceVxlaninterfaceTargetReconcileInfo struct {
	Target map[string]*SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo
}

type SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiatunnelinterfacevxlaninterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiatunnelinterfacevxlaninterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiatunnelinterfacevxlaninterfaces/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaTunnelinterfaceVxlaninterface.
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterfaceList{}
...
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.TunnelinterfaceVxlaninterface) (err error) {
	...
	for _, elementWithleafref := range TunnelinterfaceVxlaninterfaceIntraResourceleafRef {
...
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaTunnelinterfaceVxlaninterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaTunnelinterfaceVxlaninterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaTunnelinterfaceVxlaninterface config")
	...
	for _, vo := range *o.Spec.SrlnokiaTunnelinterfaceVxlaninterface {
	...
	if err := r.saveSrlnokiaTunnelinterfaceVxlaninterfaceStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterfaceFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaTunnelinterfaceVxlaninterface" + "." + strcase.UpperCamelCase(o.Name)
	hkey0 := *o.Spec.SrlNokiaTunnelInterfaceName
	hkeys1 := make([]string, 0)
	for _, n := range *o.Spec.SrlnokiaTunnelinterfaceVxlaninterface {
	...
	info := make(map[string]*SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaTunnelinterfaceVxlaninterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterfaceFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaTunnelinterfaceVxlaninterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaTunnelinterfaceVxlaninterfacelogResult(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaTunnelinterfaceVxlaninterface",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) saveSrlnokiaTunnelinterfaceVxlaninterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaTunnelinterfaceVxlaninterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaTunnelinterfaceVxlaninterface ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface) ([]*Target, bool, error) {
...
// SrlnokiaTunnelinterfaceVxlaninterfacehasFinalizer checks if object has finalizer
func SrlnokiaTunnelinterfaceVxlaninterfacehasFinalizer(o *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterfaceFinalizer)
}

func (info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaTunnelinterfaceVxlaninterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlnokiaTunnelinterfaceVxlaninterface {
...
type SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface
	Reconciler *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaTunnelinterfaceVxlaninterfaceStateMachine(o *srlinuxv1alpha1.SrlnokiaTunnelinterfaceVxlaninterface,
	reconciler *SrlnokiaTunnelinterfaceVxlaninterfaceReconciler, n *string,
	info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine{
		Object:     o,
...
type SrlnokiaTunnelinterfaceVxlaninterfacestateHandler func(*SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult

func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaTunnelinterfaceVxlaninterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaTunnelinterfaceVxlaninterfacestateHandler{
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) updateSrlnokiaTunnelinterfaceVxlaninterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) {
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) ReconcileState(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaTunnelinterfaceVxlaninterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine deletion")
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaTunnelinterfaceVxlaninterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) handleNone(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) handleConfiguring(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) handleDeleting(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) DeleteFailed(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceVxlaninterfaceStateMachine) DeleteSuccess(info *SrlnokiaTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
