...
var TunnelinterfaceVxlaninterfaceIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var TunnelinterfaceVxlaninterfaceInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var TunnelinterfaceVxlaninterfaceInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) (err error) {
	...
	for localLeafRef, leafRefInfo := range TunnelinterfaceVxlaninterfaceIntraResourceleafRef {
	...
	r.Log.WithValues("TunnelinterfaceVxlaninterfaceIntraResourceleafRef", TunnelinterfaceVxlaninterfaceIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
