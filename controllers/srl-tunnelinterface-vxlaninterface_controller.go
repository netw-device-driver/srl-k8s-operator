...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) ([]string, error) {
