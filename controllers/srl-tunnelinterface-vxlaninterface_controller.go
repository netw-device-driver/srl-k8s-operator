...
var TunnelinterfaceVxlaninterfaceInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var TunnelinterfaceVxlaninterfaceExternalResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlTunnelinterfaceVxlaninterfaceReconciler reconciles a SrlTunnelinterfaceVxlaninterface object
type SrlTunnelinterfaceVxlaninterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlTunnelinterfaceVxlaninterfaceTargetReconcileInfo struct {
	Target map[string]*SrlTunnelinterfaceVxlaninterfaceReconcileInfo
}

type SrlTunnelinterfaceVxlaninterfaceReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srltunnelinterfacevxlaninterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srltunnelinterfacevxlaninterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srltunnelinterfacevxlaninterfaces/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlTunnelinterfaceVxlaninterface", request.NamespacedName)
...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface)
		if !(oldOK && newOK) {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface{}).
...
// request for reconciliation of SrlTunnelinterfaceVxlaninterface.
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterfaceList{}
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *o.Spec.SrlTunnelinterfaceVxlaninterface {
		o := make([]srlinuxv1alpha1.TunnelinterfaceVxlaninterface, 0)
		o = append(o, obj)
		dd := struct {
			VxlanInterface *[]srlinuxv1alpha1.TunnelinterfaceVxlaninterface `json:"vxlan-interface"`
		}{
			VxlanInterface: &o,
		}
	...
	for localLeafRef, leafRefInfo := range TunnelinterfaceVxlaninterfaceExternalResourceleafRef {
	...
	r.Log.WithValues("TunnelinterfaceVxlaninterfaceExternalResourceleafRef", TunnelinterfaceVxlaninterfaceExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) (err error) {
	...
	for localLeafRef, leafRefInfo := range TunnelinterfaceVxlaninterfaceInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("TunnelinterfaceVxlaninterfaceInternalResourceleafRef", TunnelinterfaceVxlaninterfaceInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlTunnelinterfaceVxlaninterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlTunnelinterfaceVxlaninterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlTunnelinterfaceVxlaninterface config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterfaceFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		if SrlTunnelinterfaceVxlaninterfacehasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		...
		if err := r.saveSrlTunnelinterfaceVxlaninterfaceStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterfaceFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlTunnelinterfaceVxlaninterface" + "." + strcase.UpperCamelCase(o.Name)
	hkey0 := *o.Spec.SrlNokiaTunnelInterfaceName
	hkeys1 := make([]string, 0)
	for _, n := range *o.Spec.SrlTunnelinterfaceVxlaninterface {
	...
	for _, hkey1 := range hkeys1 {
		deletepaths = append(deletepaths, fmt.Sprintf("/tunnel-interface[name=%s]/vxlan-interface[index=%s]", hkey0, hkey1))
	}

	// path to be used for this object
	path := fmt.Sprintf("/tunnel-interface[name=%s]", hkey0)
	...
	if o.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlTunnelinterfaceVxlaninterface"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlTunnelinterfaceVxlaninterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlTunnelinterfaceVxlaninterfaceReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlTunnelinterfaceVxlaninterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlTunnelinterfaceVxlaninterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlTunnelinterfaceVxlaninterfacelogResult(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlTunnelinterfaceVxlaninterface")
		//info.log.Info("stopping reconcile SrlTunnelinterfaceVxlaninterface",
		//	"message", info.o.Status)
	}
}

func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) saveSrlTunnelinterfaceVxlaninterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlTunnelinterfaceVxlaninterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlTunnelinterfaceVxlaninterface ")
		return err
	}
	return nil
}

func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlTunnelinterfaceVxlaninterface"] = string(d)
		cm.Data[fmt.Sprintf("SrlTunnelinterfaceVxlaninterface.%s",*oName)] = string(d)
...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlTunnelinterfaceVxlaninterface.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlTunnelinterfaceVxlaninterface.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) (bool, *[]string, error) {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) ([]*Target, bool, error) {
...
// SrlTunnelinterfaceVxlaninterfacehasFinalizer checks if object has finalizer
func SrlTunnelinterfaceVxlaninterfacehasFinalizer(o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterfaceFinalizer)
}

// SSrlTunnelinterfaceVxlaninterfacehasOtherFinalizer checks if object has other finalizers
func SrlTunnelinterfaceVxlaninterfacehasOtherFinalizer(o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterfaceFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlTunnelinterfaceVxlaninterface {
		o := make([]srlinuxv1alpha1.TunnelinterfaceVxlaninterface, 0)
		o = append(o, obj)
		dd := struct {
			VxlanInterface *[]srlinuxv1alpha1.TunnelinterfaceVxlaninterface `json:"vxlan-interface"`
...
type SrlTunnelinterfaceVxlaninterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface
	Reconciler *SrlTunnelinterfaceVxlaninterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlTunnelinterfaceVxlaninterfaceStateMachine(o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface,
	reconciler *SrlTunnelinterfaceVxlaninterfaceReconciler, n *string,
	info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) *SrlTunnelinterfaceVxlaninterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlTunnelinterfaceVxlaninterfaceStateMachine{
		Object:     o,
...
type SrlTunnelinterfaceVxlaninterfacestateHandler func(*SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult

func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlTunnelinterfaceVxlaninterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlTunnelinterfaceVxlaninterfacestateHandler{
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) updateSrlTunnelinterfaceVxlaninterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) {
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) ReconcileState(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlTunnelinterfaceVxlaninterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlTunnelinterfaceVxlaninterfaceStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleNone(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleConfiguring(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleConfigureSuccess(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleConfigureFailed(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleDeleting(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleDeleteSuccess(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleDeleteFailed(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
