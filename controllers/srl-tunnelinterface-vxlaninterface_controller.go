...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.TunnelinterfaceVxlaninterface) (err error) {
		// marshal data to json
		dd := struct {
			VxlanInterface *srlinuxv1alpha1.TunnelinterfaceVxlaninterface `json:"vxlan-interface"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range TunnelinterfaceVxlaninterfaceIntraResourceleafRef {
...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlTunnelinterfaceVxlaninterfacehasFinalizer(o) {
		...
		/*
			validationSuccess := true
			for _, vo := range *o.Spec.SrlTunnelinterfaceVxlaninterface {
...
/*
	func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlTunnelinterfaceVxlaninterface) ([]string, []string, error) {
