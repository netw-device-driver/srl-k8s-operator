...
func SrlTunnelinterfaceVxlaninterfacelogResult(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlTunnelinterfaceVxlaninterface",
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleConfigStatusConfigureSuccess(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) handleConfigStatusConfigureFailed(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) DeleteFailed(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlTunnelinterfaceVxlaninterfaceStateMachine) DeleteSuccess(info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
