...
func (r *SrlTunnelinterfaceVxlaninterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlTunnelinterfaceVxlaninterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
