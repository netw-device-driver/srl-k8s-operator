...
var BfdIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var BfdInterResourceleafRef = map[string][]ElementKeyValue{
	"/bfd/micro-bfd-sessions/lag-interface[name=]": []ElementKeyValue{
		{"interface", "name", "string"},
	},
}

/*
	var BfdInterResourceleafRef = map[string]*ElementWithLeafRef{
...
/*
	...
	func (r *SrlBfdReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlBfdReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlBfdReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlBfd) (err error) {
	...
	for localLeafRef, leafRefInfo := range BfdIntraResourceleafRef {
	...
	r.Log.WithValues("BfdIntraResourceleafRef", BfdIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
