...
func (r *SrlBfdReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlBfdReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlBfdhasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlBfd)
		if err != nil {
...
func (info *SrlBfdReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlBfdReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
