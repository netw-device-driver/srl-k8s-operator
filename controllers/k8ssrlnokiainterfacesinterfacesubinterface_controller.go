...
// K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler reconciles a SrlNokiaInterfacesInterfaceSubinterface object
type K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaInterfacesInterfaceSubinterfaceTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo
}

type K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
func (r *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaInterfacesInterfaceSubinterface.
func (r *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterfaceList{}
...
// the SrlNokiaInterfacesInterfaceSubinterface object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaInterfacesInterfaceSubinterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaInterfacesInterfaceSubinterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaInterfacesInterfaceSubinterface config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaInterfacesInterfaceSubinterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaInterfacesInterfaceSubinterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaInterfacesInterfaceSubinterfaceFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaInterfacesInterfaceSubinterfaceStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaInterfacesInterfaceSubinterface" + "." + strcase.UpperCamelCase(o.Name)

	hkey0 := *o.Spec.SrlNokiaInterfaceName

	hkeys1 := make([]string, 0)
	for _, n := range *o.Spec.SrlNokiaInterfacesInterfaceSubinterface {
	...
	info := make(map[string]*K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaInterfacesInterfaceSubinterfacehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaInterfacesInterfaceSubinterfaceFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaInterfacesInterfaceSubinterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaInterfacesInterfaceSubinterfacelogResult(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaInterfacesInterfaceSubinterface",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler) saveK8sSrlNokiaInterfacesInterfaceSubinterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaInterfacesInterfaceSubinterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaInterfacesInterfaceSubinterface ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface) ([]*Target, bool, error) {
...
// SrlNokiaInterfacesInterfaceSubinterfacehasFinalizer checks if object has finalizer
func SrlNokiaInterfacesInterfaceSubinterfacehasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaInterfacesInterfaceSubinterfaceFinalizer)
}

func (info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaInterfacesInterfaceSubinterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlNokiaInterfacesInterfaceSubinterface {
		o := make([]srlinuxv1alpha1.SrlNokiaInterfacesInterfaceSubinterface, 0)
		o = append(o, obj)
		dd := struct {
			Subinterface *[]srlinuxv1alpha1.SrlNokiaInterfacesInterfaceSubinterface `json:"subinterface"`
		}{
			Subinterface: &o,
		}
...
type K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface
	Reconciler *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaInterfacesInterfaceSubinterface,
	reconciler *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconciler, n *string,
	info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine{
		Object:     o,
...
type SrlNokiaInterfacesInterfaceSubinterfacestateHandler func(*K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult

func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaInterfacesInterfaceSubinterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaInterfacesInterfaceSubinterfacestateHandler{
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) updateK8sSrlNokiaInterfacesInterfaceSubinterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) {
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) ReconcileState(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaInterfacesInterfaceSubinterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine deletion")
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaInterfacesInterfaceSubinterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) handleNone(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) handleConfiguring(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) handleDeleting(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) DeleteFailed(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaInterfacesInterfaceSubinterfaceStateMachine) DeleteSuccess(info *K8sSrlNokiaInterfacesInterfaceSubinterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
