...
var SystemNtpInterResourceleafRef = map[string][]ElementKeyValue{
	"/ntp/network-instance": []ElementKeyValue{
...
func (r *SrlSystemNtpReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNtp) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNtpIntraResourceleafRef {
	...
	r.Log.WithValues("SystemNtpIntraResourceleafRef", SystemNtpIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
