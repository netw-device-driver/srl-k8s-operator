...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) validateIfElementWithLeafRefExists(last bool, e string, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) validateLeafRefExists(last bool, e string, o interface{}, leafrefValue string) (interface{}, bool) {
	xType := reflect.TypeOf(o)
	xValue := reflect.ValueOf(o)
	r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceStaticroutes) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceStaticroutesInterResourceleafRef {
