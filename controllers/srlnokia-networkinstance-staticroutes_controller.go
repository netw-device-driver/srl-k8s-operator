...
var NetworkinstanceStaticroutesInterResourceleafRef = map[string]*ElementWithLeafRef{
	"/network-instance/static-routes/route/next-hop-group": {
...
// SrlnokiaNetworkinstanceStaticroutesReconciler reconciles a SrlnokiaNetworkinstanceStaticroutes object
type SrlnokiaNetworkinstanceStaticroutesReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceStaticroutesTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceStaticroutesReconcileInfo
}

type SrlnokiaNetworkinstanceStaticroutesReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstancestaticroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstancestaticroutes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstancestaticroutes/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceStaticroutes.
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutesList{}
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceStaticroutes) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceStaticroutesIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaNetworkinstanceStaticroutes", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceStaticroutes")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceStaticroutes config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaNetworkinstanceStaticroutes)
	if err != nil {
	...
	if err := r.saveSrlnokiaNetworkinstanceStaticroutesStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceStaticrouteshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutesFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutesFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceStaticroutes" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceStaticroutesReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceStaticroutesReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceStaticroutesStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceStaticrouteshasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutesFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceStaticrouteslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceStaticrouteslogResult(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceStaticroutes",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) saveSrlnokiaNetworkinstanceStaticroutesStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceStaticroutes",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceStaticroutes ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceStaticroutesReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceStaticrouteshasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceStaticrouteshasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutesFinalizer)
}

func (info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceStaticrouteshasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		StaticRoutes: info.o.Spec.SrlnokiaNetworkinstanceStaticroutes,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceStaticroutesStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes
	Reconciler *SrlnokiaNetworkinstanceStaticroutesReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceStaticroutesStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceStaticroutes,
	reconciler *SrlnokiaNetworkinstanceStaticroutesReconciler, n *string,
	info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) *SrlnokiaNetworkinstanceStaticroutesStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceStaticroutesStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceStaticroutesstateHandler func(*SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceStaticroutesstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceStaticroutesstateHandler{
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) updateSrlnokiaNetworkinstanceStaticroutesStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceStaticroutesStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceStaticroutesStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceStaticrouteshasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) handleNone(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStaticroutesStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceStaticroutesReconcileInfo) actionResult {
	return actionComplete{}
}
