	...
	*/
	...
	var NetworkinstanceStaticroutesIntraResourceleafRef= map[string]*LeafRef{
	}

	var NetworkinstanceStaticroutesInterResourceleafRef = map[string]*LeafRef{
		"/network-instance/static-routes/route/next-hop-group" : {
			AbsoluteLeafRefPath: "/network-instance/next-hop-groups",
			RelativeLeafRefPath: "",
			ElementName:         "group",
			KeyName:             "name",
		},
	...
	// the SrlnokiaNetworkinstanceStaticroutes object against the actual cluster state, and then
