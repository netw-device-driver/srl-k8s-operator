...
// K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler reconciles a SrlNokiaRoutingPolicyRoutingPolicy object
type K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaRoutingPolicyRoutingPolicyTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo
}

type K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
func (r *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaRoutingPolicyRoutingPolicy.
func (r *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicyList{}
...
// the SrlNokiaRoutingPolicyRoutingPolicy object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaRoutingPolicyRoutingPolicy", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaRoutingPolicyRoutingPolicy")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaRoutingPolicyRoutingPolicy config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaRoutingPolicyRoutingPolicyhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaRoutingPolicyRoutingPolicyFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaRoutingPolicyRoutingPolicyFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaRoutingPolicyRoutingPolicyStatus(ctx, o); err != nil {
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaRoutingPolicyRoutingPolicy" + "." + strcase.UpperCamelCase(o.Name)

	dependencies := make([]string, 0)

	deletepaths := make([]string, 0)

	deletepaths = append(deletepaths, "/routing-policy")

	// path to be used for this object
	path := "/"

	info := make(map[string]*K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaRoutingPolicyRoutingPolicyhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaRoutingPolicyRoutingPolicyFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaRoutingPolicyRoutingPolicylogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaRoutingPolicyRoutingPolicylogResult(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaRoutingPolicyRoutingPolicy",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler) saveK8sSrlNokiaRoutingPolicyRoutingPolicyStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaRoutingPolicyRoutingPolicy",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaRoutingPolicyRoutingPolicy ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy) ([]*Target, bool, error) {
...
// SrlNokiaRoutingPolicyRoutingPolicyhasFinalizer checks if object has finalizer
func SrlNokiaRoutingPolicyRoutingPolicyhasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaRoutingPolicyRoutingPolicyFinalizer)
}

func (info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaRoutingPolicyRoutingPolicyhasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		RoutingPolicy *srlinuxv1alpha1.SrlNokiaRoutingPolicyRoutingPolicy `json:"routing-policy"`
	}{
		RoutingPolicy: info.o.Spec.SrlNokiaRoutingPolicyRoutingPolicy,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy
	Reconciler *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaRoutingPolicyRoutingPolicy,
	reconciler *K8sSrlNokiaRoutingPolicyRoutingPolicyReconciler, n *string,
	info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine{
		Object:     o,
...
type SrlNokiaRoutingPolicyRoutingPolicystateHandler func(*K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult

func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaRoutingPolicyRoutingPolicystateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaRoutingPolicyRoutingPolicystateHandler{
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) updateK8sSrlNokiaRoutingPolicyRoutingPolicyStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) {
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) ReconcileState(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaRoutingPolicyRoutingPolicyStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine deletion")
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaRoutingPolicyRoutingPolicyhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) handleNone(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) handleConfiguring(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) handleDeleting(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) DeleteFailed(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaRoutingPolicyRoutingPolicyStateMachine) DeleteSuccess(info *K8sSrlNokiaRoutingPolicyRoutingPolicyReconcileInfo) actionResult {
	return actionComplete{}
}
