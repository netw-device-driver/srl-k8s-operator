...
var NetworkinstanceProtocolsIsisInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceProtocolsIsisExternalResourceleafRef = map[string]*ElementWithLeafRef{
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsIsis, cm *string) (err error) {
	...
	dd := struct {
		...
		Isis: o.Spec.SrlNetworkinstanceProtocolsIsis,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsIsisExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsIsisExternalResourceleafRef", NetworkinstanceProtocolsIsisExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlNetworkinstanceProtocolsIsisReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsIsis) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsIsisInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceProtocolsIsisInternalResourceleafRef", NetworkinstanceProtocolsIsisInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsIsishasFinalizer(o) {
		if SrlNetworkinstanceProtocolsIsishasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsIsishasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceProtocolsIsis"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
...
func SrlNetworkinstanceProtocolsIsislogResult(info *SrlNetworkinstanceProtocolsIsisReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsIsis")
		//info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsIsis",
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceProtocolsIsisReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceProtocolsIsis"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsIsis.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceProtocolsIsisReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsIsis.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceProtocolsIsis.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceProtocolsIsisReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsIsisReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
// SSrlNetworkinstanceProtocolsIsishasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceProtocolsIsishasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsIsis) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceProtocolsIsisFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceProtocolsIsisReconcileInfo) DeleteCache() error {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsIsisReconcileInfo) UpdateCache(path string) error {
...
func (o *SrlNetworkinstanceProtocolsIsisStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsIsisStateMachine) handleConfigureFailed(info *SrlNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsIsisStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceProtocolsIsisStateMachine) handleDeleteFailed(info *SrlNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
