	...
	*/
	...
	var NetworkinstanceIntraResourceleafRef= map[string]*LeafRef{
	    "/network-instance/mpls/static-mpls-entry/next-hop-group" : {
	        AbsoluteLeafRefPath: "/network-instance/next-hop-groups",
		    RelativeLeafRefPath: "/mpls/static-mpls-entry/next-hop-group",
		    ElementName:         "group",
		    KeyName:             "name",
	    },
	    "/network-instance/traffic-engineering/interface/admin-group" : {
	        AbsoluteLeafRefPath: "/network-instance/traffic-engineering/admin-groups",
		    RelativeLeafRefPath: "/traffic-engineering/interface/admin-group",
		    ElementName:         "group",
		    KeyName:             "name",
	    },
	    "/network-instance/traffic-engineering/interface/interface-name" : {
	        AbsoluteLeafRefPath: "/network-instance",
		    RelativeLeafRefPath: "/traffic-engineering/interface/interface-name",
		    ElementName:         "interface",
		    KeyName:             "name",
	    },
	    "/network-instance/traffic-engineering/interface/srlg-membership" : {
	        AbsoluteLeafRefPath: "/network-instance/traffic-engineering/shared-risk-link-groups",
		    RelativeLeafRefPath: "/traffic-engineering/interface/srlg-membership",
		    ElementName:         "group",
		    KeyName:             "name",
	    },
	}

	var NetworkinstanceInterResourceleafRef = map[string]*LeafRef{
	}
	...
	// the SrlnokiaNetworkinstance object against the actual cluster state, and then
