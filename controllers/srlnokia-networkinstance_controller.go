...
var NetworkinstanceIntraResourceleafRef = map[string]*ElementWithLeafRef{
	"/network-instance/mpls/static-mpls-entry/next-hop-group": {
		AbsolutePath2LeafRef:           "/network-instance/next-hop-groups",
		RelativePath2LeafRef:           "/next-hop-groups/group/name",
		RelativePath2ObjectWithLeafRef: "/mpls/static-mpls-entry/next-hop-group",
		ElementName:                    "group",
		KeyName:                        "name",
	},
	"/network-instance/traffic-engineering/interface/admin-group": {
		AbsolutePath2LeafRef:           "/network-instance/traffic-engineering/admin-groups",
		RelativePath2LeafRef:           "/traffic-engineering/admin-groups/group/name",
		RelativePath2ObjectWithLeafRef: "/traffic-engineering/interface/admin-group",
		ElementName:                    "group",
		KeyName:                        "name",
	},
	"/network-instance/traffic-engineering/interface/interface-name": {
		AbsolutePath2LeafRef:           "/network-instance",
		RelativePath2LeafRef:           "/interface/name",
		RelativePath2ObjectWithLeafRef: "/traffic-engineering/interface/interface-name",
		ElementName:                    "interface",
		KeyName:                        "name",
	},
	"/network-instance/traffic-engineering/interface/srlg-membership": {
		AbsolutePath2LeafRef:           "/network-instance/traffic-engineering/shared-risk-link-groups",
		RelativePath2LeafRef:           "/traffic-engineering/shared-risk-link-groups/group/name",
		RelativePath2ObjectWithLeafRef: "/traffic-engineering/interface/srlg-membership",
		ElementName:                    "group",
		KeyName:                        "name",
	},
}

var NetworkinstanceInterResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlnokiaNetworkinstanceReconciler reconciles a SrlnokiaNetworkinstance object
type SrlnokiaNetworkinstanceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceReconcileInfo
}

type SrlnokiaNetworkinstanceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstance
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstances/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstances/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstance{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstance.
func (r *SrlnokiaNetworkinstanceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceList{}
...
func (r *SrlnokiaNetworkinstanceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.Networkinstance) (err error) {
	// marshal data to json
	dd := struct {
		NetworkInstance *srlinuxv1alpha1.Networkinstance `json:"network-instance"`
	}{
		NetworkInstance: o,
	}
	...
	for _, elementWithleafref := range NetworkinstanceIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaNetworkinstance", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstance")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstance config")
	...
	for _, vo := range *o.Spec.SrlnokiaNetworkinstance {
	...
	if err := r.saveSrlnokiaNetworkinstanceStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstancehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceFinalizer)
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstance" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlnokiaNetworkinstance {
	...
	for _, hkey0 := range hkeys0 {
		deletepaths = append(deletepaths, fmt.Sprintf("/network-instance[name=%s]", hkey0))
	}

	// path to be used for this object
	path := "/"

	info := make(map[string]*SrlnokiaNetworkinstanceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstancehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstancelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstancelogResult(info *SrlnokiaNetworkinstanceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstance",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceReconciler) saveSrlnokiaNetworkinstanceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstance) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstance",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstance ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstance) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstance) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstancehasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstancehasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstance) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceFinalizer)
}

func (info *SrlnokiaNetworkinstanceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstancehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlnokiaNetworkinstance {
		o := make([]srlinuxv1alpha1.Networkinstance, 0)
		o = append(o, obj)
		dd := struct {
			NetworkInstance *[]srlinuxv1alpha1.Networkinstance `json:"network-instance"`
		}{
...
type SrlnokiaNetworkinstanceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstance
	Reconciler *SrlnokiaNetworkinstanceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstance,
	reconciler *SrlnokiaNetworkinstanceReconciler, n *string,
	info *SrlnokiaNetworkinstanceReconcileInfo) *SrlnokiaNetworkinstanceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstancestateHandler func(*SrlnokiaNetworkinstanceReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstancestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstancestateHandler{
...
func (o *SrlnokiaNetworkinstanceStateMachine) updateSrlnokiaNetworkinstanceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstancehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceStateMachine) handleNone(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceReconcileInfo) actionResult {
	return actionComplete{}
}
