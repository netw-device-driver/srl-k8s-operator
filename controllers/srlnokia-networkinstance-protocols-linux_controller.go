...
// SrlnokiaNetworkinstanceProtocolsLinuxReconciler reconciles a SrlnokiaNetworkinstanceProtocolsLinux object
type SrlnokiaNetworkinstanceProtocolsLinuxReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceProtocolsLinuxTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo
}

type SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolslinuxes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolslinuxes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolslinuxes/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceProtocolsLinux.
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinuxList{}
...
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsLinux) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsLinuxIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaNetworkinstanceProtocolsLinux", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceProtocolsLinux")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceProtocolsLinux config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaNetworkinstanceProtocolsLinux)
	if err != nil {
	...
	if err := r.saveSrlnokiaNetworkinstanceProtocolsLinuxStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceProtocolsLinuxhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinuxFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinuxFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceProtocolsLinux" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceProtocolsLinuxStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsLinuxhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinuxFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceProtocolsLinuxlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceProtocolsLinuxlogResult(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceProtocolsLinux",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) saveSrlnokiaNetworkinstanceProtocolsLinuxStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceProtocolsLinux",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceProtocolsLinux ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceProtocolsLinuxReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceProtocolsLinuxhasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceProtocolsLinuxhasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinuxFinalizer)
}

func (info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsLinuxhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Linux: info.o.Spec.SrlnokiaNetworkinstanceProtocolsLinux,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceProtocolsLinuxStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux
	Reconciler *SrlnokiaNetworkinstanceProtocolsLinuxReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceProtocolsLinuxStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsLinux,
	reconciler *SrlnokiaNetworkinstanceProtocolsLinuxReconciler, n *string,
	info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceProtocolsLinuxStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceProtocolsLinuxstateHandler func(*SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsLinuxstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsLinuxstateHandler{
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) updateSrlnokiaNetworkinstanceProtocolsLinuxStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceProtocolsLinuxStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceProtocolsLinuxStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsLinuxhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) handleNone(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsLinuxStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceProtocolsLinuxReconcileInfo) actionResult {
	return actionComplete{}
}
