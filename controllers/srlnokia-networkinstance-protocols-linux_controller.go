	...
	*/
	...
	var NetworkinstanceProtocolsLinuxIntraResourceleafRef= map[string]*LeafRef{
	}

	var NetworkinstanceProtocolsLinuxInterResourceleafRef = map[string]*LeafRef{
	}
	...
	// the SrlnokiaNetworkinstanceProtocolsLinux object against the actual cluster state, and then
