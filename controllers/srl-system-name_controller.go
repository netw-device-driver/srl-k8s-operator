...
func (r *SrlSystemNameReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlSystemNameReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNamehasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlSystemName)
		if err != nil {
...
func (r *SrlSystemNameReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlSystemName) (*[]string, error) {
...
func (info *SrlSystemNameReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlSystemNameReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
