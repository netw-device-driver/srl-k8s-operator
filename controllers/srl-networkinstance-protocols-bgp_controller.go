...
var NetworkinstanceProtocolsBgpInternalResourceleafRef = map[string]*ElementWithLeafRef{
...
var NetworkinstanceProtocolsBgpExternalResourceleafRef = map[string]*ElementWithLeafRef{
...
type SrlNetworkinstanceProtocolsBgpTargetReconcileInfo struct {
	Target map[string]*SrlNetworkinstanceProtocolsBgpReconcileInfo
}
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgps/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlNetworkinstanceProtocolsBgpReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlNetworkinstanceProtocolsBgp", request.NamespacedName)
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp)
		if !(oldOK && newOK) {
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp{}).
...
// request for reconciliation of SrlNetworkinstanceProtocolsBgp.
func (r *SrlNetworkinstanceProtocolsBgpReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpList{}
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp, cm *string) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpExternalResourceleafRef", NetworkinstanceProtocolsBgpExternalResourceleafRef).Info("External leafref STATUS All")
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpInternalResourceleafRef", NetworkinstanceProtocolsBgpInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlNetworkinstanceProtocolsBgp", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlNetworkinstanceProtocolsBgp")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlNetworkinstanceProtocolsBgp config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNetworkinstanceProtocolsBgphasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgphasFinalizer(o) {
		if SrlNetworkinstanceProtocolsBgphasOtherFinalizer(o) {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgphasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlNetworkinstanceProtocolsBgp" + "." + strcase.UpperCamelCase(o.Name)
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgphasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceProtocolsBgp"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlNetworkinstanceProtocolsBgpReconcileInfo)
	...
	for _, target := range t {
		...
		stateMachine := newSrlNetworkinstanceProtocolsBgpStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlNetworkinstanceProtocolsBgplogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNetworkinstanceProtocolsBgplogResult(info *SrlNetworkinstanceProtocolsBgpReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsBgp")
		//info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsBgp",
		//	"message", info.o.Status)
	}
}

func (r *SrlNetworkinstanceProtocolsBgpReconciler) saveSrlNetworkinstanceProtocolsBgpStatus(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlNetworkinstanceProtocolsBgp",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlNetworkinstanceProtocolsBgp ")
		return err
	}
	return nil
}

func (r *SrlNetworkinstanceProtocolsBgpReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceProtocolsBgp"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsBgp.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsBgp.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceProtocolsBgp.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp) (bool, *[]string, error) {
...
func (r *SrlNetworkinstanceProtocolsBgpReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp) ([]*Target, bool, error) {
...
// SrlNetworkinstanceProtocolsBgphasFinalizer checks if object has finalizer
func SrlNetworkinstanceProtocolsBgphasFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpFinalizer)
}

// SSrlNetworkinstanceProtocolsBgphasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceProtocolsBgphasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceProtocolsBgpReconcileInfo) UpdateCache(path string) error {
	...
	dd := struct {
		...
		Bgp: info.o.Spec.SrlNetworkinstanceProtocolsBgp,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlNetworkinstanceProtocolsBgpStateMachine struct {
	Object     *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp
	Reconciler *SrlNetworkinstanceProtocolsBgpReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlNetworkinstanceProtocolsBgpReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlNetworkinstanceProtocolsBgpStateMachine(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgp,
	reconciler *SrlNetworkinstanceProtocolsBgpReconciler, n *string,
	info *SrlNetworkinstanceProtocolsBgpReconcileInfo) *SrlNetworkinstanceProtocolsBgpStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlNetworkinstanceProtocolsBgpStateMachine{
		Object:     o,
...
type SrlNetworkinstanceProtocolsBgpstateHandler func(*SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult

func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsBgpstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsBgpstateHandler{
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) updateSrlNetworkinstanceProtocolsBgpStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlNetworkinstanceProtocolsBgpReconcileInfo) {
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) ReconcileState(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlNetworkinstanceProtocolsBgpStateFrom(initialState, info)
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgphasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleNone(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleConfiguring(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleConfigureFailed(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleDeleting(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleDeleteFailed(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
