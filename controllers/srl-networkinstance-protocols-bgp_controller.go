...
func SrlNetworkinstanceProtocolsBgplogResult(info *SrlNetworkinstanceProtocolsBgpReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlNetworkinstanceProtocolsBgp",
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleConfigStatusConfigureSuccess(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) handleConfigStatusConfigureFailed(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) DeleteFailed(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpStateMachine) DeleteSuccess(info *SrlNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	return actionComplete{}
}
