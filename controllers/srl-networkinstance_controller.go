...
func (r *SrlNetworkinstanceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (info *SrlNetworkinstanceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlNetworkinstanceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
