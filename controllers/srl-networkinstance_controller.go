...
func (r *SrlNetworkinstanceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstancehasFinalizer(o) {
		if SrlNetworkinstancehasOtherFinalizer(o) {
...
// SSrlNetworkinstancehasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstancehasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstance) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceFinalizer {
			return true
		}
	}
	return false
