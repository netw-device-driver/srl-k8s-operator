...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlNetworkinstanceProtocolsOspf)
		if err != nil {
...
func (info *SrlNetworkinstanceProtocolsOspfReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsOspfReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
