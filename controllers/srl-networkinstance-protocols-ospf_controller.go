...
type SrlNetworkinstanceProtocolsOspfTargetReconcileInfo struct {
	Target map[string]*SrlNetworkinstanceProtocolsOspfReconcileInfo
}

type SrlNetworkinstanceProtocolsOspfReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsospfs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsospfs/status,verbs=get;update;patch
...
/*
	func (r *SrlNetworkinstanceProtocolsOspfReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf)
		if !(oldOK && newOK) {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf{}).
...
// request for reconciliation of SrlNetworkinstanceProtocolsOspf.
func (r *SrlNetworkinstanceProtocolsOspfReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspfList{}
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlNetworkinstanceProtocolsOspf", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlNetworkinstanceProtocolsOspf")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlNetworkinstanceProtocolsOspf config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNetworkinstanceProtocolsOspfhasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspfFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspfFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(o) {
		if SrlNetworkinstanceProtocolsOspfhasOtherFinalizer(o) {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspfFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlNetworkinstanceProtocolsOspf" + "." + strcase.UpperCamelCase(o.Name)
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceProtocolsOspf"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlNetworkinstanceProtocolsOspfReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlNetworkinstanceProtocolsOspfStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlNetworkinstanceProtocolsOspflogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNetworkinstanceProtocolsOspflogResult(info *SrlNetworkinstanceProtocolsOspfReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsOspf")
		//info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsOspf",
		//	"message", info.o.Status)
	}
}

func (r *SrlNetworkinstanceProtocolsOspfReconciler) saveSrlNetworkinstanceProtocolsOspfStatus(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlNetworkinstanceProtocolsOspf",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlNetworkinstanceProtocolsOspf ")
		return err
	}
	return nil
}
...
/*
	func (r *SrlNetworkinstanceProtocolsOspfReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceProtocolsOspf"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsOspf.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceProtocolsOspfReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsOspf.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceProtocolsOspf.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceProtocolsOspfReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf) ([]*Target, bool, error) {
...
// SrlNetworkinstanceProtocolsOspfhasFinalizer checks if object has finalizer
func SrlNetworkinstanceProtocolsOspfhasFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspfFinalizer)
}

// SSrlNetworkinstanceProtocolsOspfhasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceProtocolsOspfhasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspfFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceProtocolsOspfReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsOspfReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	dd := struct {
		Ospf *srlinuxv1alpha1.NetworkinstanceProtocolsOspf `json:"ospf"`
	}{
		Ospf: info.o.Spec.SrlNetworkinstanceProtocolsOspf,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlNetworkinstanceProtocolsOspfStateMachine struct {
	Object     *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf
	Reconciler *SrlNetworkinstanceProtocolsOspfReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlNetworkinstanceProtocolsOspfReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlNetworkinstanceProtocolsOspfStateMachine(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf,
	reconciler *SrlNetworkinstanceProtocolsOspfReconciler, n *string,
	info *SrlNetworkinstanceProtocolsOspfReconcileInfo) *SrlNetworkinstanceProtocolsOspfStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlNetworkinstanceProtocolsOspfStateMachine{
		Object:     o,
...
type SrlNetworkinstanceProtocolsOspfstateHandler func(*SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult

func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsOspfstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsOspfstateHandler{
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) updateSrlNetworkinstanceProtocolsOspfStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlNetworkinstanceProtocolsOspfReconcileInfo) {
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) ReconcileState(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlNetworkinstanceProtocolsOspfStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlNetworkinstanceProtocolsOspfStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleNone(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleConfiguring(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleConfigureFailed(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleDeleting(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleDeleteFailed(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
