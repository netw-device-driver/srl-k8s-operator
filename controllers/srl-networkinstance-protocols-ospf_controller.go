...
/*
	func (r *SrlNetworkinstanceProtocolsOspfReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsOspf) (err error) {
		// marshal data to json
		dd := struct {
			Ospf *srlinuxv1alpha1.NetworkinstanceProtocolsOspf `json:"ospf"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range NetworkinstanceProtocolsOspfIntraResourceleafRef {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsOspfhasFinalizer(o) {
		...
		/*
			...
			for s, elementWithLeafRef := range NetworkinstanceProtocolsOspfIntraResourceleafRef {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsOspfReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsOspf) ([]string, error) {
