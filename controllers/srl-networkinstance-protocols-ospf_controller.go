...
func SrlNetworkinstanceProtocolsOspflogResult(info *SrlNetworkinstanceProtocolsOspfReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlNetworkinstanceProtocolsOspf",
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleConfigStatusConfigureSuccess(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) handleConfigStatusConfigureFailed(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) DeleteFailed(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsOspfStateMachine) DeleteSuccess(info *SrlNetworkinstanceProtocolsOspfReconcileInfo) actionResult {
	return actionComplete{}
}
