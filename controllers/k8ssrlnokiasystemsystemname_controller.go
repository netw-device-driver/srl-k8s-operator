...
// K8sSrlNokiaSystemSystemNameReconciler reconciles a SrlNokiaSystemSystemName object
type K8sSrlNokiaSystemSystemNameReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaSystemSystemNameTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaSystemSystemNameReconcileInfo
}

type K8sSrlNokiaSystemSystemNameReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaSystemSystemName
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemnames,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemnames/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokiasystemsystemnames/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaSystemSystemNameReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaSystemSystemName{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaSystemSystemName.
func (r *K8sSrlNokiaSystemSystemNameReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaSystemSystemNameList{}
...
// the SrlNokiaSystemSystemName object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaSystemSystemNameReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaSystemSystemName", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaSystemSystemName")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaSystemSystemName config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaSystemSystemNamehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaSystemSystemNameFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaSystemSystemNameFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaSystemSystemNameStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaSystemSystemName" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaSystemSystemNameReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaSystemSystemNameReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaSystemSystemNameStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNamehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemNameFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaSystemSystemNamelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaSystemSystemNamelogResult(info *K8sSrlNokiaSystemSystemNameReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaSystemSystemName",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaSystemSystemNameReconciler) saveK8sSrlNokiaSystemSystemNameStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemName) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaSystemSystemName",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaSystemSystemName ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaSystemSystemNameReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemName) ([]*Target, bool, error) {
...
// SrlNokiaSystemSystemNamehasFinalizer checks if object has finalizer
func SrlNokiaSystemSystemNamehasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemName) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaSystemSystemNameFinalizer)
}

func (info *K8sSrlNokiaSystemSystemNameReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNamehasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaSystemSystemNameReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Name *srlinuxv1alpha1.SrlNokiaSystemSystemName `json:"name"`
	}{
		Name: info.o.Spec.SrlNokiaSystemSystemName,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaSystemSystemNameStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaSystemSystemName
	Reconciler *K8sSrlNokiaSystemSystemNameReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaSystemSystemNameReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaSystemSystemNameStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaSystemSystemName,
	reconciler *K8sSrlNokiaSystemSystemNameReconciler, n *string,
	info *K8sSrlNokiaSystemSystemNameReconcileInfo) *K8sSrlNokiaSystemSystemNameStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaSystemSystemNameStateMachine{
		Object:     o,
...
type SrlNokiaSystemSystemNamestateHandler func(*K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult

func (o *K8sSrlNokiaSystemSystemNameStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemNamestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaSystemSystemNamestateHandler{
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) updateK8sSrlNokiaSystemSystemNameStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaSystemSystemNameReconcileInfo) {
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) ReconcileState(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaSystemSystemNameStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaSystemSystemNameStateMachine deletion")
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaSystemSystemNamehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) handleNone(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) handleConfiguring(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) handleDeleting(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) DeleteFailed(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaSystemSystemNameStateMachine) DeleteSuccess(info *K8sSrlNokiaSystemSystemNameReconcileInfo) actionResult {
	return actionComplete{}
}
