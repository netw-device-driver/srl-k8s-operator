...
func (r *SrlNetworkinstanceStaticroutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceStaticrouteshasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlNetworkinstanceStaticroutes)
		if err != nil {
...
func (r *SrlNetworkinstanceStaticroutesReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceStaticroutes) (*[]string, error) {
...
func (info *SrlNetworkinstanceStaticroutesReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlNetworkinstanceStaticroutesReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
