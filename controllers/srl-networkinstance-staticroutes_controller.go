...
var NetworkinstanceStaticroutesInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceStaticroutesExternalResourceleafRef = map[string]*ElementWithLeafRef{
...
func (r *SrlNetworkinstanceStaticroutesReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceStaticroutesReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceStaticroutes, cm *string) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceStaticroutesExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceStaticroutesExternalResourceleafRef", NetworkinstanceStaticroutesExternalResourceleafRef).Info("External leafref STATUS All")
...
func (r *SrlNetworkinstanceStaticroutesReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceStaticroutes) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceStaticroutesInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceStaticroutesInternalResourceleafRef", NetworkinstanceStaticroutesInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlNetworkinstanceStaticroutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceStaticrouteshasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceStaticroutes"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
...
func SrlNetworkinstanceStaticrouteslogResult(info *SrlNetworkinstanceStaticroutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceStaticroutes")
		//info.log.Info("stopping reconcile SrlNetworkinstanceStaticroutes",
...
func (r *SrlNetworkinstanceStaticroutesReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
func (o *SrlNetworkinstanceStaticroutesStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceStaticroutesStateMachine) handleConfigureFailed(info *SrlNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceStaticroutesStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceStaticroutesReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceStaticroutesStateMachine) handleDeleteFailed(info *SrlNetworkinstanceStaticroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
