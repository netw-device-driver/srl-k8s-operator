...
func SrlNetworkinstanceProtocolsBgpvpnlogResult(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlNetworkinstanceProtocolsBgpvpn",
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigStatusConfigureSuccess(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigStatusConfigureFailed(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) DeleteFailed(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) DeleteSuccess(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	return actionComplete{}
}
