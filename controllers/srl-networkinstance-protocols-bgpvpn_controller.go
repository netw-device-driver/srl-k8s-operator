...
var NetworkinstanceProtocolsBgpvpnInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceProtocolsBgpvpnExternalResourceleafRef = map[string]*ElementWithLeafRef{
	"/bgp-vpn/bgp-instance[id=]/export-policy": {
		REkvl: []ElementKeyValue{
			{"routing-policy", "", ""},
			{"policy", "name", "string"},
		},
	},
	"/bgp-vpn/bgp-instance[id=]/import-policy": {
		REkvl: []ElementKeyValue{
			{"routing-policy", "", ""},
			{"policy", "name", "string"},
		},
...
// SrlNetworkinstanceProtocolsBgpvpnReconciler reconciles a SrlNetworkinstanceProtocolsBgpvpn object
type SrlNetworkinstanceProtocolsBgpvpnReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlNetworkinstanceProtocolsBgpvpnTargetReconcileInfo struct {
	Target map[string]*SrlNetworkinstanceProtocolsBgpvpnReconcileInfo
}

type SrlNetworkinstanceProtocolsBgpvpnReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgpvpns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgpvpns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceprotocolsbgpvpns/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlNetworkinstanceProtocolsBgpvpn", request.NamespacedName)
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
		if !(oldOK && newOK) {
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn{}).
...
// request for reconciliation of SrlNetworkinstanceProtocolsBgpvpn.
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpnList{}
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn, cm *string) (err error) {
	...
	dd := struct {
		...
		BgpVpn: o.Spec.SrlNetworkinstanceProtocolsBgpvpn,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpvpnExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpvpnExternalResourceleafRef", NetworkinstanceProtocolsBgpvpnExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceProtocolsBgpvpnInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceProtocolsBgpvpnInternalResourceleafRef", NetworkinstanceProtocolsBgpvpnInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlNetworkinstanceProtocolsBgpvpn", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlNetworkinstanceProtocolsBgpvpn")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlNetworkinstanceProtocolsBgpvpn config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpnFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpnFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		if SrlNetworkinstanceProtocolsBgpvpnhasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		...
		if err := r.saveSrlNetworkinstanceProtocolsBgpvpnStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpnFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlNetworkinstanceProtocolsBgpvpn" + "." + strcase.UpperCamelCase(o.Name)
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceProtocolsBgpvpn"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlNetworkinstanceProtocolsBgpvpnReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlNetworkinstanceProtocolsBgpvpnReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlNetworkinstanceProtocolsBgpvpnStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlNetworkinstanceProtocolsBgpvpnlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNetworkinstanceProtocolsBgpvpnlogResult(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsBgpvpn")
		//info.log.Info("stopping reconcile SrlNetworkinstanceProtocolsBgpvpn",
		//	"message", info.o.Status)
	}
}

func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) saveSrlNetworkinstanceProtocolsBgpvpnStatus(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlNetworkinstanceProtocolsBgpvpn",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlNetworkinstanceProtocolsBgpvpn ")
		return err
	}
	return nil
}

func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceProtocolsBgpvpn"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsBgpvpn.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceProtocolsBgpvpn.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceProtocolsBgpvpn.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn) (bool, *[]string, error) {
...
func (r *SrlNetworkinstanceProtocolsBgpvpnReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn) ([]*Target, bool, error) {
...
// SrlNetworkinstanceProtocolsBgpvpnhasFinalizer checks if object has finalizer
func SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpnFinalizer)
}

// SSrlNetworkinstanceProtocolsBgpvpnhasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceProtocolsBgpvpnhasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpnFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	dd := struct {
		BgpVpn *srlinuxv1alpha1.NetworkinstanceProtocolsBgpvpn `json:"bgp-vpn"`
	}{
		BgpVpn: info.o.Spec.SrlNetworkinstanceProtocolsBgpvpn,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlNetworkinstanceProtocolsBgpvpnStateMachine struct {
	Object     *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn
	Reconciler *SrlNetworkinstanceProtocolsBgpvpnReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlNetworkinstanceProtocolsBgpvpnStateMachine(o *srlinuxv1alpha1.SrlNetworkinstanceProtocolsBgpvpn,
	reconciler *SrlNetworkinstanceProtocolsBgpvpnReconciler, n *string,
	info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) *SrlNetworkinstanceProtocolsBgpvpnStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlNetworkinstanceProtocolsBgpvpnStateMachine{
		Object:     o,
...
type SrlNetworkinstanceProtocolsBgpvpnstateHandler func(*SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult

func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsBgpvpnstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceProtocolsBgpvpnstateHandler{
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) updateSrlNetworkinstanceProtocolsBgpvpnStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) {
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) ReconcileState(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlNetworkinstanceProtocolsBgpvpnStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlNetworkinstanceProtocolsBgpvpnStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNetworkinstanceProtocolsBgpvpnhasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleNone(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleConfiguring(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigureFailed(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleting(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleteFailed(info *SrlNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
