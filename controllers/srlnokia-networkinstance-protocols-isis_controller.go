...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) validateIfElementWithLeafRefExists(last bool, e string, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) validateLeafRefExists(last bool, e string, o interface{}, leafrefValue string) (interface{}, bool) {
	xType := reflect.TypeOf(o)
	xValue := reflect.ValueOf(o)
	r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsIsis) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsIsisInterResourceleafRef {
