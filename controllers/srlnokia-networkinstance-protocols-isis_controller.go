...
var NetworkinstanceProtocolsIsisIntraResourceleafRef = map[string]*LeafRef{}

var NetworkinstanceProtocolsIsisInterResourceleafRef = map[string]*LeafRef{
	...
	"/network-instance/protocols/isis/instance/interface/interface-name": {
		AbsoluteLeafRefPath: "/network-instance/name=current()/name]",
		RelativeLeafRefPath: "",
...
// the SrlnokiaNetworkinstanceProtocolsIsis object against the actual cluster state, and then
