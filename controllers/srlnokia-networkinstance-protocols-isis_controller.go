...
// SrlnokiaNetworkinstanceProtocolsIsisReconciler reconciles a SrlnokiaNetworkinstanceProtocolsIsis object
type SrlnokiaNetworkinstanceProtocolsIsisReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceProtocolsIsisTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo
}

type SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsises,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsises/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsises/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceProtocolsIsis.
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsisList{}
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsIsis) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsIsisIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaNetworkinstanceProtocolsIsis", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceProtocolsIsis")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceProtocolsIsis config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaNetworkinstanceProtocolsIsis)
	if err != nil {
	...
	if err := r.saveSrlnokiaNetworkinstanceProtocolsIsisStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceProtocolsIsishasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsisFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsisFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceProtocolsIsis" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceProtocolsIsisStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsIsishasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsisFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceProtocolsIsislogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceProtocolsIsislogResult(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceProtocolsIsis",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) saveSrlnokiaNetworkinstanceProtocolsIsisStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceProtocolsIsis",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceProtocolsIsis ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceProtocolsIsisReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceProtocolsIsishasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceProtocolsIsishasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsisFinalizer)
}

func (info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsIsishasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Isis: info.o.Spec.SrlnokiaNetworkinstanceProtocolsIsis,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceProtocolsIsisStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis
	Reconciler *SrlnokiaNetworkinstanceProtocolsIsisReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceProtocolsIsisStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsIsis,
	reconciler *SrlnokiaNetworkinstanceProtocolsIsisReconciler, n *string,
	info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) *SrlnokiaNetworkinstanceProtocolsIsisStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceProtocolsIsisStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceProtocolsIsisstateHandler func(*SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsIsisstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsIsisstateHandler{
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) updateSrlnokiaNetworkinstanceProtocolsIsisStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceProtocolsIsisStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceProtocolsIsisStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsIsishasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) handleNone(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsIsisStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceProtocolsIsisReconcileInfo) actionResult {
	return actionComplete{}
}
