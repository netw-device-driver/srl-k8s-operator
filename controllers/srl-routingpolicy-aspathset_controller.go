...
var RoutingpolicyAspathsetIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var RoutingpolicyAspathsetInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var RoutingpolicyAspathsetInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlRoutingpolicyAspathsetReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlRoutingpolicyAspathsetReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlRoutingpolicyAspathsetReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) (err error) {
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyAspathsetIntraResourceleafRef {
	...
	r.Log.WithValues("RoutingpolicyAspathsetIntraResourceleafRef", RoutingpolicyAspathsetIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
