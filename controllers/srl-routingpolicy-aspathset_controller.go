...
func (r *SrlRoutingpolicyAspathsetReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (info *SrlRoutingpolicyAspathsetReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlRoutingpolicyAspathsetReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
