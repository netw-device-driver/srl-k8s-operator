...
var RoutingpolicyAspathsetInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var RoutingpolicyAspathsetExternalResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlRoutingpolicyAspathsetReconciler reconciles a SrlRoutingpolicyAspathset object
type SrlRoutingpolicyAspathsetReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlRoutingpolicyAspathsetTargetReconcileInfo struct {
	Target map[string]*SrlRoutingpolicyAspathsetReconcileInfo
}

type SrlRoutingpolicyAspathsetReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicyaspathsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicyaspathsets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicyaspathsets/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlRoutingpolicyAspathsetReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlRoutingpolicyAspathset", request.NamespacedName)
...
/*
	func (r *SrlRoutingpolicyAspathsetReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlRoutingpolicyAspathset)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlRoutingpolicyAspathset)
		if !(oldOK && newOK) {
...
func (r *SrlRoutingpolicyAspathsetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlRoutingpolicyAspathset{}).
...
// request for reconciliation of SrlRoutingpolicyAspathset.
func (r *SrlRoutingpolicyAspathsetReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlRoutingpolicyAspathsetList{}
...
func (r *SrlRoutingpolicyAspathsetReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlRoutingpolicyAspathsetReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyAspathset, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *o.Spec.SrlRoutingpolicyAspathset {
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyAspathsetExternalResourceleafRef {
	...
	r.Log.WithValues("RoutingpolicyAspathsetExternalResourceleafRef", RoutingpolicyAspathsetExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlRoutingpolicyAspathsetReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) (err error) {
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyAspathsetInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("RoutingpolicyAspathsetInternalResourceleafRef", RoutingpolicyAspathsetInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlRoutingpolicyAspathsetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlRoutingpolicyAspathset", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlRoutingpolicyAspathset")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlRoutingpolicyAspathset config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlRoutingpolicyAspathsethasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlRoutingpolicyAspathsetFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlRoutingpolicyAspathsetFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlRoutingpolicyAspathsethasFinalizer(o) {
		if SrlRoutingpolicyAspathsethasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlRoutingpolicyAspathsethasFinalizer(o) {
		...
		if err := r.saveSrlRoutingpolicyAspathsetStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlRoutingpolicyAspathsethasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlRoutingpolicyAspathsetFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlRoutingpolicyAspathset" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlRoutingpolicyAspathset {
	...
	if o.DeletionTimestamp.IsZero() && SrlRoutingpolicyAspathsethasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlRoutingpolicyAspathset"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlRoutingpolicyAspathsetReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlRoutingpolicyAspathsetReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlRoutingpolicyAspathsetStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlRoutingpolicyAspathsetlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlRoutingpolicyAspathsetlogResult(info *SrlRoutingpolicyAspathsetReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlRoutingpolicyAspathset")
		//info.log.Info("stopping reconcile SrlRoutingpolicyAspathset",
		//	"message", info.o.Status)
	}
}

func (r *SrlRoutingpolicyAspathsetReconciler) saveSrlRoutingpolicyAspathsetStatus(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlRoutingpolicyAspathset",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlRoutingpolicyAspathset ")
		return err
	}
	return nil
}

func (r *SrlRoutingpolicyAspathsetReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlRoutingpolicyAspathsetReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlRoutingpolicyAspathset"] = string(d)
		cm.Data[fmt.Sprintf("SrlRoutingpolicyAspathset.%s",*oName)] = string(d)
...
/*
	func (r *SrlRoutingpolicyAspathsetReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlRoutingpolicyAspathset.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlRoutingpolicyAspathset.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlRoutingpolicyAspathsetReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlRoutingpolicyAspathsetReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlRoutingpolicyAspathsetReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlRoutingpolicyAspathsetReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlRoutingpolicyAspathsetReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlRoutingpolicyAspathsetReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) (bool, *[]string, error) {
...
func (r *SrlRoutingpolicyAspathsetReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) ([]*Target, bool, error) {
...
// SrlRoutingpolicyAspathsethasFinalizer checks if object has finalizer
func SrlRoutingpolicyAspathsethasFinalizer(o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlRoutingpolicyAspathsetFinalizer)
}

// SSrlRoutingpolicyAspathsethasOtherFinalizer checks if object has other finalizers
func SrlRoutingpolicyAspathsethasOtherFinalizer(o *srlinuxv1alpha1.SrlRoutingpolicyAspathset) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlRoutingpolicyAspathsetFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlRoutingpolicyAspathsetReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlRoutingpolicyAspathsethasFinalizer(info.o) {
...
// Update Cache
func (info *SrlRoutingpolicyAspathsetReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlRoutingpolicyAspathset {
		o := make([]srlinuxv1alpha1.RoutingpolicyAspathset, 0)
		o = append(o, obj)
		dd := struct {
			AsPathSet *[]srlinuxv1alpha1.RoutingpolicyAspathset `json:"as-path-set"`
...
type SrlRoutingpolicyAspathsetStateMachine struct {
	Object     *srlinuxv1alpha1.SrlRoutingpolicyAspathset
	Reconciler *SrlRoutingpolicyAspathsetReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlRoutingpolicyAspathsetReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlRoutingpolicyAspathsetStateMachine(o *srlinuxv1alpha1.SrlRoutingpolicyAspathset,
	reconciler *SrlRoutingpolicyAspathsetReconciler, n *string,
	info *SrlRoutingpolicyAspathsetReconcileInfo) *SrlRoutingpolicyAspathsetStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlRoutingpolicyAspathsetStateMachine{
		Object:     o,
...
type SrlRoutingpolicyAspathsetstateHandler func(*SrlRoutingpolicyAspathsetReconcileInfo) actionResult

func (o *SrlRoutingpolicyAspathsetStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlRoutingpolicyAspathsetstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlRoutingpolicyAspathsetstateHandler{
...
func (o *SrlRoutingpolicyAspathsetStateMachine) updateSrlRoutingpolicyAspathsetStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlRoutingpolicyAspathsetReconcileInfo) {
...
func (o *SrlRoutingpolicyAspathsetStateMachine) ReconcileState(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlRoutingpolicyAspathsetStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlRoutingpolicyAspathsetStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlRoutingpolicyAspathsethasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleNone(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleConfiguring(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleConfigureSuccess(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleConfigureFailed(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleDeleting(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleDeleteSuccess(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlRoutingpolicyAspathsetStateMachine) handleDeleteFailed(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
