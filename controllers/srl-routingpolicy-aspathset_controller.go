...
func SrlRoutingpolicyAspathsetlogResult(info *SrlRoutingpolicyAspathsetReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlRoutingpolicyAspathset",
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleConfigStatusConfigureSuccess(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) handleConfigStatusConfigureFailed(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) DeleteFailed(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyAspathsetStateMachine) DeleteSuccess(info *SrlRoutingpolicyAspathsetReconcileInfo) actionResult {
	return actionComplete{}
}
