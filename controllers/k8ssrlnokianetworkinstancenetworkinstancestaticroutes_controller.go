...
// K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler reconciles a SrlNokiaNetworkInstanceNetworkInstanceStaticRoutes object
type K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo
}

type K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesList{}
...
// the SrlNokiaNetworkInstanceNetworkInstanceStaticRoutes object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaNetworkInstanceNetworkInstanceStaticRouteshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceStaticRouteshasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaNetworkInstanceNetworkInstanceStaticRouteslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaNetworkInstanceNetworkInstanceStaticRouteslogResult(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler) saveK8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes) ([]*Target, bool, error) {
...
// SrlNokiaNetworkInstanceNetworkInstanceStaticRouteshasFinalizer checks if object has finalizer
func SrlNokiaNetworkInstanceNetworkInstanceStaticRouteshasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesFinalizer)
}

func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceStaticRouteshasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		StaticRoutes *srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceStaticRoutes `json:"static-routes"`
	}{
		StaticRoutes: info.o.Spec.SrlNokiaNetworkInstanceNetworkInstanceStaticRoutes,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes
	Reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutes,
	reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconciler, n *string,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine{
		Object:     o,
...
type SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesstateHandler func(*K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult

func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceStaticRoutesstateHandler{
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) updateK8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) ReconcileState(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine deletion")
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceStaticRouteshasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) handleNone(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) handleConfiguring(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) handleDeleting(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) DeleteFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesStateMachine) DeleteSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceStaticRoutesReconcileInfo) actionResult {
	return actionComplete{}
}
