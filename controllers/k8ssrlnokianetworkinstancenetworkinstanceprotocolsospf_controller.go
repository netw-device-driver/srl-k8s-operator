...
// K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler reconciles a SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf object
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo
}

type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceprotocolsospfs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceprotocolsospfs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstanceprotocolsospfs/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfList{}
...
// the SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfhasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStatus(ctx, o); err != nil {
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf" + "." + strcase.UpperCamelCase(o.Name)
	...
	deletepaths = append(deletepaths, fmt.Sprintf("/network-instance[name=%s]/protocols/ospf", hkey0))

	// path to be used for this object
	path := fmt.Sprintf("/network-instance[name=%s]/protocols", hkey0)

	info := make(map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspflogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspflogResult(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler) saveK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf) ([]*Target, bool, error) {
...
// SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfhasFinalizer checks if object has finalizer
func SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfhasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfFinalizer)
}

func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfhasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Ospf *srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf `json:"ospf"`
	}{
		Ospf: info.o.Spec.SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf
	Reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspf,
	reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconciler, n *string,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine{
		Object:     o,
...
type SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfstateHandler func(*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult

func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfstateHandler{
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) updateK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) ReconcileState(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine deletion")
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) handleNone(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) handleConfiguring(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) handleDeleting(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) DeleteFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfStateMachine) DeleteSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsOspfReconcileInfo) actionResult {
	return actionComplete{}
}
