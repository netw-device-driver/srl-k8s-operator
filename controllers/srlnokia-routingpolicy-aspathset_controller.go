...
func (r *SrlnokiaRoutingpolicyAspathsetReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaRoutingpolicyAspathsetReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaRoutingpolicyAspathsetReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.RoutingpolicyAspathset) (err error) {
	...
	for _, elementWithleafref := range RoutingpolicyAspathsetIntraResourceleafRef {
...
func (r *SrlnokiaRoutingpolicyAspathsetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	for _, vo := range *o.Spec.SrlnokiaRoutingpolicyAspathset {
...
func (r *SrlnokiaRoutingpolicyAspathsetReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaRoutingpolicyAspathset) (*[]string, error) {
