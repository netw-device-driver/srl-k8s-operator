...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.SystemNetworkinstanceProtocolsBgpvpn) (err error) {
		// marshal data to json
		dd := struct {
			BgpVpn *srlinuxv1alpha1.SystemNetworkinstanceProtocolsBgpvpn `json:"bgp-vpn"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		...
		/*
			...
			for s, elementWithLeafRef := range SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef {
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) ([]string, []string, error) {
		...
		leafRefDependencies := make([]string, 0)
		localLeafRefPaths := make([]string, 0)
		for localLeafRef, rekvl := range SystemNetworkinstanceProtocolsBgpvpnInterResourceleafRef {
			// get the ekvl for the local leafref
			ekvl := getHierarchicalElements(localLeafRef)
