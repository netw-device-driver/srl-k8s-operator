...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlSystemNetworkinstanceProtocolsBgpvpn)
		if err != nil {
...
func (info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
