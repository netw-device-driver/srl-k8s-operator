...
var SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var SystemNetworkinstanceProtocolsBgpvpnInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var SystemNetworkinstanceProtocolsBgpvpnInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef {
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef", SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
