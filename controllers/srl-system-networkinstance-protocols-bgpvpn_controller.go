...
func SrlSystemNetworkinstanceProtocolsBgpvpnlogResult(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlSystemNetworkinstanceProtocolsBgpvpn",
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigStatusConfigureSuccess(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigStatusConfigureFailed(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) DeleteFailed(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) DeleteSuccess(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	return actionComplete{}
}
