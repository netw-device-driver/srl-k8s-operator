...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) ([]string, error) {
