...
var SystemNetworkinstanceProtocolsBgpvpnInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var SystemNetworkinstanceProtocolsBgpvpnExternalResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlSystemNetworkinstanceProtocolsBgpvpnReconciler reconciles a SrlSystemNetworkinstanceProtocolsBgpvpn object
type SrlSystemNetworkinstanceProtocolsBgpvpnReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlSystemNetworkinstanceProtocolsBgpvpnTargetReconcileInfo struct {
	Target map[string]*SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo
}

type SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlsystemnetworkinstanceprotocolsbgpvpns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlsystemnetworkinstanceprotocolsbgpvpns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlsystemnetworkinstanceprotocolsbgpvpns/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlSystemNetworkinstanceProtocolsBgpvpn", request.NamespacedName)
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn)
		if !(oldOK && newOK) {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn{}).
...
// request for reconciliation of SrlSystemNetworkinstanceProtocolsBgpvpn.
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpnList{}
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	dd := struct {
		BgpVpn *srlinuxv1alpha1.SystemNetworkinstanceProtocolsBgpvpn `json:"bgp-vpn"`
	}{
		BgpVpn: o.Spec.SrlSystemNetworkinstanceProtocolsBgpvpn,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsBgpvpnExternalResourceleafRef {
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsBgpvpnExternalResourceleafRef", SystemNetworkinstanceProtocolsBgpvpnExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsBgpvpnInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsBgpvpnInternalResourceleafRef", SystemNetworkinstanceProtocolsBgpvpnInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlSystemNetworkinstanceProtocolsBgpvpn", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlSystemNetworkinstanceProtocolsBgpvpn")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlSystemNetworkinstanceProtocolsBgpvpn config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpnFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpnFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		if SrlSystemNetworkinstanceProtocolsBgpvpnhasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		...
		if err := r.saveSrlSystemNetworkinstanceProtocolsBgpvpnStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpnFinalizer)
	...
	deletepaths = append(deletepaths, "/system/network-instance/protocols/bgp-vpn")
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlSystemNetworkinstanceProtocolsBgpvpn"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlSystemNetworkinstanceProtocolsBgpvpnStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlSystemNetworkinstanceProtocolsBgpvpnlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlSystemNetworkinstanceProtocolsBgpvpnlogResult(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlSystemNetworkinstanceProtocolsBgpvpn")
		//info.log.Info("stopping reconcile SrlSystemNetworkinstanceProtocolsBgpvpn",
		//	"message", info.o.Status)
	}
}

func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) saveSrlSystemNetworkinstanceProtocolsBgpvpnStatus(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlSystemNetworkinstanceProtocolsBgpvpn",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlSystemNetworkinstanceProtocolsBgpvpn ")
		return err
	}
	return nil
}

func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlSystemNetworkinstanceProtocolsBgpvpn"] = string(d)
		cm.Data[fmt.Sprintf("SrlSystemNetworkinstanceProtocolsBgpvpn.%s",*oName)] = string(d)
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlSystemNetworkinstanceProtocolsBgpvpn.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlSystemNetworkinstanceProtocolsBgpvpn.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) ([]*Target, bool, error) {
...
// SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer checks if object has finalizer
func SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpnFinalizer)
}

// SSrlSystemNetworkinstanceProtocolsBgpvpnhasOtherFinalizer checks if object has other finalizers
func SrlSystemNetworkinstanceProtocolsBgpvpnhasOtherFinalizer(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpnFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	dd := struct {
		BgpVpn *srlinuxv1alpha1.SystemNetworkinstanceProtocolsBgpvpn `json:"bgp-vpn"`
	}{
		BgpVpn: info.o.Spec.SrlSystemNetworkinstanceProtocolsBgpvpn,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine struct {
	Object     *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn
	Reconciler *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlSystemNetworkinstanceProtocolsBgpvpnStateMachine(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn,
	reconciler *SrlSystemNetworkinstanceProtocolsBgpvpnReconciler, n *string,
	info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine{
		Object:     o,
...
type SrlSystemNetworkinstanceProtocolsBgpvpnstateHandler func(*SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult

func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlSystemNetworkinstanceProtocolsBgpvpnstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlSystemNetworkinstanceProtocolsBgpvpnstateHandler{
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) updateSrlSystemNetworkinstanceProtocolsBgpvpnStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) {
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) ReconcileState(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlSystemNetworkinstanceProtocolsBgpvpnStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleNone(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfiguring(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigureSuccess(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigureFailed(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleting(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleteSuccess(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleteFailed(info *SrlSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
