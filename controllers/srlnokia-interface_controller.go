...
var InterfaceIntraResourceleafRef = map[string]*LeafRef{}

var InterfaceInterResourceleafRef = map[string]*LeafRef{
	...
	"/interface/qos/output/multicast-queue/template": {
		AbsoluteLeafRefPath: "/qos/queue-templates",
		RelativeLeafRefPath: "",
...
// the SrlnokiaInterface object against the actual cluster state, and then
