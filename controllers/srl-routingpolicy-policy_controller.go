...
type SrlRoutingpolicyPolicyTargetReconcileInfo struct {
	Target map[string]*SrlRoutingpolicyPolicyReconcileInfo
}

type SrlRoutingpolicyPolicyReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicypolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicypolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlroutingpolicypolicies/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlRoutingpolicyPolicyReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlRoutingpolicyPolicy", request.NamespacedName)
...
/*
	func (r *SrlRoutingpolicyPolicyReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlRoutingpolicyPolicy)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlRoutingpolicyPolicy)
		if !(oldOK && newOK) {
...
func (r *SrlRoutingpolicyPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlRoutingpolicyPolicy{}).
...
// request for reconciliation of SrlRoutingpolicyPolicy.
func (r *SrlRoutingpolicyPolicyReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlRoutingpolicyPolicyList{}
...
func (r *SrlRoutingpolicyPolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlRoutingpolicyPolicy", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlRoutingpolicyPolicy")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlRoutingpolicyPolicy config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlRoutingpolicyPolicyhasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlRoutingpolicyPolicyFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlRoutingpolicyPolicyFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPolicyhasFinalizer(o) {
		if SrlRoutingpolicyPolicyhasOtherFinalizer(o) {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPolicyhasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlRoutingpolicyPolicyFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlRoutingpolicyPolicy" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlRoutingpolicyPolicy {
	...
	if o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPolicyhasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlRoutingpolicyPolicy"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlRoutingpolicyPolicyReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlRoutingpolicyPolicyStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlRoutingpolicyPolicylogResult(info[target.TargetName], result[target.TargetName])
...
func SrlRoutingpolicyPolicylogResult(info *SrlRoutingpolicyPolicyReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlRoutingpolicyPolicy")
		//info.log.Info("stopping reconcile SrlRoutingpolicyPolicy",
		//	"message", info.o.Status)
	}
}

func (r *SrlRoutingpolicyPolicyReconciler) saveSrlRoutingpolicyPolicyStatus(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPolicy) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlRoutingpolicyPolicy",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlRoutingpolicyPolicy ")
		return err
	}
	return nil
}
...
/*
	func (r *SrlRoutingpolicyPolicyReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlRoutingpolicyPolicy"] = string(d)
		cm.Data[fmt.Sprintf("SrlRoutingpolicyPolicy.%s",*oName)] = string(d)
...
/*
	func (r *SrlRoutingpolicyPolicyReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlRoutingpolicyPolicy.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlRoutingpolicyPolicy.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlRoutingpolicyPolicyReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlRoutingpolicyPolicyReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlRoutingpolicyPolicyReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlRoutingpolicyPolicyReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyPolicy) ([]*Target, bool, error) {
...
// SrlRoutingpolicyPolicyhasFinalizer checks if object has finalizer
func SrlRoutingpolicyPolicyhasFinalizer(o *srlinuxv1alpha1.SrlRoutingpolicyPolicy) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlRoutingpolicyPolicyFinalizer)
}

// SSrlRoutingpolicyPolicyhasOtherFinalizer checks if object has other finalizers
func SrlRoutingpolicyPolicyhasOtherFinalizer(o *srlinuxv1alpha1.SrlRoutingpolicyPolicy) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlRoutingpolicyPolicyFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlRoutingpolicyPolicyReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlRoutingpolicyPolicyhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlRoutingpolicyPolicyReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlRoutingpolicyPolicy {
		o := make([]srlinuxv1alpha1.RoutingpolicyPolicy, 0)
		o = append(o, obj)
		dd := struct {
			Policy *[]srlinuxv1alpha1.RoutingpolicyPolicy `json:"policy"`
...
type SrlRoutingpolicyPolicyStateMachine struct {
	Object     *srlinuxv1alpha1.SrlRoutingpolicyPolicy
	Reconciler *SrlRoutingpolicyPolicyReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlRoutingpolicyPolicyReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlRoutingpolicyPolicyStateMachine(o *srlinuxv1alpha1.SrlRoutingpolicyPolicy,
	reconciler *SrlRoutingpolicyPolicyReconciler, n *string,
	info *SrlRoutingpolicyPolicyReconcileInfo) *SrlRoutingpolicyPolicyStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlRoutingpolicyPolicyStateMachine{
		Object:     o,
...
type SrlRoutingpolicyPolicystateHandler func(*SrlRoutingpolicyPolicyReconcileInfo) actionResult

func (o *SrlRoutingpolicyPolicyStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlRoutingpolicyPolicystateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlRoutingpolicyPolicystateHandler{
...
func (o *SrlRoutingpolicyPolicyStateMachine) updateSrlRoutingpolicyPolicyStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlRoutingpolicyPolicyReconcileInfo) {
...
func (o *SrlRoutingpolicyPolicyStateMachine) ReconcileState(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlRoutingpolicyPolicyStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlRoutingpolicyPolicyStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlRoutingpolicyPolicyStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlRoutingpolicyPolicyhasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlRoutingpolicyPolicyStateMachine) handleNone(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
...
func (o *SrlRoutingpolicyPolicyStateMachine) handleConfiguring(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPolicyStateMachine) handleConfigureSuccess(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPolicyStateMachine) handleConfigureFailed(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPolicyStateMachine) handleDeleting(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyPolicyStateMachine) handleDeleteSuccess(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlRoutingpolicyPolicyStateMachine) handleDeleteFailed(info *SrlRoutingpolicyPolicyReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
