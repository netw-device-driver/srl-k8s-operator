...
var InterfaceInterResourceleafRef = map[string][]ElementKeyValue{
	"/interface[name=]/ethernet/aggregate-id": []ElementKeyValue{
		{"interface", "name", "string"},
	},
	"/interface[name=]/qos/output/multicast-queue[queue-id=]/template": []ElementKeyValue{
		{"qos", "", ""},
		{"queue-templates", "", ""},
		{"queue-template", "name", "string"},
	},
	"/interface[name=]/qos/output/unicast-queue[queue-id=]/template": []ElementKeyValue{
		{"qos", "", ""},
		{"queue-templates", "", ""},
		{"queue-template", "name", "string"},
	},
	"/interface[name=]/qos/output/unicast-queue[queue-id=]/voq-template": []ElementKeyValue{
		{"qos", "", ""},
		{"queue-templates", "", ""},
		{"queue-template", "name", "string"},
	},
...
/*
	...
	func (r *SrlInterfaceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlInterfaceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlInterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlInterface) (err error) {
	...
	for localLeafRef, leafRefInfo := range InterfaceIntraResourceleafRef {
	...
	r.Log.WithValues("InterfaceIntraResourceleafRef", InterfaceIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
