...
var InterfaceInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var InterfaceExternalResourceleafRef = map[string]*ElementWithLeafRef{
	"/interface[name=]/ethernet/aggregate-id": {
		REkvl: []ElementKeyValue{
			{"interface", "name", "string"},
		},
	},
	"/interface[name=]/qos/output/multicast-queue[queue-id=]/template": {
		REkvl: []ElementKeyValue{
			{"qos", "", ""},
			{"queue-templates", "", ""},
	...
	"/interface[name=]/qos/output/unicast-queue[queue-id=]/template": {
		REkvl: []ElementKeyValue{
			{"qos", "", ""},
			{"queue-templates", "", ""},
			{"queue-template", "name", "string"},
	...
	"/interface[name=]/qos/output/unicast-queue[queue-id=]/voq-template": {
		REkvl: []ElementKeyValue{
			{"qos", "", ""},
			{"queue-templates", "", ""},
			{"queue-template", "name", "string"},
...
// SrlInterfaceReconciler reconciles a SrlInterface object
type SrlInterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlInterfaceTargetReconcileInfo struct {
	Target map[string]*SrlInterfaceReconcileInfo
}

type SrlInterfaceReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlinterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlinterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlinterfaces/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlInterfaceReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlInterface", request.NamespacedName)
...
func (r *SrlInterfaceReconciler) updateEventHandler(e event.UpdateEvent) bool {
	_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlInterface)
	_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlInterface)
	if !(oldOK && newOK) {
...
func (r *SrlInterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlInterface{}).
		WithEventFilter(
			predicate.Funcs{
...
// request for reconciliation of SrlInterface.
func (r *SrlInterfaceReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlInterfaceList{}
...
func (r *SrlInterfaceReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlInterfaceReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlInterface, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *o.Spec.SrlInterface {
	...
	for localLeafRef, leafRefInfo := range InterfaceExternalResourceleafRef {
	...
	r.Log.WithValues("InterfaceExternalResourceleafRef", InterfaceExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlInterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlInterface) (err error) {
	...
	for localLeafRef, leafRefInfo := range InterfaceInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("InterfaceInternalResourceleafRef", InterfaceInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlInterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlInterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlInterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlInterface config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlInterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlInterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlInterfaceFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlInterfacehasFinalizer(o) {
		if SrlInterfacehasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlInterfacehasFinalizer(o) {
		...
		if err := r.saveSrlInterfaceStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlInterfacehasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlInterfaceFinalizer)
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "SrlInterface" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlInterface {
	...
	info := make(map[string]*SrlInterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlInterfaceReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlInterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlInterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlInterfacelogResult(info *SrlInterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlInterface",
			"message", info.o.Status)
	}
}

func (r *SrlInterfaceReconciler) saveSrlInterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlInterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlInterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlInterface ")
		return err
	}
	return nil
}

func (r *SrlInterfaceReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
func (r *SrlInterfaceReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
	/*
	...
	*/
	...
	//cm.Data["SrlInterface"] = string(d)
	cm.Data[fmt.Sprintf("SrlInterface.%s", *oName)] = string(d)
...
func (r *SrlInterfaceReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
	cmKey := types.NamespacedName{
		Namespace: "nddriver-system",
		Name:      "nddriver-cm-" + *targetName,
	}
	...
	if _, ok := cm.Data[fmt.Sprintf("SrlInterface.%s", *oName)]; ok {
		delete(cm.Data, fmt.Sprintf("SrlInterface.%s", *oName))
		if err := r.Update(ctx, cm); err != nil {
			r.Log.Error(err, "Failed to update configmap")
			return err
		}
...
func (r *SrlInterfaceReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
	// get configmap
	cmKey := types.NamespacedName{
		Namespace: "nddriver-system",
		Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlInterfaceReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlInterfaceReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlInterfaceReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlInterfaceReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlInterfaceReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlInterface) (bool, *[]string, error) {
...
func (r *SrlInterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlInterface) ([]*Target, bool, error) {
...
// SrlInterfacehasFinalizer checks if object has finalizer
func SrlInterfacehasFinalizer(o *srlinuxv1alpha1.SrlInterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlInterfaceFinalizer)
}

// SSrlInterfacehasOtherFinalizer checks if object has other finalizers
func SrlInterfacehasOtherFinalizer(o *srlinuxv1alpha1.SrlInterface) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlInterfaceFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlInterfaceReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlInterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlInterfaceReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlInterface {
		o := make([]srlinuxv1alpha1.Interface, 0)
		o = append(o, obj)
		dd := struct {
			Interface *[]srlinuxv1alpha1.Interface `json:"interface"`
...
type SrlInterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlInterface
	Reconciler *SrlInterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlInterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlInterfaceStateMachine(o *srlinuxv1alpha1.SrlInterface,
	reconciler *SrlInterfaceReconciler, n *string,
	info *SrlInterfaceReconcileInfo) *SrlInterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlInterfaceStateMachine{
		Object:     o,
...
type SrlInterfacestateHandler func(*SrlInterfaceReconcileInfo) actionResult

func (o *SrlInterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlInterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlInterfacestateHandler{
...
func (o *SrlInterfaceStateMachine) updateSrlInterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlInterfaceReconcileInfo) {
...
func (o *SrlInterfaceStateMachine) ReconcileState(info *SrlInterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlInterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlInterfaceStateMachine deletion")
		info.DeleteCache()
...
func (o *SrlInterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlInterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlInterfaceStateMachine) handleNone(info *SrlInterfaceReconcileInfo) actionResult {
...
func (o *SrlInterfaceStateMachine) handleConfiguring(info *SrlInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceStateMachine) handleConfigStatusConfigureSuccess(info *SrlInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceStateMachine) handleConfigStatusConfigureFailed(info *SrlInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceStateMachine) handleDeleting(info *SrlInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceStateMachine) DeleteFailed(info *SrlInterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceStateMachine) DeleteSuccess(info *SrlInterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
