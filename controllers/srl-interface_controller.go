...
func (r *SrlInterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (info *SrlInterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlInterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
