	...
	*/
	...
	var NetworkinstanceAggregateroutesIntraResourceleafRef= map[string]*LeafRef{
	}

	var NetworkinstanceAggregateroutesInterResourceleafRef = map[string]*LeafRef{
	}
	...
	// the SrlnokiaNetworkinstanceAggregateroutes object against the actual cluster state, and then
