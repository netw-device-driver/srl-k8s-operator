...
// SrlnokiaNetworkinstanceAggregateroutesReconciler reconciles a SrlnokiaNetworkinstanceAggregateroutes object
type SrlnokiaNetworkinstanceAggregateroutesReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceAggregateroutesTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceAggregateroutesReconcileInfo
}

type SrlnokiaNetworkinstanceAggregateroutesReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceaggregateroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceaggregateroutes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceaggregateroutes/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceAggregateroutes.
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutesList{}
...
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceAggregateroutes) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceAggregateroutesIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaNetworkinstanceAggregateroutes", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceAggregateroutes")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceAggregateroutes config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaNetworkinstanceAggregateroutes)
	if err != nil {
	...
	if err := r.saveSrlnokiaNetworkinstanceAggregateroutesStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceAggregaterouteshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutesFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutesFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceAggregateroutes" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceAggregateroutesReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceAggregateroutesReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceAggregateroutesStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceAggregaterouteshasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutesFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceAggregaterouteslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceAggregaterouteslogResult(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceAggregateroutes",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) saveSrlnokiaNetworkinstanceAggregateroutesStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceAggregateroutes",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceAggregateroutes ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceAggregateroutesReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceAggregaterouteshasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceAggregaterouteshasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutesFinalizer)
}

func (info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceAggregaterouteshasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		AggregateRoutes: info.o.Spec.SrlnokiaNetworkinstanceAggregateroutes,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceAggregateroutesStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes
	Reconciler *SrlnokiaNetworkinstanceAggregateroutesReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceAggregateroutesStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceAggregateroutes,
	reconciler *SrlnokiaNetworkinstanceAggregateroutesReconciler, n *string,
	info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) *SrlnokiaNetworkinstanceAggregateroutesStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceAggregateroutesStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceAggregateroutesstateHandler func(*SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceAggregateroutesstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceAggregateroutesstateHandler{
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) updateSrlnokiaNetworkinstanceAggregateroutesStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceAggregateroutesStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceAggregateroutesStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceAggregaterouteshasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) handleNone(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceAggregateroutesStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	return actionComplete{}
}
