...
// SrlnokiaSystemNtpReconciler reconciles a SrlnokiaSystemNtp object
type SrlnokiaSystemNtpReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaSystemNtpTargetReconcileInfo struct {
	Target map[string]*SrlnokiaSystemNtpReconcileInfo
}

type SrlnokiaSystemNtpReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaSystemNtp
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemntps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemntps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemntps/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaSystemNtpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaSystemNtp{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaSystemNtp.
func (r *SrlnokiaSystemNtpReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaSystemNtpList{}
...
func (r *SrlnokiaSystemNtpReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaSystemNtpReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaSystemNtpReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.SystemNtp) (err error) {
	...
	for _, elementWithleafref := range SystemNtpIntraResourceleafRef {
...
func (r *SrlnokiaSystemNtpReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaSystemNtp", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaSystemNtp")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaSystemNtp config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaSystemNtp)
	if err != nil {
	...
	if err := r.saveSrlnokiaSystemNtpStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaSystemNtphasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaSystemNtpFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaSystemNtpFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaSystemNtp" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaSystemNtpReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaSystemNtpReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaSystemNtpStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaSystemNtphasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemNtpFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaSystemNtplogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaSystemNtplogResult(info *SrlnokiaSystemNtpReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaSystemNtp",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaSystemNtpReconciler) saveSrlnokiaSystemNtpStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemNtp) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaSystemNtp",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaSystemNtp ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaSystemNtpReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemNtp) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaSystemNtpReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemNtp) ([]*Target, bool, error) {
...
// SrlnokiaSystemNtphasFinalizer checks if object has finalizer
func SrlnokiaSystemNtphasFinalizer(o *srlinuxv1alpha1.SrlnokiaSystemNtp) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemNtpFinalizer)
}

func (info *SrlnokiaSystemNtpReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaSystemNtphasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaSystemNtpReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Ntp: info.o.Spec.SrlnokiaSystemNtp,
	}
	d := make([][]byte, 0)
...
type SrlnokiaSystemNtpStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaSystemNtp
	Reconciler *SrlnokiaSystemNtpReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaSystemNtpReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaSystemNtpStateMachine(o *srlinuxv1alpha1.SrlnokiaSystemNtp,
	reconciler *SrlnokiaSystemNtpReconciler, n *string,
	info *SrlnokiaSystemNtpReconcileInfo) *SrlnokiaSystemNtpStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaSystemNtpStateMachine{
		Object:     o,
...
type SrlnokiaSystemNtpstateHandler func(*SrlnokiaSystemNtpReconcileInfo) actionResult

func (o *SrlnokiaSystemNtpStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemNtpstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemNtpstateHandler{
...
func (o *SrlnokiaSystemNtpStateMachine) updateSrlnokiaSystemNtpStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaSystemNtpReconcileInfo) {
...
func (o *SrlnokiaSystemNtpStateMachine) ReconcileState(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaSystemNtpStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaSystemNtpStateMachine deletion")
...
func (o *SrlnokiaSystemNtpStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaSystemNtphasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaSystemNtpStateMachine) handleNone(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
...
func (o *SrlnokiaSystemNtpStateMachine) handleConfiguring(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNtpStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNtpStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNtpStateMachine) handleDeleting(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNtpStateMachine) DeleteFailed(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNtpStateMachine) DeleteSuccess(info *SrlnokiaSystemNtpReconcileInfo) actionResult {
	return actionComplete{}
}
