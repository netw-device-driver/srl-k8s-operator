...
var SystemNtpIntraResourceleafRef = map[string]*LeafRef{}

var SystemNtpInterResourceleafRef = map[string]*LeafRef{
...
// the SrlnokiaSystemNtp object against the actual cluster state, and then
