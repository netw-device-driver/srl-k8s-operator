...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) ([]string, error) {
