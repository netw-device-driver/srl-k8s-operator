...
var SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiInterResourceleafRef = map[string][]ElementKeyValue{
	"/ethernet-segment[name=]/interface": []ElementKeyValue{
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiIntraResourceleafRef {
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiIntraResourceleafRef", SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
