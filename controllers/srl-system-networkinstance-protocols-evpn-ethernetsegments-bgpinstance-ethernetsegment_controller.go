...
var SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiExternalResourceleafRef = map[string]*ElementWithLeafRef{
	"/ethernet-segment[name=]/interface": {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi", request.NamespacedName)
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
		if !(oldOK && newOK) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *o.Spec.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiExternalResourceleafRef {
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiExternalResourceleafRef", SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiInternalResourceleafRef", SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsihasFinalizer(o) {
		if SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsihasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsihasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
...
func SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsilogResult(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi")
		//info.log.Info("stopping reconcile SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi",
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi"] = string(d)
		cm.Data[fmt.Sprintf("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi.%s",*oName)] = string(d)
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
// SSrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsihasOtherFinalizer checks if object has other finalizers
func SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsihasOtherFinalizer(o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo) DeleteCache() error {
...
// Update Cache
func (info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo) UpdateCache(path string) error {
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiStateMachine) handleConfigureSuccess(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiStateMachine) handleConfigureFailed(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiStateMachine) handleDeleteSuccess(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiStateMachine) handleDeleteFailed(info *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
