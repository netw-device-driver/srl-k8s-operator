...
func (r *SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) (*[]string, error) {
