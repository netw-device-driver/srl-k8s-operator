...
/*
	func (r *SrlSystemMtuReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.SystemMtu) (err error) {
		// marshal data to json
		dd := struct {
			Mtu *srlinuxv1alpha1.SystemMtu `json:"mtu"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range SystemMtuIntraResourceleafRef {
...
func (r *SrlSystemMtuReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemMtuhasFinalizer(o) {
		...
		/*
			...
			for s, elementWithLeafRef := range SystemMtuIntraResourceleafRef {
...
/*
	func (r *SrlSystemMtuReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlSystemMtu) ([]string, []string, error) {
