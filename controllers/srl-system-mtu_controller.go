...
var SystemMtuIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var SystemMtuInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var SystemMtuInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlSystemMtuReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlSystemMtuReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlSystemMtuReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemMtu) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemMtuIntraResourceleafRef {
	...
	r.Log.WithValues("SystemMtuIntraResourceleafRef", SystemMtuIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
