...
func (r *SrlSystemMtuReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemMtuhasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlSystemMtu)
		if err != nil {
...
func (info *SrlSystemMtuReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlSystemMtuReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
