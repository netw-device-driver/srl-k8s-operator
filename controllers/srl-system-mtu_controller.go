...
func SrlSystemMtulogResult(info *SrlSystemMtuReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlSystemMtu",
...
func (o *SrlSystemMtuStateMachine) handleConfigStatusConfigureSuccess(info *SrlSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemMtuStateMachine) handleConfigStatusConfigureFailed(info *SrlSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemMtuStateMachine) DeleteFailed(info *SrlSystemMtuReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlSystemMtuStateMachine) DeleteSuccess(info *SrlSystemMtuReconcileInfo) actionResult {
	return actionComplete{}
}
