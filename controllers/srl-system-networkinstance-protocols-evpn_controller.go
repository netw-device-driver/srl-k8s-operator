...
var SystemNetworkinstanceProtocolsEvpnIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var SystemNetworkinstanceProtocolsEvpnInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var SystemNetworkinstanceProtocolsEvpnInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn) (err error) {
	...
	for localLeafRef, leafRefInfo := range SystemNetworkinstanceProtocolsEvpnIntraResourceleafRef {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn) ([]string, error) {
