...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlSystemNetworkinstanceProtocolsEvpnhasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlSystemNetworkinstanceProtocolsEvpn)
		if err != nil {
...
func (r *SrlSystemNetworkinstanceProtocolsEvpnReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn) (*[]string, error) {
...
func (info *SrlSystemNetworkinstanceProtocolsEvpnReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlSystemNetworkinstanceProtocolsEvpnReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
