...
var InterfaceSubinterfaceIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var InterfaceSubinterfaceInterResourceleafRef = map[string][]ElementKeyValue{
	"/subinterface[index=]/acl/input/ipv4-filter": []ElementKeyValue{
		{"acl", "", ""},
		{"ipv4-filter", "name", "string"},
	},
	"/subinterface[index=]/acl/input/ipv6-filter": []ElementKeyValue{
		{"acl", "", ""},
		{"ipv6-filter", "name", "string"},
	},
	"/subinterface[index=]/acl/output/ipv4-filter": []ElementKeyValue{
		{"acl", "", ""},
		{"ipv4-filter", "name", "string"},
	},
	"/subinterface[index=]/acl/output/ipv6-filter": []ElementKeyValue{
		{"acl", "", ""},
		{"ipv6-filter", "name", "string"},
	},
	"/subinterface[index=]/ipv4/vrrp/vrrp-group[virtual-router-id=]/authentication/keychain": []ElementKeyValue{
		{"system", "", ""},
		{"authentication", "", ""},
		{"keychain", "name", "string"},
	},
	"/subinterface[index=]/ipv4/vrrp/vrrp-group[virtual-router-id=]/interface-tracking/track-interface[interface=]": []ElementKeyValue{
		{"interface", "name", "string"},
	},
	"/subinterface[index=]/ipv6/vrrp/vrrp-group[virtual-router-id=]/authentication/keychain": []ElementKeyValue{
		{"system", "", ""},
		{"authentication", "", ""},
		{"keychain", "name", "string"},
	},
	"/subinterface[index=]/ipv6/vrrp/vrrp-group[virtual-router-id=]/interface-tracking/track-interface[interface=]": []ElementKeyValue{
		{"interface", "name", "string"},
	},
	"/subinterface[index=]/qos/input/classifiers/dscp": []ElementKeyValue{
		{"qos", "", ""},
		{"classifiers", "", ""},
		{"dscp-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/input/classifiers/ipv4-dscp": []ElementKeyValue{
		{"qos", "", ""},
		{"classifiers", "", ""},
		{"dscp-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/input/classifiers/ipv6-dscp": []ElementKeyValue{
		{"qos", "", ""},
		{"classifiers", "", ""},
		{"dscp-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/input/classifiers/mpls-traffic-class": []ElementKeyValue{
		{"qos", "", ""},
		{"classifiers", "", ""},
		{"mpls-traffic-class-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/output/rewrite-rules/dscp": []ElementKeyValue{
		{"qos", "", ""},
		{"rewrite-rules", "", ""},
		{"dscp-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/output/rewrite-rules/ipv4-dscp": []ElementKeyValue{
		{"qos", "", ""},
		{"rewrite-rules", "", ""},
		{"dscp-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/output/rewrite-rules/ipv6-dscp": []ElementKeyValue{
		{"qos", "", ""},
		{"rewrite-rules", "", ""},
		{"dscp-policy", "name", "string"},
	},
	"/subinterface[index=]/qos/output/rewrite-rules/mpls-traffic-class": []ElementKeyValue{
		{"qos", "", ""},
		{"rewrite-rules", "", ""},
		{"mpls-traffic-class-policy", "name", "string"},
	},
...
/*
	var InterfaceSubinterfaceInterResourceleafRef = map[string]*ElementWithLeafRef{
		"/subinterface[index=]/acl/input/ipv4-filter" : {
			AbsolutePath2LeafRef: "/acl",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "ipv4-filter",
		    KeyName:             "name",
		},
		"/subinterface[index=]/acl/input/ipv6-filter" : {
			AbsolutePath2LeafRef: "/acl",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "ipv6-filter",
		    KeyName:             "name",
		},
		"/subinterface[index=]/acl/output/ipv4-filter" : {
			AbsolutePath2LeafRef: "/acl",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "ipv4-filter",
		...
		"/subinterface[index=]/acl/output/ipv6-filter" : {
			AbsolutePath2LeafRef: "/acl",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "ipv6-filter",
		...
		"/subinterface[index=]/ipv4/vrrp/vrrp-group[virtual-router-id=]/authentication/keychain" : {
		...
		"/subinterface[index=]/ipv4/vrrp/vrrp-group[virtual-router-id=]/interface-tracking/track-interface[interface=]" : {
		...
		"/subinterface[index=]/ipv6/vrrp/vrrp-group[virtual-router-id=]/authentication/keychain" : {
			AbsolutePath2LeafRef: "/system/authentication",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "keychain",
		...
		"/subinterface[index=]/ipv6/vrrp/vrrp-group[virtual-router-id=]/interface-tracking/track-interface[interface=]" : {
			AbsolutePath2LeafRef: "/",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "interface",
		...
		"/subinterface[index=]/qos/input/classifiers/dscp" : {
			AbsolutePath2LeafRef: "/qos/classifiers",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "dscp-policy",
		    KeyName:             "name",
		},
		"/subinterface[index=]/qos/input/classifiers/ipv4-dscp" : {
			AbsolutePath2LeafRef: "/qos/classifiers",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "dscp-policy",
		...
		"/subinterface[index=]/qos/input/classifiers/ipv6-dscp" : {
			AbsolutePath2LeafRef: "/qos/classifiers",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "dscp-policy",
		...
		"/subinterface[index=]/qos/input/classifiers/mpls-traffic-class" : {
			AbsolutePath2LeafRef: "/qos/classifiers",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "mpls-traffic-class-policy",
		    KeyName:             "name",
		},
		"/subinterface[index=]/qos/output/rewrite-rules/dscp" : {
			AbsolutePath2LeafRef: "/qos/rewrite-rules",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "dscp-policy",
		    KeyName:             "name",
		},
		"/subinterface[index=]/qos/output/rewrite-rules/ipv4-dscp" : {
			AbsolutePath2LeafRef: "/qos/rewrite-rules",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "dscp-policy",
		...
		"/subinterface[index=]/qos/output/rewrite-rules/ipv6-dscp" : {
			AbsolutePath2LeafRef: "/qos/rewrite-rules",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "dscp-policy",
		...
		"/subinterface[index=]/qos/output/rewrite-rules/mpls-traffic-class" : {
			AbsolutePath2LeafRef: "/qos/rewrite-rules",
			RelativePath2LeafRef: "",
		    RelativePath2ObjectWithLeafRef: "",
		    ElementName:         "mpls-traffic-class-policy",
...
// SrlInterfaceSubinterfaceReconciler reconciles a SrlInterfaceSubinterface object
type SrlInterfaceSubinterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlInterfaceSubinterfaceTargetReconcileInfo struct {
	Target map[string]*SrlInterfaceSubinterfaceReconcileInfo
}

type SrlInterfaceSubinterfaceReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlinterfacesubinterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlinterfacesubinterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlinterfacesubinterfaces/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch

func (r *SrlInterfaceSubinterfaceReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlInterfaceSubinterface", request.NamespacedName)
...
func (r *SrlInterfaceSubinterfaceReconciler) updateEventHandler(e event.UpdateEvent) bool {
	_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlInterfaceSubinterface)
	_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlInterfaceSubinterface)
	if !(oldOK && newOK) {
...
func (r *SrlInterfaceSubinterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlInterfaceSubinterface{}).
		WithEventFilter(
			predicate.Funcs{
...
// request for reconciliation of SrlInterfaceSubinterface.
func (r *SrlInterfaceSubinterfaceReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlInterfaceSubinterfaceList{}
...
/*
	...
	func (r *SrlInterfaceSubinterfaceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlInterfaceSubinterfaceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlInterfaceSubinterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlInterfaceSubinterface) (err error) {
	r.Log.Info("Validate Local LeafRef Dependencies ...")

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *o.Spec.SrlInterfaceSubinterface {
		o := make([]srlinuxv1alpha1.InterfaceSubinterface, 0)
		o = append(o, obj)
		dd := struct {
			Subinterface *[]srlinuxv1alpha1.InterfaceSubinterface `json:"subinterface"`
		}{
			Subinterface: &o,
		}
	...
	for localLeafRef, leafRefInfo := range InterfaceSubinterfaceIntraResourceleafRef {
	...
	r.Log.WithValues("InterfaceSubinterfaceIntraResourceleafRef", InterfaceSubinterfaceIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}

/*
	func (r *SrlInterfaceSubinterfaceReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.InterfaceSubinterface) (err error) {
		// marshal data to json
		dd := struct {
			Subinterface *srlinuxv1alpha1.InterfaceSubinterface `json:"subinterface"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range InterfaceSubinterfaceIntraResourceleafRef {
...
func (r *SrlInterfaceSubinterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlInterfaceSubinterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlInterfaceSubinterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlInterfaceSubinterface config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlInterfaceSubinterfacehasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlInterfaceSubinterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlInterfaceSubinterfaceFinalizer)
	...
	if o.DeletionTimestamp.IsZero() && SrlInterfaceSubinterfacehasFinalizer(o) {
		...
		/*
			validationSuccess := true
			for _, vo := range *o.Spec.SrlInterfaceSubinterface {
		...
		*/
		...
		if err := r.saveSrlInterfaceSubinterfaceStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlInterfaceSubinterfacehasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlInterfaceSubinterfaceFinalizer)
	...
	for _, n := range *o.Spec.SrlInterfaceSubinterface {
		hkeys1 = append(hkeys1, strconv.Itoa(int(*n.Index)))
	}
	...
	for _, hkey1 := range hkeys1 {
		deletepaths = append(deletepaths, fmt.Sprintf("/interface[name=%s]/subinterface[index=%s]", hkey0, hkey1))
	}

	// path to be used for this object
	path := fmt.Sprintf("/interface[name=%s]", hkey0)

	info := make(map[string]*SrlInterfaceSubinterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlInterfaceSubinterfaceReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlInterfaceSubinterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlInterfaceSubinterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlInterfaceSubinterfacelogResult(info *SrlInterfaceSubinterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlInterfaceSubinterface",
			"message", info.o.Status)
	}
}

func (r *SrlInterfaceSubinterfaceReconciler) saveSrlInterfaceSubinterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlInterfaceSubinterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlInterfaceSubinterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlInterfaceSubinterface ")
		return err
	}
	return nil
}

func (r *SrlInterfaceSubinterfaceReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlInterfaceSubinterfaceReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlInterfaceSubinterfaceReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlInterfaceSubinterfaceReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlInterfaceSubinterface) ([]string, []string, error) {
	...
	leafRefDependencies := make([]string, 0)
	localLeafRefPaths := make([]string, 0)
	for localLeafRef, rekvl := range InterfaceSubinterfaceInterResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
...
func (r *SrlInterfaceSubinterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlInterfaceSubinterface) ([]*Target, bool, error) {
...
// SrlInterfaceSubinterfacehasFinalizer checks if object has finalizer
func SrlInterfaceSubinterfacehasFinalizer(o *srlinuxv1alpha1.SrlInterfaceSubinterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlInterfaceSubinterfaceFinalizer)
}

func (info *SrlInterfaceSubinterfaceReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlInterfaceSubinterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlInterfaceSubinterfaceReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlInterfaceSubinterface {
		o := make([]srlinuxv1alpha1.InterfaceSubinterface, 0)
		o = append(o, obj)
		dd := struct {
			Subinterface *[]srlinuxv1alpha1.InterfaceSubinterface `json:"subinterface"`
...
type SrlInterfaceSubinterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlInterfaceSubinterface
	Reconciler *SrlInterfaceSubinterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlInterfaceSubinterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlInterfaceSubinterfaceStateMachine(o *srlinuxv1alpha1.SrlInterfaceSubinterface,
	reconciler *SrlInterfaceSubinterfaceReconciler, n *string,
	info *SrlInterfaceSubinterfaceReconcileInfo) *SrlInterfaceSubinterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlInterfaceSubinterfaceStateMachine{
		Object:     o,
...
type SrlInterfaceSubinterfacestateHandler func(*SrlInterfaceSubinterfaceReconcileInfo) actionResult

func (o *SrlInterfaceSubinterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlInterfaceSubinterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlInterfaceSubinterfacestateHandler{
...
func (o *SrlInterfaceSubinterfaceStateMachine) updateSrlInterfaceSubinterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlInterfaceSubinterfaceReconcileInfo) {
...
func (o *SrlInterfaceSubinterfaceStateMachine) ReconcileState(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlInterfaceSubinterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlInterfaceSubinterfaceStateMachine deletion")
		info.DeleteCache()
...
func (o *SrlInterfaceSubinterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlInterfaceSubinterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleNone(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleConfiguring(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleConfigStatusConfigureSuccess(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleConfigStatusConfigureFailed(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleDeleting(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) DeleteFailed(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) DeleteSuccess(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
