...
var InterfaceSubinterfaceInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var InterfaceSubinterfaceExternalResourceleafRef = map[string]*ElementWithLeafRef{
...
func (r *SrlInterfaceSubinterfaceReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlInterfaceSubinterfaceReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlInterfaceSubinterface, cm *string) (err error) {
	...
	for localLeafRef, leafRefInfo := range InterfaceSubinterfaceExternalResourceleafRef {
	...
	r.Log.WithValues("InterfaceSubinterfaceExternalResourceleafRef", InterfaceSubinterfaceExternalResourceleafRef).Info("External leafref STATUS All")
...
func (r *SrlInterfaceSubinterfaceReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlInterfaceSubinterface) (err error) {
	...
	for localLeafRef, leafRefInfo := range InterfaceSubinterfaceInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("InterfaceSubinterfaceInternalResourceleafRef", InterfaceSubinterfaceInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlInterfaceSubinterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !o.DeletionTimestamp.IsZero() && SrlInterfaceSubinterfacehasFinalizer(o) {
		if SrlInterfaceSubinterfacehasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlInterfaceSubinterfacehasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlInterfaceSubinterface"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
...
func SrlInterfaceSubinterfacelogResult(info *SrlInterfaceSubinterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlInterfaceSubinterface")
		//info.log.Info("stopping reconcile SrlInterfaceSubinterface",
...
func (r *SrlInterfaceSubinterfaceReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlInterfaceSubinterfaceReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlInterfaceSubinterface"] = string(d)
		cm.Data[fmt.Sprintf("SrlInterfaceSubinterface.%s",*oName)] = string(d)
...
/*
	func (r *SrlInterfaceSubinterfaceReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlInterfaceSubinterface.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlInterfaceSubinterface.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlInterfaceSubinterfaceReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlInterfaceSubinterfaceReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
// SSrlInterfaceSubinterfacehasOtherFinalizer checks if object has other finalizers
func SrlInterfaceSubinterfacehasOtherFinalizer(o *srlinuxv1alpha1.SrlInterfaceSubinterface) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlInterfaceSubinterfaceFinalizer {
			return true
		}
	}
	return false
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleConfigureSuccess(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleConfigureFailed(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlInterfaceSubinterfaceStateMachine) handleDeleteSuccess(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlInterfaceSubinterfaceStateMachine) handleDeleteFailed(info *SrlInterfaceSubinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
