...
func (r *SrlNetworkinstanceAggregateroutesReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(o) {
		err := r.validateLocalLeafRefs(o.Spec.SrlNetworkinstanceAggregateroutes)
		if err != nil {
...
func (info *SrlNetworkinstanceAggregateroutesReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlNetworkinstanceAggregateroutesReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
