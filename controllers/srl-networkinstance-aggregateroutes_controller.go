...
var NetworkinstanceAggregateroutesIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var NetworkinstanceAggregateroutesInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var NetworkinstanceAggregateroutesInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlNetworkinstanceAggregateroutesReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlNetworkinstanceAggregateroutesReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceAggregateroutesIntraResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceAggregateroutesIntraResourceleafRef", NetworkinstanceAggregateroutesIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
