...
func SrlNetworkinstanceAggregaterouteslogResult(info *SrlNetworkinstanceAggregateroutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlNetworkinstanceAggregateroutes",
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleConfigStatusConfigureSuccess(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleConfigStatusConfigureFailed(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) DeleteFailed(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) DeleteSuccess(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	return actionComplete{}
}
