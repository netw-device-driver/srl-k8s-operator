...
var NetworkinstanceAggregateroutesInternalResourceleafRef = map[string]*ElementWithLeafRef{}

var NetworkinstanceAggregateroutesExternalResourceleafRef = map[string]*ElementWithLeafRef{}

// SrlNetworkinstanceAggregateroutesReconciler reconciles a SrlNetworkinstanceAggregateroutes object
type SrlNetworkinstanceAggregateroutesReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlNetworkinstanceAggregateroutesTargetReconcileInfo struct {
	Target map[string]*SrlNetworkinstanceAggregateroutesReconcileInfo
}

type SrlNetworkinstanceAggregateroutesReconcileInfo struct {
	target              *string
	resource            *string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceaggregateroutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceaggregateroutes/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnetworkinstanceaggregateroutes/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch;update
// +kubebuilder:rbac:groups="",resources=events,verbs=get;list;watch;create;update;patch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;update

func (r *SrlNetworkinstanceAggregateroutesReconciler) publishEvent(request ctrl.Request, event corev1.Event) {
	reqLogger := r.Log.WithValues("SrlNetworkinstanceAggregateroutes", request.NamespacedName)
...
/*
	func (r *SrlNetworkinstanceAggregateroutesReconciler) updateEventHandler(e event.UpdateEvent) bool {
		_, oldOK := e.ObjectOld.(*srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes)
		_, newOK := e.ObjectNew.(*srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes)
		if !(oldOK && newOK) {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes{}).
...
// request for reconciliation of SrlNetworkinstanceAggregateroutes.
func (r *SrlNetworkinstanceAggregateroutesReconciler) NetworkNodeMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlNetworkinstanceAggregateroutesList{}
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) ValidateParentDependency(ctx context.Context, cm *string, dependencies *[]string) (bool, error) {
	var x1 interface{}
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) ValidateExternalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes, cm *string) (err error) {
	r.Log.Info("Validate External LeafRef Dependencies ...")

	// marshal data to json
	dd := struct {
		AggregateRoutes *srlinuxv1alpha1.NetworkinstanceAggregateroutes `json:"aggregate-routes"`
	}{
		AggregateRoutes: o.Spec.SrlNetworkinstanceAggregateroutes,
	}
	d := make([][]byte, 0)
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceAggregateroutesExternalResourceleafRef {
	...
	r.Log.WithValues("NetworkinstanceAggregateroutesExternalResourceleafRef", NetworkinstanceAggregateroutesExternalResourceleafRef).Info("External leafref STATUS All")

	return nil
}

func (r *SrlNetworkinstanceAggregateroutesReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) (err error) {
	...
	for localLeafRef, leafRefInfo := range NetworkinstanceAggregateroutesInternalResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
	...
	r.Log.WithValues("NetworkinstanceAggregateroutesInternalResourceleafRef", NetworkinstanceAggregateroutesInternalResourceleafRef).Info("leafref STATUS All")
	return nil
}

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
func (r *SrlNetworkinstanceAggregateroutesReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlNetworkinstanceAggregateroutes", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlNetworkinstanceAggregateroutes")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlNetworkinstanceAggregateroutes config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNetworkinstanceAggregaterouteshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNetworkinstanceAggregateroutesFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNetworkinstanceAggregateroutesFinalizer)
		err := r.Update(ctx, o)
		if err != nil {
	...
	if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(o) {
		if SrlNetworkinstanceAggregaterouteshasOtherFinalizer(o) {
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(o) {
		...
		if err := r.saveSrlNetworkinstanceAggregateroutesStatus(ctx, o); err != nil {
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if !o.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(o) {
				...
				o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceAggregateroutesFinalizer)
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "SrlNetworkinstanceAggregateroutes" + "." + strcase.UpperCamelCase(o.Name)
	...
	if o.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(o) {
		for _, target := range t {
			...
			if err := addSharedMemoryEntry(stringPtr(target.TargetName), stringPtr("SrlNetworkinstanceAggregateroutes"), stringPtr(req.Name), stringSlicePtr(deletepaths)); err != nil {
				return ctrl.Result{}, err
			}
	...
	info := make(map[string]*SrlNetworkinstanceAggregateroutesReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			"target", target.TargetName,
			"status", initialState)
		info[target.TargetName] = &SrlNetworkinstanceAggregateroutesReconcileInfo{
			ctx:                 ctx,
		...
		stateMachine := newSrlNetworkinstanceAggregateroutesStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	for _, target := range t {
		...
		SrlNetworkinstanceAggregaterouteslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNetworkinstanceAggregaterouteslogResult(info *SrlNetworkinstanceAggregateroutesReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping reconcile SrlNetworkinstanceAggregateroutes")
		//info.log.Info("stopping reconcile SrlNetworkinstanceAggregateroutes",
		//	"message", info.o.Status)
	}
}

func (r *SrlNetworkinstanceAggregateroutesReconciler) saveSrlNetworkinstanceAggregateroutesStatus(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlNetworkinstanceAggregateroutes",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlNetworkinstanceAggregateroutes ")
		return err
	}
	return nil
}

func (r *SrlNetworkinstanceAggregateroutesReconciler) getConfigMap(ctx context.Context, targetName *string) (*string, error) {
...
/*
	func (r *SrlNetworkinstanceAggregateroutesReconciler) addEntryConfigMap(ctx context.Context, targetName, oName *string, deletepaths *[]string) error {
		dp := &DeletePaths{
			DeletePaths: deletepaths,
		}
		...
		//cm.Data["SrlNetworkinstanceAggregateroutes"] = string(d)
		cm.Data[fmt.Sprintf("SrlNetworkinstanceAggregateroutes.%s",*oName)] = string(d)
...
/*
	func (r *SrlNetworkinstanceAggregateroutesReconciler) deleteEntryConfigMap(ctx context.Context, targetName, oName *string) error {
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
		}
		...
		if _, ok := cm.Data[fmt.Sprintf("SrlNetworkinstanceAggregateroutes.%s",*oName)]; ok {
			delete(cm.Data, fmt.Sprintf("SrlNetworkinstanceAggregateroutes.%s",*oName))
			if err := r.Update(ctx, cm); err != nil {
				r.Log.Error(err, "Failed to update configmap")
				return err
			}
...
/*
	func (r *SrlNetworkinstanceAggregateroutesReconciler) GetRemoteleafRefResource(ctx context.Context, targetName *string, remoteleafRef *srlinuxv1alpha1.RemoteLeafRefInfo) (*string, error) {
		// get configmap
		cmKey := types.NamespacedName{
			Namespace: "nddriver-system",
			Name:      "nddriver-cm-" + *targetName,
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) findPathInTree(x1 interface{}, ekvl []ElementKeyValue, idx int) bool {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues, localLeafRefPaths []string, lridx int) ([]string, []string) {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) FindRemoteLeafRef(remoteLeafRef string, d [][]byte, rekvl []ElementKeyValue) []string {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) FindLocalLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) ([]string, []string) {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) FindSpecDiff(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) (bool, *[]string, error) {
...
func (r *SrlNetworkinstanceAggregateroutesReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) ([]*Target, bool, error) {
...
// SrlNetworkinstanceAggregaterouteshasFinalizer checks if object has finalizer
func SrlNetworkinstanceAggregaterouteshasFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNetworkinstanceAggregateroutesFinalizer)
}

// SSrlNetworkinstanceAggregaterouteshasOtherFinalizer checks if object has other finalizers
func SrlNetworkinstanceAggregaterouteshasOtherFinalizer(o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes) bool {
	for _, f := range o.Finalizers {
		if f != srlinuxv1alpha1.SrlNetworkinstanceAggregateroutesFinalizer {
			return true
		}
	}
	return false
...
func (info *SrlNetworkinstanceAggregateroutesReconcileInfo) DeleteCache() error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(info.o) {
...
// Update Cache
func (info *SrlNetworkinstanceAggregateroutesReconcileInfo) UpdateCache(path string) error {

	// marshal data to json
	dd := struct {
		AggregateRoutes *srlinuxv1alpha1.NetworkinstanceAggregateroutes `json:"aggregate-routes"`
	}{
		AggregateRoutes: info.o.Spec.SrlNetworkinstanceAggregateroutes,
	}
	d := make([][]byte, 0)
	dj, err := json.Marshal(dd)
	if err != nil {
...
type SrlNetworkinstanceAggregateroutesStateMachine struct {
	Object     *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes
	Reconciler *SrlNetworkinstanceAggregateroutesReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlNetworkinstanceAggregateroutesReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlNetworkinstanceAggregateroutesStateMachine(o *srlinuxv1alpha1.SrlNetworkinstanceAggregateroutes,
	reconciler *SrlNetworkinstanceAggregateroutesReconciler, n *string,
	info *SrlNetworkinstanceAggregateroutesReconcileInfo) *SrlNetworkinstanceAggregateroutesStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlNetworkinstanceAggregateroutesStateMachine{
		Object:     o,
...
type SrlNetworkinstanceAggregateroutesstateHandler func(*SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult

func (o *SrlNetworkinstanceAggregateroutesStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceAggregateroutesstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNetworkinstanceAggregateroutesstateHandler{
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) updateSrlNetworkinstanceAggregateroutesStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlNetworkinstanceAggregateroutesReconcileInfo) {
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) ReconcileState(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlNetworkinstanceAggregateroutesStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlNetworkinstanceAggregateroutesStateMachine deletion")
		info.DeleteCache()
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNetworkinstanceAggregaterouteshasFinalizer(o.Object) {
		// Delete requested
		switch *o.NextState {
		default:
			// new state deleting
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleNone(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleConfiguring(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleConfigureSuccess(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleConfigureFailed(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleDeleting(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleDeleteSuccess(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	return actionFinished{}
}

func (o *SrlNetworkinstanceAggregateroutesStateMachine) handleDeleteFailed(info *SrlNetworkinstanceAggregateroutesReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
