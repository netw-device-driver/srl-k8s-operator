...
func (r *SrlnokiaNetworkinstanceProtocolsBgpvpnReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpvpnReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpvpnReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsBgpvpn) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsBgpvpnIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaNetworkinstanceProtocolsBgpvpn)
	if err != nil {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpvpnReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpvpn) (*[]string, error) {
