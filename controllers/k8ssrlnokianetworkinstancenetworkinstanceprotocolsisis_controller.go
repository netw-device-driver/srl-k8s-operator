...
// K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler reconciles a SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis object
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo
}

type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisList{}
...
// the SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsishasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStatus(ctx, o); err != nil {
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsishasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsislogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsislogResult(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler) saveK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis) ([]*Target, bool, error) {
...
// SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsishasFinalizer checks if object has finalizer
func SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsishasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisFinalizer)
}

func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsishasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		Isis *srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis `json:"isis"`
	}{
		Isis: info.o.Spec.SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis
	Reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsis,
	reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconciler, n *string,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine{
		Object:     o,
...
type SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisstateHandler func(*K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult

func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisstateHandler{
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) updateK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) ReconcileState(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine deletion")
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceProtocolsIsishasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) handleNone(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) handleConfiguring(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) handleDeleting(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) DeleteFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisStateMachine) DeleteSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceProtocolsIsisReconcileInfo) actionResult {
	return actionComplete{}
}
