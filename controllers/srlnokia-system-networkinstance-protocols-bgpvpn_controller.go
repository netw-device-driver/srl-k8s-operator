	...
	*/
	...
	var SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef= map[string]*LeafRef{
	}

	var SystemNetworkinstanceProtocolsBgpvpnInterResourceleafRef = map[string]*LeafRef{
	}
	...
	// the SrlnokiaSystemNetworkinstanceProtocolsBgpvpn object against the actual cluster state, and then
