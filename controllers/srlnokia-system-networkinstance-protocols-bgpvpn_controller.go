...
// SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler reconciles a SrlnokiaSystemNetworkinstanceProtocolsBgpvpn object
type SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaSystemNetworkinstanceProtocolsBgpvpnTargetReconcileInfo struct {
	Target map[string]*SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo
}

type SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemnetworkinstanceprotocolsbgpvpns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemnetworkinstanceprotocolsbgpvpns/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiasystemnetworkinstanceprotocolsbgpvpns/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaSystemNetworkinstanceProtocolsBgpvpn.
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpnList{}
...
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.SystemNetworkinstanceProtocolsBgpvpn) (err error) {
	...
	for _, elementWithleafref := range SystemNetworkinstanceProtocolsBgpvpnIntraResourceleafRef {
...
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaSystemNetworkinstanceProtocolsBgpvpn", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaSystemNetworkinstanceProtocolsBgpvpn")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaSystemNetworkinstanceProtocolsBgpvpn config")
	...
	err := r.validateLocalLeafRefs(o.Spec.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn)
	if err != nil {
	...
	if err := r.saveSrlnokiaSystemNetworkinstanceProtocolsBgpvpnStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpnFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpnFinalizer)
	...
	level := int32(4)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaSystemNetworkinstanceProtocolsBgpvpn" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpnFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaSystemNetworkinstanceProtocolsBgpvpnlogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaSystemNetworkinstanceProtocolsBgpvpnlogResult(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaSystemNetworkinstanceProtocolsBgpvpn",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) saveSrlnokiaSystemNetworkinstanceProtocolsBgpvpnStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaSystemNetworkinstanceProtocolsBgpvpn",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaSystemNetworkinstanceProtocolsBgpvpn ")
		return err
	}
	return nil
}
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn) ([]*Target, bool, error) {
...
// SrlnokiaSystemNetworkinstanceProtocolsBgpvpnhasFinalizer checks if object has finalizer
func SrlnokiaSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o *srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpnFinalizer)
}

func (info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		BgpVpn: info.o.Spec.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn,
	}
	d := make([][]byte, 0)
...
type SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn
	Reconciler *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine(o *srlinuxv1alpha1.SrlnokiaSystemNetworkinstanceProtocolsBgpvpn,
	reconciler *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconciler, n *string,
	info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine{
		Object:     o,
...
type SrlnokiaSystemNetworkinstanceProtocolsBgpvpnstateHandler func(*SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult

func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemNetworkinstanceProtocolsBgpvpnstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaSystemNetworkinstanceProtocolsBgpvpnstateHandler{
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) updateSrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) {
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) ReconcileState(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine deletion")
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaSystemNetworkinstanceProtocolsBgpvpnhasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleNone(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfiguring(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) handleDeleting(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) DeleteFailed(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnStateMachine) DeleteSuccess(info *SrlnokiaSystemNetworkinstanceProtocolsBgpvpnReconcileInfo) actionResult {
	return actionComplete{}
}
