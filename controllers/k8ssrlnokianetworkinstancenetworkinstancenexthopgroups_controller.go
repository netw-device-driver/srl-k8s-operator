...
// K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler reconciles a SrlNokiaNetworkInstanceNetworkInstanceNextHopGroups object
type K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler struct {
	client.Client
	Log    logr.Logger
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsTargetReconcileInfo struct {
	Target map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo
}

type K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstancenexthopgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstancenexthopgroups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=k8ssrlnokianetworkinstancenetworkinstancenexthopgroups/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups.
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsList{}
...
// the SrlNokiaNetworkInstanceNetworkInstanceNextHopGroups object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.0/pkg/reconcile
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupshasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsFinalizer)
	...
	if err != nil {
		...
		case *TargetNotFoundError:
			...
			if dirty {
				if err = r.saveK8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStatus(ctx, o); err != nil {
	...
	level := int32(2)
	resource := "srlinux.henderiw.be" + "." + "K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newK8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupshasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsFinalizer)
	...
	for _, target := range t {
		...
		SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupslogResult(info[target.TargetName], result[target.TargetName])
...
func SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupslogResult(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups",
			"message", info.o.Status)
	}
}

func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler) saveK8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStatus(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups ")
		return err
	}
	return nil
}
...
func (r *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups) ([]*Target, bool, error) {
...
// SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupshasFinalizer checks if object has finalizer
func SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupshasFinalizer(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsFinalizer)
}

func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupshasFinalizer(info.o) {
...
// Update Cache
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	dd := struct {
		NextHopGroups *srlinuxv1alpha1.SrlNokiaNetworkInstanceNetworkInstanceNextHopGroups `json:"next-hop-groups"`
	}{
		NextHopGroups: info.o.Spec.SrlNokiaNetworkInstanceNetworkInstanceNextHopGroups,
	}
	d := make([][]byte, 0)
...
type K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine struct {
	Object     *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups
	Reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newK8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine(o *srlinuxv1alpha1.K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroups,
	reconciler *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconciler, n *string,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine{
		Object:     o,
...
type SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsstateHandler func(*K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult

func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsstateHandler{
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) updateK8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) ReconcileState(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateK8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine deletion")
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlNokiaNetworkInstanceNetworkInstanceNextHopGroupshasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) handleNone(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) handleConfiguring(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) handleConfigStatusConfigureSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) handleConfigStatusConfigureFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) handleDeleting(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) DeleteFailed(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsStateMachine) DeleteSuccess(info *K8sSrlNokiaNetworkInstanceNetworkInstanceNextHopGroupsReconcileInfo) actionResult {
	return actionComplete{}
}
