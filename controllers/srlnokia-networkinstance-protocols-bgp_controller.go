...
// SrlnokiaNetworkinstanceProtocolsBgpReconciler reconciles a SrlnokiaNetworkinstanceProtocolsBgp object
type SrlnokiaNetworkinstanceProtocolsBgpReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaNetworkinstanceProtocolsBgpTargetReconcileInfo struct {
	Target map[string]*SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo
}

type SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsbgps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsbgps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokianetworkinstanceprotocolsbgps/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaNetworkinstanceProtocolsBgp.
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpList{}
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.NetworkinstanceProtocolsBgp) (err error) {
	...
	for _, elementWithleafref := range NetworkinstanceProtocolsBgpIntraResourceleafRef {
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaNetworkinstanceProtocolsBgp")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaNetworkinstanceProtocolsBgp config")
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaNetworkinstanceProtocolsBgphasFinalizer(o) {
		r.Log.Info(
			...
			"newValue", srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpFinalizer)
	...
	level := int32(3)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaNetworkinstanceProtocolsBgp" + "." + strcase.UpperCamelCase(o.Name)
	...
	info := make(map[string]*SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaNetworkinstanceProtocolsBgpStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsBgphasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaNetworkinstanceProtocolsBgplogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaNetworkinstanceProtocolsBgplogResult(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaNetworkinstanceProtocolsBgp",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) saveSrlnokiaNetworkinstanceProtocolsBgpStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaNetworkinstanceProtocolsBgp",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaNetworkinstanceProtocolsBgp ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaNetworkinstanceProtocolsBgpReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp) ([]*Target, bool, error) {
...
// SrlnokiaNetworkinstanceProtocolsBgphasFinalizer checks if object has finalizer
func SrlnokiaNetworkinstanceProtocolsBgphasFinalizer(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgpFinalizer)
}

func (info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsBgphasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
	...
	dd := struct {
		...
		Bgp: info.o.Spec.SrlnokiaNetworkinstanceProtocolsBgp,
	}
	d := make([][]byte, 0)
...
type SrlnokiaNetworkinstanceProtocolsBgpStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp
	Reconciler *SrlnokiaNetworkinstanceProtocolsBgpReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaNetworkinstanceProtocolsBgpStateMachine(o *srlinuxv1alpha1.SrlnokiaNetworkinstanceProtocolsBgp,
	reconciler *SrlnokiaNetworkinstanceProtocolsBgpReconciler, n *string,
	info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) *SrlnokiaNetworkinstanceProtocolsBgpStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaNetworkinstanceProtocolsBgpStateMachine{
		Object:     o,
...
type SrlnokiaNetworkinstanceProtocolsBgpstateHandler func(*SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult

func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsBgpstateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaNetworkinstanceProtocolsBgpstateHandler{
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) updateSrlnokiaNetworkinstanceProtocolsBgpStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) {
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) ReconcileState(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaNetworkinstanceProtocolsBgpStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaNetworkinstanceProtocolsBgpStateMachine deletion")
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaNetworkinstanceProtocolsBgphasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) handleNone(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) handleConfiguring(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) handleDeleting(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) DeleteFailed(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaNetworkinstanceProtocolsBgpStateMachine) DeleteSuccess(info *SrlnokiaNetworkinstanceProtocolsBgpReconcileInfo) actionResult {
	return actionComplete{}
}
