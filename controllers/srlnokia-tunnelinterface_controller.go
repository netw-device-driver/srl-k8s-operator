...
// SrlnokiaTunnelinterfaceReconciler reconciles a SrlnokiaTunnelinterface object
type SrlnokiaTunnelinterfaceReconciler struct {
	client.Client
	Log    logr.Logger
...
type SrlnokiaTunnelinterfaceTargetReconcileInfo struct {
	Target map[string]*SrlnokiaTunnelinterfaceReconcileInfo
}

type SrlnokiaTunnelinterfaceReconcileInfo struct {
	target            *string
	resource          *string
	o                 *srlinuxv1alpha1.SrlnokiaTunnelinterface
	level             *int32
	dependencies      *[]string
	deletepaths       *[]string
...
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiatunnelinterfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiatunnelinterfaces/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=srlinux.henderiw.be,resources=srlnokiatunnelinterfaces/finalizers,verbs=update

// SetupWithManager sets up the controller with the Manager.
func (r *SrlnokiaTunnelinterfaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, option controller.Options) error {
	b := ctrl.NewControllerManagedBy(mgr).
		For(&srlinuxv1alpha1.SrlnokiaTunnelinterface{}).
		WithOptions(option).
		Watches(
...
// request for reconciliation of SrlnokiaTunnelinterface.
func (r *SrlnokiaTunnelinterfaceReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
	...
	os := &srlinuxv1alpha1.SrlnokiaTunnelinterfaceList{}
...
func (r *SrlnokiaTunnelinterfaceReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
func (r *SrlnokiaTunnelinterfaceReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
	//xType := reflect.TypeOf(o)
	//xValue := reflect.ValueOf(o)
	//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
	switch x := o.(type) {
...
func (r *SrlnokiaTunnelinterfaceReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.Tunnelinterface) (err error) {
	...
	for _, elementWithleafref := range TunnelinterfaceIntraResourceleafRef {
...
func (r *SrlnokiaTunnelinterfaceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("SrlnokiaTunnelinterface", req.NamespacedName)

	r.Log.WithValues("ObjectName", req.NamespacedName).Info("reconciling SrlnokiaTunnelinterface")
	...
	if err := r.Client.Get(ctx, req.NamespacedName, o); err != nil {
		...
		r.Log.WithValues(req.Name, req.Namespace).Error(err, "Failed to get SrlnokiaTunnelinterface config")
	...
	for _, vo := range *o.Spec.SrlnokiaTunnelinterface {
	...
	if err := r.saveSrlnokiaTunnelinterfaceStatus(ctx, o); err != nil {
	...
	if o.DeletionTimestamp.IsZero() && !SrlnokiaTunnelinterfacehasFinalizer(o) {
		r.Log.Info(
			"adding finalizer",
			"existingFinalizers", o.Finalizers,
			"newValue", srlinuxv1alpha1.SrlnokiaTunnelinterfaceFinalizer,
		)
		o.Finalizers = append(o.Finalizers,
			srlinuxv1alpha1.SrlnokiaTunnelinterfaceFinalizer)
	...
	level := int32(1)
	resource := "srlinux.henderiw.be" + "." + "SrlnokiaTunnelinterface" + "." + strcase.UpperCamelCase(o.Name)
	hkeys0 := make([]string, 0)
	for _, n := range *o.Spec.SrlnokiaTunnelinterface {
	...
	info := make(map[string]*SrlnokiaTunnelinterfaceReconcileInfo)
	...
	for _, target := range t {
		...
		r.Log.Info("configuration status in reconcile",
			...
			"status", initialState)
		info[target.TargetName] = &SrlnokiaTunnelinterfaceReconcileInfo{
			ctx:          ctx,
		...
		stateMachine := newSrlnokiaTunnelinterfaceStateMachine(o, r, &target.TargetName, info[target.TargetName])
	...
	if !o.DeletionTimestamp.IsZero() && SrlnokiaTunnelinterfacehasFinalizer(o) {
		...
		if deleted {
			...
			o.Finalizers = removeString(o.Finalizers, srlinuxv1alpha1.SrlnokiaTunnelinterfaceFinalizer)
	...
	for _, target := range t {
		...
		SrlnokiaTunnelinterfacelogResult(info[target.TargetName], result[target.TargetName])
...
func SrlnokiaTunnelinterfacelogResult(info *SrlnokiaTunnelinterfaceReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlnokiaTunnelinterface",
			"message", info.o.Status)
	}
}

func (r *SrlnokiaTunnelinterfaceReconciler) saveSrlnokiaTunnelinterfaceStatus(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaTunnelinterface) error {
	t := metav1.Now()
	o.Status.DeepCopy()
	o.Status.LastUpdated = &t

	r.Log.Info("SrlnokiaTunnelinterface",
		"status", o.Status)

	if err := r.Client.Status().Update(ctx, o); err != nil {
		r.Log.WithValues(o.Name, o.Namespace).Error(err, "Failed to update SrlnokiaTunnelinterface ")
		return err
	}
	return nil
}
...
func (r *SrlnokiaTunnelinterfaceReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaTunnelinterface) (*[]string, error) {
...
// FindTarget finds the SRL target for Object
func (r *SrlnokiaTunnelinterfaceReconciler) FindTarget(ctx context.Context, o *srlinuxv1alpha1.SrlnokiaTunnelinterface) ([]*Target, bool, error) {
...
// SrlnokiaTunnelinterfacehasFinalizer checks if object has finalizer
func SrlnokiaTunnelinterfacehasFinalizer(o *srlinuxv1alpha1.SrlnokiaTunnelinterface) bool {
	return StringInList(o.Finalizers, srlinuxv1alpha1.SrlnokiaTunnelinterfaceFinalizer)
}

func (info *SrlnokiaTunnelinterfaceReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
	if !info.o.DeletionTimestamp.IsZero() && SrlnokiaTunnelinterfacehasFinalizer(info.o) {
...
// Update Cache
func (info *SrlnokiaTunnelinterfaceReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {

	// marshal data to json

	d := make([][]byte, 0)
	for _, obj := range *info.o.Spec.SrlnokiaTunnelinterface {
...
type SrlnokiaTunnelinterfaceStateMachine struct {
	Object     *srlinuxv1alpha1.SrlnokiaTunnelinterface
	Reconciler *SrlnokiaTunnelinterfaceReconciler
	Target     *string
	TargetName *string
...
// appendEvent
func (info *SrlnokiaTunnelinterfaceReconcileInfo) appendEvent(reason, message string) {
	info.events = append(info.events, info.o.NewEvent(reason, message))
}

func newSrlnokiaTunnelinterfaceStateMachine(o *srlinuxv1alpha1.SrlnokiaTunnelinterface,
	reconciler *SrlnokiaTunnelinterfaceReconciler, n *string,
	info *SrlnokiaTunnelinterfaceReconcileInfo) *SrlnokiaTunnelinterfaceStateMachine {
	currentState := o.Status.Target[*n].ConfigStatus
	r := SrlnokiaTunnelinterfaceStateMachine{
		Object:     o,
...
type SrlnokiaTunnelinterfacestateHandler func(*SrlnokiaTunnelinterfaceReconcileInfo) actionResult

func (o *SrlnokiaTunnelinterfaceStateMachine) handlers() map[srlinuxv1alpha1.ConfigStatus]SrlnokiaTunnelinterfacestateHandler {
	return map[srlinuxv1alpha1.ConfigStatus]SrlnokiaTunnelinterfacestateHandler{
...
func (o *SrlnokiaTunnelinterfaceStateMachine) updateSrlnokiaTunnelinterfaceStateFrom(initialState *srlinuxv1alpha1.ConfigStatus,
	info *SrlnokiaTunnelinterfaceReconcileInfo) {
...
func (o *SrlnokiaTunnelinterfaceStateMachine) ReconcileState(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	initialState := o.Object.Status.Target[*o.TargetName].ConfigStatus
	defer o.updateSrlnokiaTunnelinterfaceStateFrom(initialState, info)

	if o.checkInitiateDelete() {
		// initiate cache delete
		info.log.Info("Initiating SrlnokiaTunnelinterfaceStateMachine deletion")
...
func (o *SrlnokiaTunnelinterfaceStateMachine) checkInitiateDelete() bool {
	if !o.Object.DeletionTimestamp.IsZero() && SrlnokiaTunnelinterfacehasFinalizer(o.Object) {
		// Delete requested
		switch o.NextState {
		default:
			// new state deleting
...
func (o *SrlnokiaTunnelinterfaceStateMachine) handleNone(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
...
func (o *SrlnokiaTunnelinterfaceStateMachine) handleConfiguring(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceStateMachine) handleConfigStatusConfigureSuccess(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceStateMachine) handleConfigStatusConfigureFailed(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceStateMachine) handleDeleting(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceStateMachine) DeleteFailed(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlnokiaTunnelinterfaceStateMachine) DeleteSuccess(info *SrlnokiaTunnelinterfaceReconcileInfo) actionResult {
	return actionComplete{}
}
