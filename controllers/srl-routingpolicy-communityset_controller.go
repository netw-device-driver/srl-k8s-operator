...
func (r *SrlRoutingpolicyCommunitysetReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyCommunityset) (err error) {
	...
	r.Log.WithValues("RoutingpolicyCommunitysetIntraResourceleafRef", RoutingpolicyCommunitysetIntraResourceleafRef).Info("leafref STATUS All")
	return nil
}
...
func (r *SrlRoutingpolicyCommunitysetReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyCommunityset) ([]string, []string, error) {
