...
var RoutingpolicyCommunitysetIntraResourceleafRef = map[string]*ElementWithLeafRef{}
...
var RoutingpolicyCommunitysetInterResourceleafRef = map[string][]ElementKeyValue{}

/*
	var RoutingpolicyCommunitysetInterResourceleafRef = map[string]*ElementWithLeafRef{
	}
*/
...
/*
	...
	func (r *SrlRoutingpolicyCommunitysetReconciler) validateIfElementWithLeafRefExists(elements []string, i int, o interface{}, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
...
/*
	func (r *SrlRoutingpolicyCommunitysetReconciler) validateLeafRefExists(elements []string, i int, o interface{}, leafrefValue string, elementWithleafref *ElementWithLeafRef) (interface{}, bool) {
		//xType := reflect.TypeOf(o)
		//xValue := reflect.ValueOf(o)
		//r.Log.WithValues("xType", xType, "xValue", xValue).Info("validateObject")
		switch x := o.(type) {
...
func (r *SrlRoutingpolicyCommunitysetReconciler) ValidateLocalLeafRefs(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyCommunityset) (err error) {
	...
	for localLeafRef, leafRefInfo := range RoutingpolicyCommunitysetIntraResourceleafRef {
...
/*
	func (r *SrlRoutingpolicyCommunitysetReconciler) validateLocalLeafRefs(o *srlinuxv1alpha1.RoutingpolicyCommunityset) (err error) {
		// marshal data to json
		dd := struct {
			CommunitySet *srlinuxv1alpha1.RoutingpolicyCommunityset `json:"community-set"`
		}{
		...
		for elementWithleafrefPath, elementWithleafref := range RoutingpolicyCommunitysetIntraResourceleafRef {
...
func (r *SrlRoutingpolicyCommunitysetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if o.DeletionTimestamp.IsZero() && SrlRoutingpolicyCommunitysethasFinalizer(o) {
		...
		/*
			validationSuccess := true
			for _, vo := range *o.Spec.SrlRoutingpolicyCommunityset {
...
func SrlRoutingpolicyCommunitysetlogResult(info *SrlRoutingpolicyCommunitysetReconcileInfo, result ctrl.Result) {
	if result.Requeue || result.RequeueAfter != 0 ||
		...
		info.log.Info("stopping on SrlRoutingpolicyCommunityset",
...
func (r *SrlRoutingpolicyCommunitysetReconciler) findLeafRefInTree(x1 interface{}, ekvl []ElementKeyValue, idx int, leafRefValues []string) []string {
...
func (r *SrlRoutingpolicyCommunitysetReconciler) FindLeafRef(localLeafRef string, d [][]byte, ekvl, rekvl []ElementKeyValue) []string {
...
func (r *SrlRoutingpolicyCommunitysetReconciler) FindInterLeafRefDependencies(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyCommunityset) ([]string, error) {
	...
	for localLeafRef, rekvl := range RoutingpolicyCommunitysetInterResourceleafRef {
		// get the ekvl for the local leafref
		ekvl := getHierarchicalElements(localLeafRef)
...
func (o *SrlRoutingpolicyCommunitysetStateMachine) handleConfigStatusConfigureSuccess(info *SrlRoutingpolicyCommunitysetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyCommunitysetStateMachine) handleConfigStatusConfigureFailed(info *SrlRoutingpolicyCommunitysetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyCommunitysetStateMachine) DeleteFailed(info *SrlRoutingpolicyCommunitysetReconcileInfo) actionResult {
	cr, err := getCachStatus(o.Reconciler.Ctx, o.Target, info.resource, *info.level)
	if err != nil {
		return actionFailed{dirty: true, errorCount: *info.o.Status.Target[*o.TargetName].ErrorCount}
	}
...
func (o *SrlRoutingpolicyCommunitysetStateMachine) DeleteSuccess(info *SrlRoutingpolicyCommunitysetReconcileInfo) actionResult {
	return actionComplete{}
}
