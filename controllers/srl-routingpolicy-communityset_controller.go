...
func (r *SrlRoutingpolicyCommunitysetReconciler) NetworkDeviceMapFunc(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}
...
func (r *SrlRoutingpolicyCommunitysetReconciler) FindSpecDelta(ctx context.Context, o *srlinuxv1alpha1.SrlRoutingpolicyCommunityset) (*[]string, error) {
...
func (info *SrlRoutingpolicyCommunitysetReconcileInfo) DeleteCache(deletepaths, dependencies *[]string) error {
...
// Update Cache
func (info *SrlRoutingpolicyCommunitysetReconcileInfo) UpdateCache(path string, deletepaths, dependencies []string) error {
